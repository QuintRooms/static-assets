...
<head>
    ...
    <meta content="57m 20s" name="expiresIn" />
...
<body onkeydown="onKeyDown(event)" class="CheckoutMode-WBCheckoutForm3 h4hperkstest events-hotelsforhope-com MemberNotAuthenticated PrivateSite MemberTypeNone WBForgotPasswordForm" id="theBody">
...
-->
    ...
    <div class="ArnSupportLinks ArnSupportTop"><a class="ARN_ServiceLinks searchLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;2">Search</a><span class="dvd"> | </span><a class="ARN_ServiceLinks lowRateLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;3">Low Rate Guarantee</a><span class="dvd"> | </span><a class="ARN_ServiceLinks faqLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;4">FAQ</a><span class="dvd"> | </span><a class="ARN_ServiceLinks termsLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;5">Terms &amp; Conditions</a><span class="dvd"> | </span><a class="ARN_ServiceLinks privacyLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;6">Privacy Policy</a><span class="dvd"> | </span><a class="ARN_ServiceLinks supportLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;7">Support</a><span class="dvd"> | </span><a class="ARN_ServiceLinks cancelLink" href="https://events.hotelsforhope.com/v6?_s=ub2tf69CIj2ujKNM&amp;_k=sAGyGp8w&amp;siteId=39624&amp;theme=standard&amp;8">Cancel/Modify</a></div><span style="display:none;">customize with forgotPasswordTop.html in theme directory</span>
    <div id="C7bv97mipbhwhw2hvqcs8h8q63" class="SSForm WBForgotPasswordFormContainer WBAuthContainer ArnSubPage">
        <div id="theWBForgotPasswordFormBody" class="SSFormBody">
            <form accept-charset="utf-8" method="post" action="https://events.hotelsforhope.com/v6" id="theWBForgotPasswordForm">
                <div class="WBForgotPasswordFormFields">
                    <div id="theUserNameAjax" class="FormFields Required textInputView"><label for="id9">User Name</label><input id="id9" class="formField text" name="10" type="text" /></div>
                </div>
                <div class="WBForgotPasswordFormActions FormActions"><input accesskey="s" style="cursor:hand;cursor:pointer;" class="SendMeNewPasswordAction submit" name="11" value="Send Me New Password" type="submit" /><a accesskey="c" class="CancelAction" href="login.php">Cancel</a></div>
                <div><input name="_s" value="ub2tf69CIj2ujKNM" type="hidden" class="hidden" /><input name="_k" value="sAGyGp8w" type="hidden" class="hidden" /><input name="siteId" value="39624" type="hidden" class="hidden" /><input name="theme" value="standard" type="hidden" class="hidden" /></div>
            </form>
        </div>
    </div><span style="display:none;">customize with forgotPasswordBottom.html in theme directory</span>
