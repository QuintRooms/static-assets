...
<head>
    ...
    <meta content="1h 0s" name="expiresIn" />
...
<body onkeydown="onKeyDown(event)" class="CheckoutMode-WBCheckoutForm3 h4hperkstest events-hotelsforhope-com MemberNotAuthenticated PrivateSite MemberTypeNone WBLoginForm" id="theBody">
...
-->
    ...
    <div class="ArnSupportLinks ArnSupportTop"><a class="ARN_ServiceLinks searchLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;2">Search</a><span class="dvd"> | </span><a class="ARN_ServiceLinks lowRateLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;3">Low Rate Guarantee</a><span class="dvd"> | </span><a class="ARN_ServiceLinks faqLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;4">FAQ</a><span class="dvd"> | </span><a class="ARN_ServiceLinks termsLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;5">Terms &amp; Conditions</a><span class="dvd"> | </span><a class="ARN_ServiceLinks privacyLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;6">Privacy Policy</a><span class="dvd"> | </span><a class="ARN_ServiceLinks supportLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;7">Support</a><span class="dvd"> | </span><a class="ARN_ServiceLinks cancelLink" href="https://events.hotelsforhope.com/v6/login?_s=ub2tf69CIj2ujKNM&amp;_k=UbxoDFr8&amp;siteId=39624&amp;theme=standard&amp;8">Cancel/Modify</a></div>
    <div id="Ce5m5unuxr8t78mwp806km21du" class="SSForm WBLoginFormContainer WBAuthContainer ArnSubPage">
        <style>
            .WBLoginForm {
    ...
    @media only screen and (max-width: 800px) {
        ...
        <div id="theWBLoginFormBody" class="SSFormBody">
            <form accept-charset="utf-8" method="post" action="../index.php" id="theWBLoginForm">
                <div class="WBLoginFormFields">
                    <div id="theUserNameAjax" class="FormFields Required textInputView"><label for="id9">Username/Email</label><input id="id9" class="formField text" name="10" type="text" /></div>
                    <div id="thePasswordAjax" class="FormFields Required passwordInputView"><label for="id11">Password</label><input id="id11" class="formField password" autocomplete="off" name="12" type="password" /></div>
                    <div id="theRememberMeAjax" class="FormFields checkboxView"><input class="formField checkbox" name="13" type="checkbox" /><input name="15" type="hidden" class="hidden" /><label for="id14">Remember Me</label></div>
                </div>
                <div class="WBLoginFormActions FormActions"><input accesskey="l" style="cursor:hand;cursor:pointer;" class="LoginAction submit" name="16" value="Login" type="submit" /><a accesskey="f" class="ForgotPasswordAction" href="forgot-password.php">Forgot Password?</a><a accesskey="c" class="CreateAnAccountAction" href="register.php">Create An Account</a></div>
                <div><input name="_s" value="ub2tf69CIj2ujKNM" type="hidden" class="hidden" /><input name="_k" value="UbxoDFr8" type="hidden" class="hidden" /><input name="siteId" value="39624" type="hidden" class="hidden" /><input name="theme" value="standard" type="hidden" class="hidden" /></div>
            </form>
        </div><span style="display:none;">customize with loginBottom.html in theme directory</span>
    </div>
