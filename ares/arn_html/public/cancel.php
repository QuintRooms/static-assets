...
<head>
    <title>Cancellations or Resend Emails</title>
...
.S30 .conditionalPolicies {display: block !important;}</style>
    ...
    <link rel="canonical" href="https://www.reservetravel.com/v6/cancel-or-resend" />
...
<body onkeydown="onKeyDown(event)" class="CheckoutMode-WBCheckoutForm3 h4hperkstest CanManageOrgs CanManageProfiles CanLogin HandlesPermissionRequests events-hotelsforhope-com MemberAuthenticated PrivateSite MemberTypeWholesale WBResendOrCancelForm" id="theBody">
...
-->
    ...
    <div class="ArnSupportLinks ArnSupportTop"><a class="ARN_ServiceLinks searchLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;5">Search</a><span class="dvd"> | </span><a class="ARN_ServiceLinks lowRateLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;6">Low Rate Guarantee</a><span class="dvd"> | </span><a class="ARN_ServiceLinks faqLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;7">FAQ</a><span class="dvd"> | </span><a class="ARN_ServiceLinks termsLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;8">Terms &amp; Conditions</a><span class="dvd"> | </span><a class="ARN_ServiceLinks privacyLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;9">Privacy Policy</a><span class="dvd"> | </span><a class="ARN_ServiceLinks supportLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;10">Support</a><span class="dvd"> | </span><a class="ARN_ServiceLinks cancelLink" href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;11">Cancel/Modify</a></div>
    <div class="ArnSubPage WBResendOrCancelForm">
        <h1>Cancellations, Modifications, or Resend Receipt</h1>
        <div id="Ccaxjqcddhmghl0gljw05xgu9q" class="SSForm WBResendOrCancelFormContainer">
            <div id="theWBResendOrCancelFormBody" class="SSFormBody">
                <form accept-charset="utf-8" method="post" action="https://events.hotelsforhope.com/v6/cancel-or-resend" id="theWBResendOrCancelForm">
                    <div class="WBResendOrCancelFormFields">
                        <div id="theEmailAddressAjax" class="FormFields Required textInputView"><label for="id12">Email Address</label><input id="id12" class="formField text" name="13" type="text" /></div>
                        <div id="theConfirmationNumberAjax" class="FormFields Required textInputView"><label for="id14">Confirmation or Reference Number</label><input id="id14" class="formField text" name="15" type="text" /></div>
                    </div>
                    <h3 class="emailWarningHeading">Try all of your email addresses.</h3>
                    <p class="emailWarning">If you have several email addresses and can't remember which one you used, you will need to try them all. In order to keep your personal information secure, we cannot tell you your email address.</p>
                    <p class="emailWarning2">If you cannot remember your address you may use our <a href="https://events.hotelsforhope.com/v6/cancel-or-resend?_s=DVDzt5wty523T0tH&amp;_k=begvGqgC&amp;siteId=39624&amp;theme=standard&amp;16">support form</a> to contact an agent for assistance</p>
                    <div class="WBResendOrCancelFormActions FormActions"><input style="cursor:hand;cursor:pointer;" accesskey="c" class="CancelReservationAction submit" name="17" value="Cancel Reservation" type="submit" /><input style="cursor:hand;cursor:pointer;" accesskey="r" class="ResendGuestReceiptEmailAction submit" name="18" value="Resend Guest Receipt Email" type="submit" /><input style="cursor:hand;cursor:pointer;" accesskey="m" class="ModifyReservationAction submit" name="19" value="Modify Reservation" type="submit" /></div>
                    <div><input name="_s" value="DVDzt5wty523T0tH" type="hidden" class="hidden" /><input name="_k" value="begvGqgC" type="hidden" class="hidden" /><input name="siteId" value="39624" type="hidden" class="hidden" /><input name="theme" value="standard" type="hidden" class="hidden" /></div>
                </form>
            </div>
        </div>
    </div>
