...
<head>
    ...
    <meta name="otherPriceUSD" content="2187" />
    <meta name="discount" content="449.36 USD" />
    <meta name="propertyId" content="20498" />
    <meta name="checkIn" content="11/6/2020" />
    <meta name="checkOut" content="11/9/2020" />
    <meta name="roomtType" content="577232|37310|ARN|PKG_NET" />
    <meta name="rateCode" content="234363" />
    <meta name="gateway" content="61" />
                ...
                <table>
                    <tr>
                        <td class="GuestForms" valign="top"><span style="display:none;">customize with detailInfoBeforeGuests.html in theme directory</span>
                            ...
                            <fieldset id="theRoomOneAjax" class="RoomNumber-1 WBGuestFormFields">
                                <legend>Step 2: Enter Room One Info</legend>
                                <div id="theGuestNameAjax1" class="FormFields ArnGuestNames">
                                ...
                                <div id="theCountryAjax1" class="FormFields guestCountryList Required"><label>Country:</label><select id="theCountryList1" class="countryList" onchange="new Ajax.Updater('theStateAjax1','https://events.hotelsforhope.com/v6/details',{'evalScripts':true,'parameters':['_s=DVDzt5wty523T0tH','_k=q6jRkeDl','siteId='+39624,'theme=standard','37',$('theCountryList1').serialize()].join('&amp;')})" name="38">
                                        ...
                                        <option value="43">American Samoa</option>
                                        <option value="44">Andorra</option>
                                        <option value="45">Angola</option>
                                        <option value="46">Anguilla</option>
                                        <option value="47">Antarctica</option>
                                        <option value="48">Antigua/ Barbuda</option>
                                        ...
                                        <option value="54">Azerbaijan</option>
                                        ...
                                        <option value="60">Belgium</option>
                                        ...
                                        <option value="80">Central Africa</option>
                                        ...
                                        <option value="85">Cocos (Keeling) Islands</option>
                                        <option value="86">Colombia</option>
                                        <option value="87">Comoros</option>
                                        ...
                                        <option value="97">Djibouti</option>
                                        <option value="98">Dominica</option>
                                        <option value="99">Dominican Republic</option>
                                        <option value="100">Ecuador</option>
                                        <option value="101">Egypt</option>
                                        <option value="102">El Salvador</option>
                                        <option value="103">Equatorial Guinea</option>
                                        <option value="104">Eritrea</option>
                                        <option value="105">Estonia</option>
                                        <option value="106">Ethiopia</option>
                                        <option value="107">Faeroe Islands</option>
                                        ...
                                        <option value="112">French Polynesia</option>
                                        <option value="113">French Southern Territories</option>
                                        <option value="114">Gabon</option>
                                        <option value="115">Gambia</option>
                                        <option value="116">Georgia</option>
                                        <option value="117">Germany</option>
                                        <option value="118">Ghana</option>
                                        <option value="119">Gibraltar</option>
                                        <option value="120">Greece</option>
                                        <option value="121">Greenland</option>
                                        ...
                                        <option value="126">Guiana</option>
                                        <option value="127">Guinea</option>
                                        <option value="128">Guinea-Bissau</option>
                                        <option value="129">Guyana</option>
                                        <option value="130">Haiti</option>
                                        <option value="131">Heard And Mcdonald Islands</option>
                                        <option value="132">Honduras</option>
                                        <option value="133">Hong Kong</option>
                                        <option value="134">Hungary</option>
                                        ...
                                        <option value="173">Mayotte</option>
                                        <option value="174">Mexico</option>
                                        <option value="175">Micronesia</option>
                                        <option value="176">Moldova</option>
                                        <option value="177">Monaco</option>
                                        <option value="178">Mongolia</option>
                                        <option value="179">Montenegro</option>
                                        <option value="180">Montserrat</option>
                                        <option value="181">Morocco</option>
                                        <option value="182">Mozambique</option>
                                        <option value="183">Myanmar</option>
                                        <option value="184">Namibia</option>
                                        <option value="185">Nauru</option>
                                        <option value="186">Nepal</option>
                                        ...
                                        <option value="196">North Korea</option>
                                        <option value="197">Northern Mariana Islands</option>
                                        <option value="198">Norway</option>
                                        <option value="199">Oman</option>
                                        ...
                                        <option value="207">Pitcairn</option>
                                        ...
                                        <option value="212">Reunion</option>
                                        <option value="213">Romania</option>
                                        <option value="214">Russia</option>
                                        <option value="215">Rwanda</option>
                                        <option value="216">Saint Lucia</option>
                                        ...
                                        <option value="225">Slovak Republic</option>
                                        <option value="226">Slovenia</option>
                                        <option value="227">Solomon Islands</option>
                                        <option value="228">Somalia</option>
                                        <option value="229">South Africa</option>
                                        <option value="230">South Georgia</option>
                                        <option value="231">Spain</option>
                                        <option value="232">Sri Lanka</option>
                                        <option value="233">St. Helena</option>
                                        <option value="234">St. Kitts &amp; Nevis</option>
                                        <option value="235">St. Pierre</option>
                                        <option value="236">St. Vincent &amp; The Grendadines</option>
                                        <option value="237">Sudan</option>
                                        <option value="238">Suriname</option>
                                        <option value="239">Svalbard And Jan Mayen Islands</option>
                                        <option value="240">Swaziland</option>
                                        <option value="241">Sweden</option>
                                        <option value="242">Switzerland</option>
                                        <option value="243">Syria</option>
                                        <option value="244">Taiwan</option>
                                        <option value="245">Tajikistan</option>
                                        <option value="246">Tanzania</option>
                                        <option value="247">Thailand</option>
                                        ...
                                        <option value="252">Tunisia</option>
                                        <option value="253">Turkey</option>
                                        <option value="254">Turkmenistan</option>
                                        <option value="255">Turks And Caicos Islands</option>
                                        <option value="256">Tuvalu</option>
                                        <option value="257">U.S. Minor Outlying Islands</option>
                                        ...
                                        <option value="264">Vanuatu</option>
                                        <option value="265">Vatican City State</option>
                                        <option value="266">Venezuela</option>
                                        <option value="267">Viet Nam</option>
                                        <option value="268">Virgin Islands (British)</option>
                                        <option value="269">Virgin Islands (U.S.)</option>
                                        <option value="270">Wallis And Futuna Islands</option>
                                        <option value="271">Western Sahara</option>
                                        <option value="272">Western Samoa</option>
                                ...
                                <div id="theStateAjax1" class="FormFields guestStateList Required"><label>State: </label><select class="stateList" name="276">
                                        ...
                                        <option value="280">Arizona</option>
                                        <option value="281">Arkansas</option>
                                        <option value="282">California</option>
                                        <option value="283">Colorado</option>
                                        <option value="284">Connecticut</option>
                                        <option value="285">Delaware</option>
                                        <option value="286">District of Columbia</option>
                                        <option value="287">Florida</option>
                                        <option value="288">Georgia</option>
                                        <option value="289">Hawaii</option>
                                        <option value="290" selected="selected">Idaho</option>
                                        <option value="291">Illinois</option>
                                        <option value="292">Indiana</option>
                                        <option value="293">Iowa</option>
                                        <option value="294">Kansas</option>
                                        <option value="295">Kentucky</option>
                                        <option value="296">Louisiana</option>
                                        <option value="297">Maine</option>
                                        <option value="298">Maryland</option>
                                        <option value="299">Massachusetts</option>
                                        <option value="300">Michigan</option>
                                        <option value="301">Minnesota</option>
                                        <option value="302">Mississippi</option>
                                        <option value="303">Missouri</option>
                                        <option value="304">Montana</option>
                                        <option value="305">Nebraska</option>
                                        <option value="306">Nevada</option>
                                        <option value="307">New Hampshire</option>
                                        <option value="308">New Jersey</option>
                                        <option value="309">New Mexico</option>
                                        <option value="310">New York</option>
                                        <option value="311">North Carolina</option>
                                        <option value="312">North Dakota</option>
                                        <option value="313">Ohio</option>
                                        <option value="314">Oklahoma</option>
                                        <option value="315">Oregon</option>
                                        <option value="316">Pennsylvania</option>
                                        <option value="317">Puerto Rico</option>
                                        <option value="318">Rhode Island</option>
                                        <option value="319">South Carolina</option>
                                        <option value="320">South Dakota</option>
                                        <option value="321">Tennessee</option>
                                        <option value="322">Texas</option>
                                        <option value="323">Utah</option>
                                        <option value="324">Vermont</option>
                                        <option value="325">Virgin Islands</option>
                                        <option value="326">Virginia</option>
                                        <option value="327">Washington</option>
                                        <option value="328">West Virginia</option>
                                        ...
                                        <tr>
                                            <td>
                                                <div id="theExpirationMonthAjax" class="guestExpiresMonth"><select class="cardMonth" name="333">
                                                        ...
                                                        <option value="337">03</option>
                                                        <option value="338">04</option>
                                                        <option value="339">05</option>
                                                        <option value="340">06</option>
                                                        <option value="341">07</option>
                                                        <option value="342">08</option>
                                                        <option value="343">09</option>
                                                        <option value="344">10</option>
                                                        <option value="345">11</option>
                                                        <option value="346">12</option>
                                                    </select></div>
                                            </td>
                                            <td>
                                                <div id="theExpirationYearAjax" class="guestExpiresYear"><select class="cardYear" name="347">
                                                        ...
                                                        <option value="351">2022</option>
                                                        <option value="352">2023</option>
                                                        <option value="353">2024</option>
                                                        <option value="354">2025</option>
                                                        <option value="355">2026</option>
                                                        <option value="356">2027</option>
                                                        <option value="357">2028</option>
                                                        <option value="358">2029</option>
                                                        <option value="359">2030</option>
                                                        <option value="360">2031</option>
                                                        <option value="361">2032</option>
                                                        <option value="362">2033</option>
                                                    </select></div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <fieldset id="theRoomTwoAjax" class="RoomNumber-2 WBGuestFormFields">
                                ...
                                <div id="theCountryAjax2" class="FormFields guestCountryList Required"><label>Country:</label><select id="theCountryList2" class="countryList" onchange="new Ajax.Updater('theStateAjax2','https://events.hotelsforhope.com/v6/details',{'evalScripts':true,'parameters':['_s=DVDzt5wty523T0tH','_k=q6jRkeDl','siteId='+39624,'theme=standard','382',$('theCountryList2').serialize()].join('&amp;')})" name="383">
                                        ...
                                        <option value="389">Andorra</option>
                                        <option value="390">Angola</option>
                                        <option value="391">Anguilla</option>
                                        <option value="392">Antarctica</option>
                                        <option value="393">Antigua/ Barbuda</option>
                                        <option value="394">Argentina</option>
                                        <option value="395">Armenia</option>
                                        <option value="396">Aruba</option>
                                        <option value="397">Australia</option>
                                        <option value="398">Austria</option>
                                        <option value="399">Azerbaijan</option>
                                        <option value="400">Bahamas</option>
                                        <option value="401">Bahrain</option>
                                        <option value="402">Bangladesh</option>
                                        <option value="403">Barbados</option>
                                        <option value="404">Belarus</option>
                                        <option value="405">Belgium</option>
                                        <option value="406">Belize</option>
                                        <option value="407">Benin</option>
                                        <option value="408">Bermuda</option>
                                        <option value="409">Bhutan</option>
                                        <option value="410">Bolivia</option>
                                        <option value="411">Bosnia</option>
                                        <option value="412">Botswana</option>
                                        <option value="413">Bouvet Island</option>
                                        <option value="414">Brazil</option>
                                        <option value="415">British Indian Ocean Territory</option>
                                        <option value="416">Brunei Darussalam</option>
                                        <option value="417">Bulgaria</option>
                                        <option value="418">Burkina Faso</option>
                                        <option value="419">Burundi</option>
                                        <option value="420">Cambodia</option>
                                        <option value="421">Cameroon</option>
                                        <option value="422">Canada</option>
                                        <option value="423">Cape Verde</option>
                                        <option value="424">Cayman Islands</option>
                                        <option value="425">Central Africa</option>
                                        <option value="426">Chad</option>
                                        <option value="427">Chile</option>
                                        <option value="428">China</option>
                                        <option value="429">Christmas Island</option>
                                        <option value="430">Cocos (Keeling) Islands</option>
                                        <option value="431">Colombia</option>
                                        <option value="432">Comoros</option>
                                        <option value="433">Congo</option>
                                        <option value="434">Cook Islands</option>
                                        <option value="435">Costa Rica</option>
                                        <option value="436">Cote D'Ivoire</option>
                                        <option value="437">Croatia</option>
                                        <option value="438">Cuba</option>
                                        <option value="439">Cyprus</option>
                                        <option value="440">Czech Republic</option>
                                        ...
                                        <option value="448">Equatorial Guinea</option>
                                        <option value="449">Eritrea</option>
                                        <option value="450">Estonia</option>
                                        <option value="451">Ethiopia</option>
                                        <option value="452">Faeroe Islands</option>
                                        <option value="453">Falkland Islands</option>
                                        <option value="454">Fiji</option>
                                        <option value="455">Finland</option>
                                        <option value="456">France</option>
                                        <option value="457">French Polynesia</option>
                                        <option value="458">French Southern Territories</option>
                                        <option value="459">Gabon</option>
                                        <option value="460">Gambia</option>
                                        <option value="461">Georgia</option>
                                        <option value="462">Germany</option>
                                        <option value="463">Ghana</option>
                                        <option value="464">Gibraltar</option>
                                        <option value="465">Greece</option>
                                        <option value="466">Greenland</option>
                                        <option value="467">Grenada</option>
                                        <option value="468">Guadeloupe</option>
                                        <option value="469">Guam</option>
                                        <option value="470">Guatemala</option>
                                        <option value="471">Guiana</option>
                                        <option value="472">Guinea</option>
                                        <option value="473">Guinea-Bissau</option>
                                        <option value="474">Guyana</option>
                                        <option value="475">Haiti</option>
                                        <option value="476">Heard And Mcdonald Islands</option>
                                        <option value="477">Honduras</option>
                                        <option value="478">Hong Kong</option>
                                        <option value="479">Hungary</option>
                                        <option value="480">Iceland</option>
                                        <option value="481">India</option>
                                        <option value="482">Indonesia</option>
                                        <option value="483">Iran</option>
                                        <option value="484">Iraq</option>
                                        <option value="485">Ireland</option>
                                        <option value="486">Israel</option>
                                        <option value="487">Italy</option>
                                        <option value="488">Jamaica</option>
                                        <option value="489">Japan</option>
                                        <option value="490">Jordan</option>
                                        <option value="491">Kazakhstan</option>
                                        <option value="492">Kenya</option>
                                        <option value="493">Kiribati</option>
                                        <option value="494">Korea</option>
                                        <option value="495">Kuwait</option>
                                        <option value="496">Kyrgyzstan</option>
                                        <option value="497">Laos</option>
                                        <option value="498">Latvia</option>
                                        <option value="499">Lebanon</option>
                                        <option value="500">Lesotho</option>
                                        <option value="501">Liberia</option>
                                        <option value="502">Libya</option>
                                        <option value="503">Liechtenstein</option>
                                        <option value="504">Lithuania</option>
                                        <option value="505">Luxembourg</option>
                                        <option value="506">Macau</option>
                                        <option value="507">Macedonia</option>
                                        <option value="508">Madagascar</option>
                                        <option value="509">Malawi</option>
                                        <option value="510">Malaysia</option>
                                        <option value="511">Maldives</option>
                                        <option value="512">Mali</option>
                                        <option value="513">Malta</option>
                                        <option value="514">Marshall Islands</option>
                                        <option value="515">Martinique</option>
                                        <option value="516">Mauritania</option>
                                        <option value="517">Mauritius</option>
                                        <option value="518">Mayotte</option>
                                        <option value="519">Mexico</option>
                                        <option value="520">Micronesia</option>
                                        <option value="521">Moldova</option>
                                        <option value="522">Monaco</option>
                                        <option value="523">Mongolia</option>
                                        <option value="524">Montenegro</option>
                                        <option value="525">Montserrat</option>
                                        <option value="526">Morocco</option>
                                        <option value="527">Mozambique</option>
                                        <option value="528">Myanmar</option>
                                        <option value="529">Namibia</option>
                                        <option value="530">Nauru</option>
                                        <option value="531">Nepal</option>
                                        <option value="532">Netherlands</option>
                                        <option value="533">Netherlands Antilles</option>
                                        <option value="534">New Caledonia</option>
                                        <option value="535">New Zealand</option>
                                        <option value="536">Nicaragua</option>
                                        <option value="537">Niger</option>
                                        <option value="538">Nigeria</option>
                                        <option value="539">Niue</option>
                                        <option value="540">Norfolk Island</option>
                                        <option value="541">North Korea</option>
                                        <option value="542">Northern Mariana Islands</option>
                                        <option value="543">Norway</option>
                                        <option value="544">Oman</option>
                                        <option value="545">Pakistan</option>
                                        <option value="546">Palau</option>
                                        <option value="547">Panama</option>
                                        <option value="548">Papua New Guinea</option>
                                        <option value="549">Paraguay</option>
                                        <option value="550">Peru</option>
                                        <option value="551">Philippines</option>
                                        <option value="552">Pitcairn</option>
                                        <option value="553">Poland</option>
                                        <option value="554">Portugal</option>
                                        <option value="555">Puerto Rico</option>
                                        <option value="556">Qatar</option>
                                        <option value="557">Reunion</option>
                                        <option value="558">Romania</option>
                                        <option value="559">Russia</option>
                                        <option value="560">Rwanda</option>
                                        <option value="561">Saint Lucia</option>
                                        <option value="562">San Marino</option>
                                        <option value="563">Sao Tome And Principe</option>
                                        <option value="564">Saudi Arabia</option>
                                        <option value="565">Senegal</option>
                                        <option value="566">Serbia</option>
                                        <option value="567">Seychelles</option>
                                        <option value="568">Sierra Leone</option>
                                        <option value="569">Singapore</option>
                                        <option value="570">Slovak Republic</option>
                                        <option value="571">Slovenia</option>
                                        <option value="572">Solomon Islands</option>
                                        <option value="573">Somalia</option>
                                        <option value="574">South Africa</option>
                                        <option value="575">South Georgia</option>
                                        <option value="576">Spain</option>
                                        <option value="577">Sri Lanka</option>
                                        <option value="578">St. Helena</option>
                                        <option value="579">St. Kitts &amp; Nevis</option>
                                        <option value="580">St. Pierre</option>
                                        <option value="581">St. Vincent &amp; The Grendadines</option>
                                        <option value="582">Sudan</option>
                                        <option value="583">Suriname</option>
                                        <option value="584">Svalbard And Jan Mayen Islands</option>
                                        <option value="585">Swaziland</option>
                                        <option value="586">Sweden</option>
                                        <option value="587">Switzerland</option>
                                        <option value="588">Syria</option>
                                        <option value="589">Taiwan</option>
                                        <option value="590">Tajikistan</option>
                                        <option value="591">Tanzania</option>
                                        <option value="592">Thailand</option>
                                        <option value="593">Togo</option>
                                        <option value="594">Tokelau</option>
                                        <option value="595">Tonga</option>
                                        <option value="596">Trinidad And Tobago</option>
                                        <option value="597">Tunisia</option>
                                        <option value="598">Turkey</option>
                                        <option value="599">Turkmenistan</option>
                                        <option value="600">Turks And Caicos Islands</option>
                                        <option value="601">Tuvalu</option>
                                        <option value="602">U.S. Minor Outlying Islands</option>
                                        <option value="603">Uganda</option>
                                        <option value="604">Ukraine</option>
                                        <option value="605">United Arab Emirates</option>
                                        <option value="606">United Kingdom</option>
                                        <option value="607">Uruguay</option>
                                        <option value="608">Uzbekistan</option>
                                        <option value="609">Vanuatu</option>
                                        <option value="610">Vatican City State</option>
                                        <option value="611">Venezuela</option>
                                        <option value="612">Viet Nam</option>
                                        <option value="613">Virgin Islands (British)</option>
                                        <option value="614">Virgin Islands (U.S.)</option>
                                        <option value="615">Wallis And Futuna Islands</option>
                                        <option value="616">Western Sahara</option>
                                        <option value="617">Western Samoa</option>
                                ...
                                <div id="theStateAjax2" class="FormFields guestStateList Required"><label>State: </label><select class="stateList" name="621">
                                        ...
                                        <option value="625">Arizona</option>
                                        <option value="626">Arkansas</option>
                                        <option value="627">California</option>
                                        <option value="628">Colorado</option>
                                        <option value="629">Connecticut</option>
                                        <option value="630">Delaware</option>
                                        <option value="631">District of Columbia</option>
                                        <option value="632">Florida</option>
                                        <option value="633">Georgia</option>
                                        <option value="634">Hawaii</option>
                                        <option value="635" selected="selected">Idaho</option>
                                        <option value="636">Illinois</option>
                                        <option value="637">Indiana</option>
                                        <option value="638">Iowa</option>
                                        <option value="639">Kansas</option>
                                        <option value="640">Kentucky</option>
                                        <option value="641">Louisiana</option>
                                        <option value="642">Maine</option>
                                        <option value="643">Maryland</option>
                                        <option value="644">Massachusetts</option>
                                        <option value="645">Michigan</option>
                                        <option value="646">Minnesota</option>
                                        <option value="647">Mississippi</option>
                                        <option value="648">Missouri</option>
                                        <option value="649">Montana</option>
                                        <option value="650">Nebraska</option>
                                        <option value="651">Nevada</option>
                                        <option value="652">New Hampshire</option>
                                        <option value="653">New Jersey</option>
                                        <option value="654">New Mexico</option>
                                        <option value="655">New York</option>
                                        <option value="656">North Carolina</option>
                                        <option value="657">North Dakota</option>
                                        <option value="658">Ohio</option>
                                        <option value="659">Oklahoma</option>
                                        <option value="660">Oregon</option>
                                        <option value="661">Pennsylvania</option>
                                        <option value="662">Puerto Rico</option>
                                        <option value="663">Rhode Island</option>
                                        <option value="664">South Carolina</option>
                                        <option value="665">South Dakota</option>
                                        <option value="666">Tennessee</option>
                                        <option value="667">Texas</option>
                                        <option value="668">Utah</option>
                                        <option value="669">Vermont</option>
                                        <option value="670">Virgin Islands</option>
                                        <option value="671">Virginia</option>
                                        <option value="672">Washington</option>
                                        <option value="673">West Virginia</option>
                                        ...
                                        <tr>
                                            <td>
                                                <div id="theExpirationMonthAjax" class="guestExpiresMonth"><select class="cardMonth" name="678">
                                                        ...
                                                        <option value="682">03</option>
                                                        <option value="683">04</option>
                                                        <option value="684">05</option>
                                                        <option value="685">06</option>
                                                        <option value="686">07</option>
                                                        <option value="687">08</option>
                                                        <option value="688">09</option>
                                                        <option value="689">10</option>
                                                        <option value="690">11</option>
                                                        <option value="691">12</option>
                                                    </select></div>
                                            </td>
                                            <td>
                                                <div id="theExpirationYearAjax" class="guestExpiresYear"><select class="cardYear" name="692">
                                                        ...
                                                        <option value="696">2022</option>
                                                        <option value="697">2023</option>
                                                        <option value="698">2024</option>
                                                        <option value="699">2025</option>
                                                        <option value="700">2026</option>
                                                        <option value="701">2027</option>
                                                        <option value="702">2028</option>
                                                        <option value="703">2029</option>
                                                        <option value="704">2030</option>
                                                        <option value="705">2031</option>
                                                        <option value="706">2032</option>
                                                        <option value="707">2033</option>
                                                    </select></div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <fieldset id="theHotel" class="ArnBox 4StarsHotel">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" class="checkOutSummaryTable">
                                    <tr class="checkInRow">
                                        ...
                                        <td>Friday, November 6, 2020 </td>
                                    </tr>
                                    <tr class="checkOutRow">
                                        <th nowrap="nowrap">Checkout</th>
                                        <td>Monday, November 9, 2020 </td>
                                    </tr>
                                    <tr class="numberOfNights">
                                        <th>3 Night Stay</th>
                                        <td></td>
                                    </tr>
                                    <tr class="numberOfAdults">
                                        <th nowrap="nowrap">4 Adults</th>
                                        <td>(Aged 18+)</td>
                                    </tr>
                                    <tr class="numberOfChildren">
                                        <th nowrap="nowrap">0 Children</th>
                                        <td>(Aged 0-17)</td>
                                    </tr>
                                </table>
                            </fieldset>
                            <fieldset id="theCharges" class="ArnBox">
                                ...
                                <table class="totalsTable" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr class="dueNowRow">
                                        <th style="border-bottom: 0px;">Due Now:</th>
