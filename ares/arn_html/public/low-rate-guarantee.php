...
<head>
    <title>Low Rate Guarantee</title>
    ...
    <meta content="59m 51s" name="expiresIn" />
...
.S30 .conditionalPolicies {display: block !important;}</style>
    ...
    <link rel="canonical" href="https://www.reservetravel.com/v6/low-rate-guarantee" />
...
<body onkeydown="onKeyDown(event)" class="CheckoutMode-WBCheckoutForm3 h4hperkstest CanManageOrgs CanManageProfiles CanLogin HandlesPermissionRequests events-hotelsforhope-com MemberAuthenticated PrivateSite MemberTypeWholesale WBRateGuaranteeForm2" id="theBody">
...
-->
    ...
    <div class="ArnSupportLinks ArnSupportTop"><a class="ARN_ServiceLinks searchLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;5">Search</a><span class="dvd"> | </span><a class="ARN_ServiceLinks lowRateLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;6">Low Rate Guarantee</a><span class="dvd"> | </span><a class="ARN_ServiceLinks faqLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;7">FAQ</a><span class="dvd"> | </span><a class="ARN_ServiceLinks termsLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;8">Terms &amp; Conditions</a><span class="dvd"> | </span><a class="ARN_ServiceLinks privacyLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;9">Privacy Policy</a><span class="dvd"> | </span><a class="ARN_ServiceLinks supportLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;10">Support</a><span class="dvd"> | </span><a class="ARN_ServiceLinks cancelLink" href="https://events.hotelsforhope.com/v6/low-rate-guarantee?_s=DVDzt5wty523T0tH&amp;_k=2hRdQbak&amp;siteId=39624&amp;theme=standard&amp;11">Cancel/Modify</a></div>
    <div class="ArnSubPage WBRateGuaranteeForm">
        <h1>Rate Guarantee Form</h1>
        <p>Property reservations booked through our website are guaranteed to be available at the lowest rate available compared to any publicly available website (no membership or log-in required).</p>
        <p>Within twenty-four (24) hours of your original property reservation, If you find a lower rate at the exact same property, for the exact same room type, exact same dates, and the exact same terms (i.e. cancellation policy, deposit policy, etc.) the process is simple:</p>
        <p>Please fill out the following form to include the web address of the publicly accessible website and attach a screen shot that includes the dates searched, the property name and address and the room type and terms you found and we will reimburse you for the difference; or, cancel your reservation and re-book using the lower rates found for no additional fee. Refund amount will be credited to the same credit card used to make the reservation.</p>
        <p>This rate guarantee does not apply to non-cancellable rates, rates booked for dates the property's cancellation penalty terms would apply, or any special group, event, member, or association rate.</p>
        <div id="C8c70k1ygtf8g47andnh30luvl" class="SSForm WBRateGuaranteeForm2Container">
            <div id="theWBRateGuaranteeForm2Body" class="SSFormBody">
                <form accept-charset="utf-8" method="post" action="https://events.hotelsforhope.com/v6/low-rate-guarantee" id="theWBRateGuaranteeForm2" enctype="multipart/form-data">
                    <div class="WBRateGuaranteeForm2Fields">
                        <div id="theConfirmationNumberAjax" class="FormFields Required textInputView"><label for="id12">Confirmation Number</label><input id="id12" class="formField text" name="13" type="text" /></div>
                        <div id="theGuestNameAjax" class="FormFields Required textInputView"><label for="id14">Guest Name</label><input id="id14" class="formField text" name="15" type="text" /></div>
                        <div id="theGuestEmailAddressAjax" class="FormFields Required textInputView"><label for="id16">Guest Email Address</label><input id="id16" class="formField text" name="17" type="text" /></div>
                        <div id="theWebAddressOfLowerRateAjax" class="FormFields Required textInputView"><label for="id18">Web Address of website in which lower rate was found</label><input id="id18" class="formField text" name="19" type="text" /></div>
                        <div id="theUploadScreenShotAjax" class="FormFields Required fileUploadView"><label for="id20">Upload screen shot</label><input id="id20" class="formField file" name="21" type="file" /></div>
                    </div>
                    <div class="WBRateGuaranteeForm2Actions FormActions"><input accesskey="s" style="cursor:hand;cursor:pointer;" class="SendRequestAction submit" name="22" value="Send Request" type="submit" /></div>
                    <div><input name="_s" value="DVDzt5wty523T0tH" type="hidden" class="hidden" /><input name="_k" value="2hRdQbak" type="hidden" class="hidden" /><input name="siteId" value="39624" type="hidden" class="hidden" /><input name="theme" value="standard" type="hidden" class="hidden" /></div>
                </form>
            </div>
        </div>
    </div>
