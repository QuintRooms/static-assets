                        ...
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    ...
                                    return e.abrupt('return');
                                case 2:
                                    return (e.next = 4), y.waitForSelectorInDOM('header');
                                case 4:
                                    document
                                        .querySelector('header')
                                        .insertAdjacentHTML(
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo.png'), logo_outbound_url: 'https://www.aclfestival.com/'},
