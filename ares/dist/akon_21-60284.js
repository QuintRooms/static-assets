!(function (e) {
    ...
    function (e, t, n) {
        ...
        $ ||
            ...
            (n(30).f = K),
            (M.f = ee),
            i && !n(17) && c(N, 'propertyIsEnumerable', K, !0),
            (p.f = function (e) {
                return z(h(e));
            })),
    ...
    function (e, t, n) {
        ...
        var p = new (function () {
            return {
                ...
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://www.a-kon.com/'},
