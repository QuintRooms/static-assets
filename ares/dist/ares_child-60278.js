!(function (e) {
        ...
        var r,
            ...
            Y = !!(function () {
                try {
                    ...
                    return (C || 'function' == typeof PromiseRejectionEvent) && e.then(E) instanceof t && 0 !== M.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            P = function (e) {
                var t;
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var _, S = '', w = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var k = String(b[0]), A = u(l(a(b.index), f.length), 0), M = [], L = 1; L < b.length; L++) M.push(void 0 === (_ = b[L]) ? _ : String(_));
                        var C = b.groups;
                        if (h) {
                        ...
                        A >= w && ((S += f.slice(w, A) + q), (w = A + k.length));
                    }
                    return S + f.slice(w);
                },
            ];
                ...
                s = function (e, n, r) {
                    try {
                        ...
                        var v = u || 0,
                            ...
                            _ = d || 0,
                            S = f || 0;
                        return h ? new Date(Date.UTC(y, g, m, v, b, _, S + 60 * h.offset * 1e3)) : r ? new Date(Date.UTC(y, g, m, v, b, _, S)) : new Date(y, g, m, v, b, _, S);
                    } catch (e) {
                        return new Date('');
                    }
                };
        ...
        var r = n(1),
            ...
            G =
                ...
                u(function () {
                    ...
                    ? function (e, t, n) {
                          var r = q(N, t);
                          r && delete N[t], Y(e, t, n), r && e !== N && Y(N, t, r);
                      }
                    : Y,
            z = function (e) {
            ...
            Z = function (e, t, n) {
                return (
                    ...
                    v(n),
                    o(I, t)
                        ? (n.enumerable ? (o(e, D) && e[D][t] && (e[D][t] = !1), (n = k(n, {enumerable: x(0, !1)}))) : (o(e, D) || Y(e, D, x(1, {})), (e[D][t] = !0)), G(e, t, n))
                        : Y(e, t, n)
                );
            },
            J = function (e, t) {
                v(e);
                for (var n, r = y((t = S(t))), o = 0, i = r.length; i > o; ) Z(e, (n = r[o++]), t[n]);
                return e;
            },
            K = function (e) {
            ...
            ee = function (e) {
                for (var t, n = e === N, r = P(n ? F : S(e)), i = [], a = 0; r.length > a; ) !o(I, (t = r[a++])) || (n && !o(N, t)) || i.push(I[t]);
                return i;
            };
        $ ||
            (c(
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            var v,
                ...
                L = M || S(m),
                C = m ? (x ? S('entries') : L) : void 0,
                E = ('Array' == t && A.entries) || M;
            if (
                (E && (_ = l(E.call(new e()))) !== Object.prototype && _.next && (u(_, w, !0), r || 'function' == typeof _[d] || a(_, d, h)),
                x &&
                    M &&
                    'values' !== M.name &&
                    ((k = !0),
                ...
                if (((v = {values: x ? L : S('values'), keys: y ? L : S('keys'), entries: C}), g)) for (b in v) b in A || i(A, b, v[b]);
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(64), n(65), n(74), n(35), n(88), n(36), n(29), n(92), n(94), n(38), n(58), n(98), n(59), n(101), n(102), n(105), n(42);
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: 'calculateNights',
                            value: function () {
                                var e = q(document.querySelector('input#theCheckIn').value).format('MM/DD/YYYY'),
                                    t = q(document.querySelector('input#theCheckOut').value).format('MM/DD/YYYY');
                                return q(t).diff(q(e), 'days');
                            },
                        },
                        {
                            key: 'matchMediaQuery',
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                var t = q();
                                return q(e).diff(t, 'milliseconds') < 0;
                            },
                        },
                    ]) && E(t.prototype, n),
                    r && E(t, r),
                            ...
                            document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                ...
                                function S(e) {
                                    Object.keys(e).forEach(function (t) {
                                        '' !== e[t].value && null !== e[t].value && void 0 !== e[t].value && void 0 !== e[t].key && _.searchParams.append(e[t].key, e[t].value);
                                    });
                                }
                                'standard' === n.getMetaTagContent('theme')
                                    ? ((u = O(document.querySelector('input#theCheckIn').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                      (d = O(document.querySelector('input#theCheckOut').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                      (f = O(d).diff(O(u), 'days')))
                                    : 'mandarin' === n.getMetaTagContent('theme') || 'tw_mandarin' === n.getMetaTagContent('theme')
                                    ? ((u = O(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                      (d = O(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                      (f = O(d).diff(O(u), 'days')),
                                      (u = O(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('YYYY/M/D')),
                                      (d = O(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('YYYY/M/D')))
                                    : ((u = O(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                      (d = O(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                      (f = O(d).diff(O(u), 'days')),
                                      (u = O(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('D/M/YYYY')),
                                      (d = O(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('D/M/YYYY'))),
                                    'standard' !== n.getMetaTagContent('theme') &&
                                    ...
                                    (window.location.href = decodeURIComponent(_));
                            }),
                                (function (e) {
                    ...
                    (n = [
                                                                ...
                                                                case 9:
                                                                    'cug' === e.site_config.site_type &&
                                                                                ...
                                                                                regeneratorRuntime.mark(function e() {
                                                                                    return regeneratorRuntime.wrap(function (e) {
                                                                                        for (;;)
                                                                                            switch ((e.prev = e.next)) {
                                                                                                case 0:
                                                                                                    W.appendToParent('#commands', 'header');
                                                                                                case 1:
                                                                                                case 'end':
                                                                                                    return e.stop();
                                                                                            }
                                                                        ...
                                                                        'property-detail' === e.page_name &&
                                                                            ...
                                                                            W.updateHTML('.SinglePropDetail .Map a', 'Map'),
                                                                            W.updateHTML('.SinglePropDetail .Reviews a', 'Reviews'),
                                                                            W.updateHTML('.SinglePropDetail .OptionsPricing a', 'Rooms'),
                                                                            W.updateHTML('.SinglePropDetail .Details a', 'General Info'),
                                                                            e.isPropByGateway(
                                                                            ...
                                                                            W.moveElementIntoExistingWrapper(
                                                                        ...
                                                                        'checkout' === e.page_name &&
                                                                            ...
                                                                            W.updateAttribute('#theEmailAddressAjax input', 'email', 'type'),
                                                                            W.updateAttribute('.CheckOutForm #theCountryCode', 'numeric', 'inputmode'),
                                                                            W.updateAttribute('.CheckOutForm #theAreaCode', 'numeric', 'inputmode'),
                                                                            W.updateAttribute('.CheckOutForm #thePhoneNumber', 'numeric', 'inputmode'),
                                                                            W.updateAttribute('.CheckOutForm #theCreditCardNumber', 'numeric', 'inputmode'),
                                                                            W.updateAttribute('.CheckOutForm #theCvvCode', 'numeric', 'inputmode'),
                                                                            W.appendToParent('#theMarketingOptInAjax', '#theConfirmCheckboxesAjax'),
                                                                            W.updateHTML('#theCharges legend', 'Rate Info'),
                                                                            W.updateHTML('.taxFeeRow th', '<span>Taxes:</span>'),
                                                                            W.updateHTML('#theHotel legend', 'Reservation Summary'),
                                                                            e.formatCheckoutForm(),
                                                                            e.setupReservationSummaryContainer(),
                                                                            W.moveElementIntoExistingWrapper('#theBookingPage #theRateDescription', '#theHotel', 'beforeEnd'),
                                                                            W.emailVerificationSetup(),
                                                                            e.fixCheckoutInputTabOrder(),
                                                                            W.selectCheckboxOnLabelClick('.confirmationWarning, .confirmationAgreement, #theMarketingOptInAjax')),
                                                                        ...
                                                                        document.querySelector('.RootBody') &&
                                                                            ...
                                                                            W.moveOrphanedElementsIntoNewWrapper(
                                                                            ...
                                                                            W.selectCheckboxOnLabelClick('.ArnSearchField div')),
                                                                        W.updateHTML('#thePassCodeAjax label', 'Promocode'),
                                                                        W.updateHTML('#theUserNameAjax label', 'Username/Email'),
                                                                        W.createHTML('<h1>Login</h1>', '#theWBLoginFormBody form', 'beforeBegin'),
                                                                        W.createHTML('<h1>Register</h1>', '#theWBValidatedRegistrationFormBody form', 'beforeBegin'),
                                                                        W.createHTML('<h1>Forgot Password?</h1>', '#theWBForgotPasswordFormBody form', 'beforeBegin'),
                                                                        W.createHTML(
                                                                                            ...
                                                                                            switch ((t.prev = t.next)) {
                                                                                                case 0:
                                                                                                    return (
                                                                                                        (e.map_loaded = !0),
                                                                                                        (t.next = 3),
                                                                                                        W.waitForSelectorInDOM('.pollingFinished')
                                                                                                    );
                                                                                                case 3:
                                                                        ...
                                                                        W.waitForSelectorInDOM('.pollingFinished').then(
                                                                            (function () {
                                                                                var t = I(
                                                                                    regeneratorRuntime.mark(function t(n) {
                                                                                        return regeneratorRuntime.wrap(function (t) {
                                                                                                ...
                                                                                                switch ((t.prev = t.next)) {
                                                                                                    case 0:
                                                                                                        if (
                                                                                                            ('hold-rooms' === e.page_name &&
                                                                                                                ...
                                                                                                                W.addClass('ArnSearchContainerMainDiv', 'ArnSubPage')),
                                                                                                    ...
                                                                                                    case 3:
                                                                                                        return (
                                                                                                            ...
                                                                                                            e.moveReviewsIntoPropNameContainer(),
                                                                                                            W.updateAttribute('.ArnShowRatesLink', '_blank', 'target'),
                                                                                                            e.movePropClassBelowPropName(),
                                                                                                            W.selectCheckboxOnLabelClick('.ArnSearchField div'),
                                                                                                            W.updateHTML('#ShowHotelOnMap', 'Open Map'),
                                                                                                            W.updateHTML('.ArnShowRatesLink', 'Book Rooms'),
                                                                                                            W.updateHTML('.lblRating', 'Stars'),
                                                                                                            W.updateHTML('.lblCurrency', 'Currency'),
                                                                                                            W.updateHTML('.lblAmenities', 'Amenities'),
                                                                                                            W.updateHTML('.lblNearbyCities', 'Nearby Cities'),
                                                                                                            W.updateHTML('.lblPropertyType', 'Property Type'),
                                                                                                            W.updateHTML('.ArnSortBy', '<div class="sort">Sort</div>'),
                                                                                                            W.updateHTML('.ArnSearchHeader', 'Update Search'),
                                                                                                            W.moveElementIntoExistingWrapper(
                                                                                                                '.ArnPropClass',
                                                                                                                '.ArnPropName',
                                                                                                                'beforeEnd'
                                                                                                            ...
                                                                                                            (t.next = 32),
                                                                                                            W.waitForSelectorInDOM('#pagerBottomAjax').then(function () {
                                                                                                                W.appendToParent('#pagerBottomAjax', '#currentPropertyPage');
                                                                                                            })
                                                                                                        );
                                                                                                    case 32:
                                                                                                        return (
                                                                                                            (t.next = 34),
                                                                                                            W.waitForSelectorInDOM('.ArnSortContainer').then(function () {
                                                                                                                W.createWrapper(
                                                                                                    ...
                                                                                                    case 34:
                                                                                                        ...
                                                                                                        return (t.next = 38), W.waitForSelectorInDOM('#ArnPropertyMap');
                                                                                                    case 38:
                                                                                                        document.querySelector('.leaflet-control-scale-line') ||
                                                                                                            L.control.scale().addTo(window.ArnMap),
                                                                                                            e.useLogoForVenueMapMarker(),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                window.matchMedia('(max-width:800px)').matches &&
                                    ...
                                    W.moveOrphanedElementsIntoNewWrapper(document.querySelectorAll('#theStayPolicies *'), 'policies-container', '#theStayPolicies', 'beforeEnd'),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                o &&
                                    ...
                                    W.createHTML('<span class="date-container">'.concat(e, ' - ').concat(n), '#theHotelAddress', 'beforeBegin'),
                                    W.moveElementIntoExistingWrapper('.totalRow .discount', '.theHotelName', 'afterEnd'));
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                e.forEach(function (e) {
                                    (t += 1),
                                        ...
                                        W.updateHTML('#theCreditCardBillingNameAjax'.concat(t - 1, ' label'), "Cardholder's Name"),
                                        W.updateHTML('#theBillingAddressAjax'.concat(t - 1, ' label'), 'Billing Address'),
                                        W.updateHTML('.RoomNumber-'.concat(t, ' > legend'), 'Billing Info'),
                                        t > 1 && W.updateHTML('.RoomNumber-'.concat(t, ' > legend'), 'Billing Info - Room '.concat(t)),
                                        W.createHTML('<legend>Credit Card Info</legend>', '.RoomNumber-'.concat(t, ' .guestBillingAddress'), 'beforeBegin'),
                                        W.updateHTML(
                                            '.cardNumber label',
                            ...
                            value: function (e) {
                                document.querySelector('#theCopyInfoAjax input') &&
                                    document.querySelector('#theCopyInfoAjax input').addEventListener('click', function () {
                                        setTimeout(function () {
                                            W.updateHTML('.RoomNumber-'.concat(e, ' > legend'), 'Billing Info'),
                                                e > 1 && W.updateHTML('.RoomNumber-'.concat(e, ' > legend'), 'Billing Info - Room '.concat(e));
                                        }, 750);
                                    });
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.site_config &&
                                    e &&
                                    (W.createHTML('<link href="'.concat(this.site_config.google_font_url, '" rel="stylesheet">'), 'head', 'beforeEnd'),
                                    e.insertAdjacentHTML(
                                        'afterBegin',
                                ...
                                this.site_config &&
                                    ...
                                    (this.site_config.show_language_select
                                        ? (document.querySelector('div#language-label').classList.add('config-label'),
                                          ...
                                          ((n = r.querySelector('#language-label')).querySelector('span').innerHTML = document.querySelector('.active-language').innerHTML),
                                          n.addEventListener('click', function () {
                                              r.querySelector('.language-container').classList.toggle('show-language-container'),
                                                  window.document.documentMode || n.querySelector('svg').classList.toggle('flip-svg');
                                          }),
                                          r.querySelector('.language-container').addEventListener('click', function (n) {
                                              var r = document.getElementById(n.target.id).getAttribute('value');
                                              if (('search-results' === t.page_name || 'landing-page' === t.page_name) && r !== e) {
                                                  a.set('theme', r);
                                                  var o,
                                                      i,
                                                      c,
                                                      s = document.querySelector('input#theCheckIn'),
                                                      u = document.querySelector('input#theCheckOut');
                                                  'standard' !== r && 'mandarin' !== r && 'tw_mandarin' !== r && 'standard' === e
                                                      ? ((o = $(s.value, 'M/D/YYYY').format('M/D/YYYY')),
                                                        (i = $(u.value, 'M/D/YYYY').format('M/D/YYYY')),
                                                        (c = $(i).diff($(o), 'days')),
                                                        (o = $(s.value, 'M/D/YYYY').format('D/M/YYYY')),
                                                        (i = $(u.value, 'M/D/YYYY').format('D/M/YYYY')))
                                                      : 'standard' === r && 'standard' !== e
                                                      ? ((o = $(s.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (i = $(u.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (c = $(i).diff($(o), 'days')))
                                                      : 'standard' !== r && 'mandarin' !== r && 'tw_mandarin' !== r && 'standard' !== e
                                                      ? ((o = $(s.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (i = $(u.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (c = $(i).diff($(o), 'days')),
                                                        (o = $(s.value, 'D/M/YYYY').format('D/M/YYYY')),
                                                        (i = $(u.value, 'D/M/YYYY').format('D/M/YYYY')))
                                                      : ('mandarin' !== r && 'tw_mandarin' !== r) || 'standard' === e
                                                      ? (('mandarin' === r || 'tw_mandarin' === r) && 'mandarin' === e) || 'tw_mandarin' === e
                                                          ? ((o = $(s.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                            (i = $(u.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                            (c = $(i).diff($(o), 'days')),
                                                            (o = $(s.value, 'YYYY/M/D').format('YYYY/M/D')),
                                                            (i = $(u.value, 'YYYY/M/D').format('YYYY/M/D')))
                                                          : ('mandarin' !== r && 'tw_mandarin' !== r) || 'standard' !== e
                                                          ? 'standard' !== r || ('mandarin' !== e && 'tw_mandarin' !== e)
                                                              ? 'standard' === r ||
                                                                ('mandarin' !== e && 'tw_mandarin' !== e) ||
                                                                ((o = $(s.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                                (i = $(u.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                                (c = $(i).diff($(o), 'days')),
                                                                (o = $(s.value, 'YYYY/M/D').format('D/M/YYYY')),
                                                                (i = $(u.value, 'YYYY/M/D').format('D/M/YYYY')))
                                                              : ((o = $(s.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                                (i = $(u.value, 'YYYY/M/D').format('M/D/YYYY')),
                                                                (c = $(i).diff($(o), 'days')))
                                                          : ((o = $(s.value, 'M/D/YYYY').format('YYYY/M/D')),
                                                            (i = $(u.value, 'M/D/YYYY').format('YYYY/M/D')),
                                                            (c = $(i).diff($(o), 'days')))
                                                      : ((o = $(s.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (i = $(u.value, 'D/M/YYYY').format('M/D/YYYY')),
                                                        (c = $(i).diff($(o), 'days')),
                                                        (o = $(s.value, 'D/M/YYYY').format('YYYY/M/D')),
                                                        (i = $(u.value, 'D/M/YYYY').format('YYYY/M/D'))),
                                                      'search-results' === t.page_name && (a.set('nights', c), a.set('checkin', o)),
                                          ...
                                          window.addEventListener('click', function (e) {
                                              if (document.querySelector('.show-language-container')) {
                                                  ...
                                                  if ((document.querySelector('.language-container').classList.toggle('show-language-container'), window.document.documentMode))
                                                      return;
                                                  n.querySelector('svg').classList.toggle('flip-svg');
                                              }
                                          }))
                                                        ...
                                                        return (
                                                            ...
                                                            (n = function (e) {
                                                                ...
                                                                t.insertAdjacentElement('beforeEnd', n),
                                                                    W.createDropdownMenu('#currency-label', t, '.currency-content', '.dropdown');
                                                            }),
                                                            (r = function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                'checkout' === this.page_name &&
                                    ...
                                    W.replaceSpecificText('.confirmedDueNowCharge .confirmationAgreement', /(^|)You(?=\s|$)/gi, 'I'),
                                    W.replaceSpecificText('.confirmedDueNowCharge .confirmationAgreement', /(^|)your(?=|$)/gi, 'my'),
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (r = document.querySelector(n)), (e.next = 5), W.fetchHTMLFromFile(t);
                                                    case 5:
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            ...
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (t = this.site_config.header.logo_outbound_url), (e.next = 5), W.waitForSelectorInDOM('.logo');
                                                        case 5:
                                        ...
                                        return regeneratorRuntime.wrap(
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            if (W.matchMediaQuery('max-width: 800px')) {
                                                                e.next = 2;
                                                                break;
                                                            }
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (e.next = 4), W.waitForSelectorInDOM('#theCheckIn');
                                                        case 4:
        ...
        var te = new (function () {
            return {
                ...
                banner_image_url: 'linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)), url('
                    .concat(V.path, '/site_configs/')
                    .concat(Z, '/img/banner.jpg) no-repeat center center /cover'),
                map_marker_image_url: ''.concat(V.path, '/site_configs/').concat(Z, '/img/favicon.png'),
                theme: 'light',
...
//# sourceMappingURL=ares_child-60278.map
