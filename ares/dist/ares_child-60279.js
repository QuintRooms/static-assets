!(function (e) {
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(29), n(32), n(33), n(73), n(74), n(82), n(83), n(85), n(88), n(55), n(40), n(92), n(94), n(96), n(98), n(99), n(102);
                                            ...
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return (
                                                                (t = document.body).classList.contains('SearchHotels') &&
                                                                    !t.classList.contains('HoldRoomsForm') &&
                                                                    (this.page_name = 'search-results'),
                                                                t.classList.contains('SinglePropDetail') && (this.page_name = 'property-detail'),
                                                                t.classList.contains('CheckOutForm') && (this.page_name = 'checkout'),
                                                                t.classList.contains('ConfirmationForm') && (this.page_name = 'confirmation'),
                                                                t.classList.contains('RootBody') && (this.page_name = 'landing-page'),
                                                                t.classList.contains('WBFaq') && (this.page_name = 'faq'),
                                                                t.classList.contains('WBTermsAndConditions') && (this.page_name = 'terms-conditions'),
                                                                t.classList.contains('WBPrivacyPolicy') && (this.page_name = 'privacy-policy'),
                                                                t.classList.contains('WBRateGuaranteeForm2') && (this.page_name = 'lrg-page'),
                                                                t.classList.contains('WBValidatedRegistrationForm') && (this.page_name = 'cug-registration'),
                                                                t.classList.contains('HoldRoomsForm') && t.classList.contains('SearchHotels') && (this.page_name = 'hold-rooms'),
                                                                e.abrupt('return', this.page_name)
                                                            );
                                                        case 13:
                                                        case 'end':
                                                            return e.stop();
        ...
        var Y = new P(),
            Z = new (function () {
                return {
                    ...
                    cug: {is_cug: !1, show_points: !1, allow_registration: !0, show_percent_savings: !1},
                    ...
                    has_custom_styles: !0,
                    custom_styles_url: ''.concat(F.path, '/site_configs/').concat(D, '/').concat(60279, '.css'),
