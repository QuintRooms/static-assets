    ...
    function (e, t, n) {
        ...
        var p = new (function () {
            return {
                ...
                fav_icon_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo2.png'),
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo2.png'), logo_outbound_url: 'http://www.azbikeweek.com/'},
                map_marker_image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo2.png'),
                theme: 'light',
