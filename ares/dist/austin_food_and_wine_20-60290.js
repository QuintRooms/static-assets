!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(68),
            o = n(21),
            i = new (n.n(o).a)(),
            a = 'austin_food_and_wine_20-'.concat(60290);
        function c(e) {
            return (c =
        ...
        var p = new (function () {
            return {
                ...
                lodging: {event_id: 41292, event_name: 'Austin Food & Wine Festival', event_dates: '11/13/2020 - 11/15/2020', is_lrg: !0},
                ...
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://www.austinfoodandwinefestival.com/'},
