        ...
        var r,
            ...
            P = !!(function () {
                try {
                    ...
                    return (L || 'function' == typeof PromiseRejectionEvent) && e.then(E) instanceof t && 0 !== M.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            T = function (e) {
                var t;
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var A = String(b[0]), k = u(l(a(b.index), f.length), 0), M = [], C = 1; C < b.length; C++) M.push(void 0 === (S = b[C]) ? S : String(S));
                        var L = b.groups;
                        if (h) {
                            var E = [A].concat(M, k, f);
                            void 0 !== L && E.push(L);
                            var q = String(t.apply(void 0, E));
                        } else q = m(A, f, k, M, L, t);
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: x ? C : w('values'), keys: y ? C : w('keys'), entries: L}), g)) for (b in v) b in k || i(k, b, v[b]);
