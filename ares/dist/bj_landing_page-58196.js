!(function (e) {
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            var h = new o.default(),
                ...
                g = (function () {
                    ...
                    var t, n, o, s, i, c, u, p, g, _, v, j, b, S;
                    return (
                        (t = e),
                        (n = [
                            {
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            ...
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (o = document.querySelector(n)), (e.next = 5), h.fetchHTMLFromFile(t);
                                                        case 5:
  ...
  \****************************************************/
                            ...
                            },
                            {
                                ...
                                value: function (e, t, n) {
                                    ...
                                    return 52342 === n ||
                                        ...
                                        ? ((o = a(i, 'M/D/YYYY').format('M/D/YYYY')),
                                          (r = a(c, 'M/D/YYYY').format('M/D/YYYY')),
                                          {check_in_value: o, nights: (s = a(r).diff(a(o), 'days'))})
                                        : 'mandarin' === e || 'tw_mandarin' === e
                                        ? ((o = a(i, 'YYYY/M/D').format('YYYY/M/D')),
                                          (r = a(c, 'YYYY/M/D').format('YYYY/M/D')),
                                          {check_in_value: o, nights: (s = a(r).diff(a(o), 'days'))})
                                        : ((o = a(i, 'D/M/YYYY').format('M/D/YYYY')),
                                          (r = a(c, 'D/M/YYYY').format('M/D/YYYY')),
                                          (s = a(r).diff(a(o), 'days')),
                                          (o = a(i, 'D/M/YYYY').format('D/M/YYYY')),
    ...
    './js/components/landing_page/landing-page.js':
        /*!****************************************************!*\
  !*** ./js/components/landing_page/landing-page.js ***!
  \****************************************************/
        /*! no static exports found */ function (e, t, n) {
                                        ...
                                        regeneratorRuntime.mark(function e() {
                                            ...
                                            return regeneratorRuntime.wrap(function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return (e.next = 2), a.waitForSelectorInDOM('.events');
                                                        case 2:
                                                            (t = document.querySelectorAll('.event-container')),
                                                                (n = document.querySelector('.events')),
                                                                (e.t0 = t.length),
                                                                (e.next = 1 === e.t0 ? 7 : 2 === e.t0 ? 9 : 3 === e.t0 ? 11 : 13);
                                                            break;
                                                        case 7:
                                                            return (n.style.gridTemplateColumns = '1fr'), e.abrupt('break', 14);
                                                        case 9:
                                                            return (n.style.gridTemplateColumns = '1fr 1fr'), e.abrupt('break', 14);
                                                        case 11:
                                                            return (n.style.gridTemplateColumns = '1fr 1fr 1fr'), e.abrupt('break', 14);
                                                        case 13:
                                                            n.style.gridTemplateColumns = '1fr 1fr 1fr';
                                                        case 14:
                                                        case 'end':
                                                            return e.stop();
                                                    }
                                ...
                                value: function (e) {
                                    ...
                                    if (document.querySelector('.RootBody')) {
                                        var t = new URL(e),
                                            ...
                                            r = n.get('utm_medium');
                                        if (null !== o && null !== r) {
                                            var s = document.querySelectorAll('.event-container, .header-container');
                                            return s.length
                                                ? (s.forEach(function (e) {
                                                      var t = e.getAttribute('href');
                                                      e.href = ''.concat(t, '&utm_source=').concat(o, '&utm_medium=').concat(r);
                                                  }),
                                                  [o, r])
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            var i = n(/*! dayjs */ './node_modules/dayjs/dayjs.min.js'),
                a = (function () {
                    ...
                    var t, n, o, a, c, u, l, d, m, f, p, h, y, g, _;
                    return (
                        (t = e),
                        (n = [
                            {
  ...
  \******************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            e.exports = function (e, t, n, p, h, y, g) {
                ...
                if (
                    (q && (j = l(q.call(new e()))) !== Object.prototype && j.next && (u(j, S, !0), o || 'function' == typeof j[d] || i(j, d, f)),
                    w &&
                        A &&
                        'values' !== A.name &&
                        ((x = !0),
  ...
  \*****************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            E ||
                ...
                (s = function () {
                    var e = new o();
                    (this.promise = e), (this.resolve = u(I, e, 1)), (this.reject = u(Y, e, 1));
                }),
                (v.f = C = function (e) {
  ...
  \****************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var o = n(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                Z = function (e, t) {
                    _(e);
                    for (var n, o = y((t = b(t))), r = 0, s = o.length; s > r; ) J(e, (n = o[r++]), t[n]);
                    return e;
                },
                Q = function (e) {
                    var t = I.call(this, (e = S(e, !0)));
                    return !(this === N && r(F, e) && !r(B, e)) && (!(t || !r(this, e) || !r(F, e) || (r(this, D) && this[D][e])) || t);
                },
                K = function (e, t) {
                ...
                X = function (e) {
                    for (var t, n = P(b(e)), o = [], s = 0; n.length > s; ) r(F, (t = n[s++])) || t == D || t == c || o.push(t);
                    return o;
                },
                ee = function (e) {
                    for (var t, n = e === N, o = P(n ? B : b(e)), s = [], i = 0; o.length > i; ) !r(F, (t = o[i++])) || (n && !r(N, t)) || s.push(F[t]);
                    return s;
                };
            U ||
                (a(
                ...
                (n(/*! ./_object-pie */ './node_modules/core-js/modules/_object-pie.js').f = Q),
                (M.f = ee),
                s && !n(/*! ./_library */ './node_modules/core-js/modules/_library.js') && a(N, 'propertyIsEnumerable', Q, !0),
                (p.f = function (e) {
                    return V(f(e));
                })),
            ...
            for (var te = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), ne = 0; te.length > ne; )
                f(te[ne++]);
            for (var oe = q(f.store), re = 0; oe.length > re; ) h(oe[re++]);
            i(i.S + i.F * !U, 'Symbol', {
                for: function (e) {
                    return r(H, (e += '')) ? H[e] : (H[e] = T(e));
                },
                keyFor: function (e) {
            ...
            i(i.S + i.F * se, 'Object', {
                ...
                T.prototype[Y] || n(/*! ./_hide */ './node_modules/core-js/modules/_hide.js')(T.prototype, Y, T.prototype.valueOf),
                d(T, 'Symbol'),
                d(Math, 'Math', !0),
                d(o.JSON, 'JSON', !0);
        },
  ...
  \********************************************/
    ...
    './site_configs/bj_landing_page-58196/js/58196-config.js':
        /*!***************************************************************!*\
  !*** ./site_configs/bj_landing_page-58196/js/58196-config.js ***!
  \***************************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var r = new ((o = n(/*! ../../../js/build_tools/path */ './js/build_tools/path.js')) && o.__esModule ? o : {default: o}).default(),
                s = 'bj_landing_page-'.concat(58196);
        },
    './site_configs/bj_landing_page-58196/js/58196.js':
        /*!********************************************************!*\
  !*** ./site_configs/bj_landing_page-58196/js/58196.js ***!
  \********************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var o = i(n(/*! ../../../js/build */ './js/build.js')),
                r = i(n(/*! ./58196-config */ './site_configs/bj_landing_page-58196/js/58196-config.js')),
                s = i(n(/*! ../../../js/components/landing_page/landing-page */ './js/components/landing_page/landing-page.js'));
            function i(e) {
                return e && e.__esModule ? e : {default: e};
            }
            function a(e) {
            ...
            new s.default(p.landing_page_events, p.hide_search_on_landing_page).init(), new h();
        },
    './site_configs/bj_landing_page-58196/styles/58196.scss':
        /*!**************************************************************!*\
  !*** ./site_configs/bj_landing_page-58196/styles/58196.scss ***!
  \**************************************************************/
        /*! no static exports found */ function (e, t, n) {},
  ...
  \**********************/
        /*! no static exports found */ function (e, t, n) {
            'use strict';
            n(/*! ../site_configs/bj_landing_page-58196/js/58196 */ './site_configs/bj_landing_page-58196/js/58196.js'),
                n(/*! ../site_configs/bj_landing_page-58196/styles/58196.scss */ './site_configs/bj_landing_page-58196/styles/58196.scss');
        },
});
//# sourceMappingURL=bj_landing_page-58196.js.map
