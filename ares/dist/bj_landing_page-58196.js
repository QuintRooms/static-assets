            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, k = 0; k < v.length; k++) {
                        b = v[k];
                        for (var x = String(b[0]), A = u(l(a(b.index), f.length), 0), M = [], q = 1; q < b.length; q++) M.push(void 0 === (S = b[q]) ? S : String(S));
                        var L = b.groups;
                        if (p) {
                            var C = [x].concat(M, A, f);
                            void 0 !== L && C.push(L);
                            var E = String(t.apply(void 0, C));
                        } else E = m(x, f, A, M, L, t);
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: k ? q : w('values'), keys: y ? q : w('keys'), entries: L}), g)) for (b in v) b in A || i(A, b, v[b]);
        ...
        var r = n(2),
            ...
            Z = function (e, t, n) {
                return (
                    ...
                    v(n),
                    o(F, t)
                        ? (n.enumerable ? (o(e, Y) && e[Y][t] && (e[Y][t] = !1), (n = x(n, {enumerable: k(0, !1)}))) : (o(e, Y) || P(e, Y, k(1, {})), (e[Y][t] = !0)), W(e, t, n))
                        : P(e, t, n)
                );
            },
            J = function (e, t) {
            ...
            (c(
                (R = function () {
                    ...
                    var e = f(arguments.length > 0 ? arguments[0] : void 0),
                        t = function (n) {
                            this === N && t.call(B, n), o(this, Y) && o(this[Y], e) && (this[Y][e] = !1), W(this, e, k(1, n));
                        };
