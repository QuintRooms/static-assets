!(function (e) {
    ...
    function (e, t, n) {
        ...
        var N = new H(),
            ...
            Y = new H(),
            z = 'bj_scottsdale_21-'.concat(58513);
        function V(e) {
            return (V =
        ...
        var Q = new (function () {
            return {
                ...
                ads: {
                    sidebar_ad: {is_active: !0, image_url: ''.concat(Y.path, '/site_configs/').concat(z, '/img/leftbanner.jpg'), outbound_url: 'https://www.grandcanyon.org/'},
