!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(68),
            o = n(21),
            i = new (n.n(o).a)(),
            a = 'bj_scottsdale_21-'.concat(58513);
        function c(e) {
            return (c =
        ...
        var p = new (function () {
            return {
                ...
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://www.barrett-jackson.com/'},
                map_marker_image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/favicon.png'),
                theme: 'light',
                google_font_url: '//fonts.googleapis.com/css?family=Montserrat:100,500,700',
                ads: {
                    sidebar_ad: {is_active: !0, image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/leftbanner.jpg'), outbound_url: 'https://www.grandcanyon.org/'},
