!(function (e) {
    ...
    function (e, t, n) {
        ...
        var Y = new B.a(),
            ...
            V = new B.a(),
            Z = 'breeders_cup_20-'.concat(59788);
        function J(e) {
            return (J =
        ...
        var te = new (function () {
            return {
                ...
                lodging: {event_id: 40940, event_name: "Breeder's Cup", event_dates: '11/06/2020 - 11/07/2020', is_lrg: !1},
                ...
                header: {logo_file_location: ''.concat(V.path, '/site_configs/').concat(Z, '/img/logo.png'), logo_outbound_url: 'https://www.breederscup.com/'},
