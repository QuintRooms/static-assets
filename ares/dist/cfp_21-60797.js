        ...
        var r,
            ...
            T = !!(function () {
                try {
                    ...
                    return (M || 'function' == typeof PromiseRejectionEvent) && e.then(q) instanceof t && 0 !== L.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            P = function (e) {
                var t;
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', _ = 0, x = 0; x < g.length; x++) {
                        S = g[x];
                        for (var A = String(S[0]), k = u(l(a(S.index), d.length), 0), L = [], E = 1; E < S.length; E++) L.push(void 0 === (b = S[E]) ? b : String(b));
                        var M = S.groups;
                        if (h) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: x ? E : w('values'), keys: y ? E : w('keys'), entries: M}), v)) for (S in g) S in k || i(k, S, g[S]);
