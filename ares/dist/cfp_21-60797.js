!(function (e) {
    ...
    function (e, t, n) {
        for (
            ...
            var m,
                ...
                S = a[g],
                b = S && S.prototype;
            if (b && (b[l] || c(b, l, d), b[f] || c(b, f, g), (s[g] = d), v)) for (m in r) b[m] || i(b, m, r[m], !0);
        }
    },
    function (e, t, n) {
        e.exports = (function () {
                ...
                u = function (e, n, r) {
                    try {
                        ...
                        var v = u || 0,
                            ...
                            b = f || 0,
                            w = d || 0;
                        return h ? new Date(Date.UTC(m, g, y, v, S, b, w + 60 * h.offset * 1e3)) : r ? new Date(Date.UTC(m, g, y, v, S, b, w)) : new Date(m, g, y, v, S, b, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                    ...
                                    52342 === e.site_id || ('standard' === n.getMetaTagContent('theme') && 16980 !== e.affiliate_id)
                                        ...
                                        ? ((u = P(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (f = P(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (d = P(f).diff(P(u), 'days')),
                                        ...
                                        : (16980 === e.affiliate_id || e.site_id,
                                          ...
                                          (f = P(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('M/D/YYYY')),
                                          (d = P(f).diff(P(u), 'days')),
                                                                ...
                                                                case 9:
                                                                    'cug' === e.site_config.site_type &&
                                                                        ...
                                                                        'search-results' === e.page_name &&
                                                                            ($.init(e.site_config, e.page_name, N), e.showOriginalPrice('.ArnProperty', '.arnPrice')),
                                                                        jQuery('#theBody').on(
                                                                            'arnMapLoadedEvent',
                                                                            H(
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, _ = []; w < d.length; ) {
                            ...
                            var x,
                                A = s(v, p ? d : d.slice(w));
                            if (null === A || (x = f(c(v.lastIndex + (p ? 0 : w)), d.length)) === b) w = a(d, w, m);
                            else {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, y, m, g) {
            ...
            if (
                ...
                if (((v = {values: x ? M : w('values'), keys: m ? M : w('keys'), entries: E}), g)) for (S in v) S in k || i(k, S, v[S]);
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, f, d) {
            ...
            if (i(g)) {
                for (h = c(e.length); h > S; S++) if ((m = t ? v(a((p = e[S]))[0], p[1]) : v(e[S])) === u || m === l) return m;
    ...
    function (e, t, n) {
        ...
        var p = new (function () {
            return {
                ...
                fav_icon_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/favicon.png?v2'),
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://collegefootballplayoff.com/'},
        ...
        new ((function (e) {
            ...
            function n() {
                ...
                return (
                    ...
                    d(((e = f((r = t.call(this, p)))), h(n.prototype)), 'init', e).call(e),
                    r
                );
            }
            return n;
