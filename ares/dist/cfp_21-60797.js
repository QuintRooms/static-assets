!(function (e) {
    ...
    function (e, t, n) {
        'use strict';
        n(37), n(91), n(31), n(29), n(95), n(68), n(32), n(59), n(100), n(60), n(103), n(104), n(107), n(42);
    ...
    function (e, t, n) {
        ...
        var d = new (function () {
            return {
                ...
                show_date_prompt: !1,
                fav_icon_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/favicon.jpg'),
                has_custom_styles: !0,
                custom_styles_url: ''.concat(o.path, '/site_configs/').concat(i, '/').concat(60797, '.css'),
                has_social_sharing: !0,
                header: {
                    logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo_copy.png'),
                    logo_outbound_url: 'https://collegefootballplayoff.com/',
                    background: '#000',
                    logo_flex_position: 'flex-start',
                    logo_max_width: '330px',
                },
                banner_image_url: 'url('.concat(o.path, '/site_configs/').concat(i, '/img/banner.png) no-repeat'),
                map_marker_image_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/favicon.jpg'),
                theme: 'light',
