!(function (e) {
    ...
    function (e, t, n) {
        ...
        new i.default(p.landing_page_events, p.hide_search_on_landing_page).init(),
            new m(),
            document.querySelector('.RootBody') && (document.querySelector('.event-2 .event-name').innerHTML = '<h2 class="event-name">SEARCH <br> ANYWHERE</h2>');
    },
    function (e, t, n) {
        n(47)('asyncIterator');
    },
