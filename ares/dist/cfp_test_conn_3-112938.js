!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(2),
            ...
            K = function (e) {
                for (var t, n = C(S(e)), r = [], i = 0; n.length > i; ) o(R, (t = n[i++])) || t == D || t == u || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = C(n ? B : S(e)), i = [], a = 0; r.length > a; ) !o(R, (t = r[a++])) || (n && !o(N, t)) || i.push(R[t]);
                return i;
            };
        U ||
            (c(
            ...
            (n(47).f = J),
            (E.f = ee),
            i && !n(30) && c(N, 'propertyIsEnumerable', J, !0),
            (p.f = function (e) {
                return V(h(e));
            })),
        ...
        a(a.S + a.F * ie, 'Object', {
            ...
            O.prototype[F] || n(11)(O.prototype, F, O.prototype.valueOf),
            f(O, 'Symbol'),
            f(Math, 'Math', !0),
            f(r.JSON, 'JSON', !0);
    },
                                    ...
                                    try {
                                        c
                                            ? (o || (2 == e._h && D(e), (e._h = 1)),
                                              ...
                                              n === t.promise ? s(x('Promise-chain cycle')) : (i = C(n)) ? i.call(n, u, s) : u(n))
                                            : s(r);
                                    } catch (e) {
                                        l && !a && l.exit(), s(e);
                                    }
            ...
            return (
                ...
                (T.prototype = {
                    ...
                    delegateYield: function (t, n, r) {
                        return (this.delegate = {iterator: C(t), resultName: n, nextLoc: r}), 'next' === this.method && (this.arg = e), v;
                    },
                }),
                t
            );
    ...
    function (e, t, n) {
        ...
        n(84), n(86), n(87), n(20), n(34), n(21), n(22), n(23), n(16), n(24), n(25), n(26), n(27), n(36), n(28), n(75);
        var o = c(n(113)),
            i = c(n(45)),
            a = c(n(132));
        function c(e) {
                ...
                (r = [
                    {
                        key: 'init',
                        value: function () {
                            this.deselectPropertyTypes(), this.addLocationButtons(), this.addUtmTrackingToUrls(window.location.href);
                        },
                    },
                    {
                        key: 'deselectPropertyTypes',
                        value:
                            ((c = l(
                                u().mark(function e() {
                                    var t, n;
                                    return u().wrap(function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    return (e.next = 2), g.waitForSelectorInDOM('.ExtStayBox');
                                                case 2:
                                                    (t = document.getElementsByName('234')), (n = document.getElementsByName('238')), (t[0].checked = !1), (n[0].checked = !1);
                                                case 6:
                                                case 'end':
                                                    return e.stop();
                                            }
                                ...
                                u().mark(function e() {
                                    return u().wrap(function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    if ('88767' === document.querySelector('meta[name="siteId"]').content) {
                                                        e.next = 2;
                                                        break;
                                                    }
                                                    return e.abrupt('return');
                                                case 2:
                                                    return (e.next = 4), g.waitForSelectorInDOM('header');
                                                case 4:
                                                    document
                                        ...
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    ...
                                                    return e.abrupt('return', new Error('URL is null'));
                                                case 2:
                                                    return (e.next = 4), g.waitForSelectorInDOM('#stadium-location');
                                                case 4:
                                                    return (e.next = 6), g.waitForSelectorInDOM('#downtown-location');
                                                case 6:
                                                    return (e.next = 8), g.waitForSelectorInDOM('#galleria-location');
                                                case 8:
                                                    return (e.next = 10), g.waitForSelectorInDOM('meta[name="originalParams"]');
                                                case 10:
                                                    if (
                                                        ((n = document.querySelectorAll('#stadium-location, #downtown-location, #galleria-location')),
                                                        document.querySelector('#stadium-location') &&
                                                            document.querySelector('#downtown-location') &&
                                                            document.querySelector('#galleria-location'))
                                                    ) {
                                                        e.next = 13;
                                                        break;
                                                    }
                                                ...
                                                case 13:
                                                    if (
                                                        ...
                                                        (i = o.get('utm_source')),
                                                        (a = o.get('utm_medium')),
                                                        (c = o.get('utm_campaign')),
                                                        (s = document.querySelector('meta[name="originalParams"]').content),
                                                        (l = new URLSearchParams(s)),
                                                        'NRG Stadium' === (f = l.get('locationlabel')) && ((n[1].style.color = '#000'), (n[1].style.background = '#c9920e')),
                                                        'George R. Brown Convention Center (Playoff Fan Central)' === f &&
                                                            ((n[0].style.color = '#000'), (n[0].style.background = '#c9920e')),
                                                        'Galleria' === f && ((n[2].style.color = '#000'), (n[2].style.background = '#c9920e')),
                                                ...
                                                case 29:
                                                    return (
                                                        n.forEach(function (e) {
                                                            ...
                                                            e.href = ''.concat(t, '&utm_campaign=').concat(c, '&utm_source=').concat(i, '&utm_medium=').concat(a);
                                                        }),
                                                        e.abrupt('return', [i, a])
                                                    );
                                                case 31:
        ...
        e.exports = {
            set:
                ...
                ('__proto__' in {}
                    ? (function (e, t, r) {
                          try {
                              (r = n(18)(Function.call, n(29).f(Object.prototype, '__proto__').set, 2))(e, []), (t = !(e instanceof Array));
                          } catch (e) {
                              t = !0;
                          }
                          return function (e, n) {
    ...
    function (e, t, n) {
        'use strict';
        n(21), n(22), n(23), n(16), n(24), n(25), n(28), n(26), Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(27), n(36), n(20), n(34);
        var r,
    ...
    function (e, t, n) {
        ...
        n(21), n(22), n(23), n(16), n(24), n(25), n(28), n(26), Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(36), n(27), n(80), n(20), n(34);
        var s = n(46),
            l = n(58);
        s.extend(l);
        t.default = (function () {
    ...
    function (e, t, n) {
        ...
        n(20),
            ...
            n(21),
            n(22);
        var u = new ((o = n(45)) && o.__esModule ? o : {default: o}).default();
        function s() {
            return (s = c(
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    lodging: {event_id: '', event_name: 'College Football Playoff', event_dates: '', redirect_date: '', redirect_url: '', is_lrg: !1},
                    ...
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo-houston.png'), logo_outbound_url: 'https://collegefootballplayoff.com/'},
        ...
        var o = new ((r = n(81)) && r.__esModule ? r : {default: r}).default(),
            i = 'cfp_test_conn_3-'.concat(112938);
    },
    function (e, t, n) {},
]);
