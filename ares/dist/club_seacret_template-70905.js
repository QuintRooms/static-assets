!(function (e) {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(37), n(69), n(44), n(70), n(49), n(71), n(18), n(19), n(20);
        var a = n(27),
            c = (function () {
                function e() {
                    !(function (e, t) {
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, _ = []; w < f.length; ) {
                            ...
                            var x,
                                k = s(g, h ? f : f.slice(w));
                            if (null === k || (x = d(c(g.lastIndex + (h ? 0 : w)), f.length)) === b) w = a(f, w, y);
                            else {
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            f = /\$([$&`']|\d\d?|<[^>]*>)/g,
            p = /\$([$&`']|\d\d?)/g;
        n(36)('replace', 2, function (e, t, n, h) {
            return [
                function (r, o) {
                    var i = e(this),
                        a = null == r ? void 0 : r[t];
                ...
                function (e, t) {
                    ...
                    for (var g = []; ; ) {
                        ...
                        if (null === S) break;
                        if ((g.push(S), !y)) break;
                        '' === String(S[0]) && (d.lastIndex = c(f, i(d.lastIndex), v));
                    }
                    for (var b, w = '', _ = 0, x = 0; x < g.length; x++) {
                        S = g[x];
                        for (var k = String(S[0]), A = u(l(a(S.index), f.length), 0), M = [], L = 1; L < S.length; L++) M.push(void 0 === (b = S[L]) ? b : String(b));
                        var q = S.groups;
                        if (p) {
    ...
    function (e, t, n) {
        for (
            ...
            var y,
                ...
                S = a[v],
                b = S && S.prototype;
            if (b && (b[l] || c(b, l, f), b[d] || c(b, d, v), (s[v] = f), g)) for (y in r) b[y] || i(b, y, r[y], !0);
        }
    },
    function (e, t, n) {
        var r = n(25),
    ...
    function (e, t, n) {
        'use strict';
        n(75), n(76), n(18), n(44), n(19), n(96), n(98), n(65), n(66), n(68), n(103), n(108), n(20);
        var r = c(n(27)),
            o = c(n(112)),
            i = c(n(128)),
            a = c(n(38));
        ...
        new ((function (e) {
            ...
            function x() {
                ...
                return (
                    ...
                    y(((e = m((t = _.call(this, g)))), v(x.prototype)), 'init', e).call(e),
                    t.init(),
                    (t.ref = ''),
                    (t.trips = {}),
                    (t.trip = {}),
            ...
            return (
                ...
                (n = [
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (e.next = 4), this.getReferenceId();
                                                    case 4:
                                                        return (e.next = 6), this.fetchTrips();
                                                    case 6:
                                                        return (e.next = 8), this.fetchPropertyHtml();
                                                    case 8:
                                                        return (e.next = 10), this.getTrip();
                                                    case 10:
                                                        this.insertTripDetailsIntoHtml(), this.restyleCarousel(), this.hideArnElements(), this.updateCheckoutInterface();
                                                    case 14:
                                                    case 'end':
                                                        return e.stop();
                                                }
                    ...
                    },
                    {
                        key: 'hideArnElements',
                        value: function () {
                            S.waitForSelectorInDOM('.ArnRightListContainer');
                            var e = document.querySelector('.ArnRightListContainer'),
                                t = document.querySelector('.ArnLeftListContainer');
                            e.classList.add('hide'), t.classList.add('hide');
                        },
                    },
                    {
                                        ...
                                        function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 2:
                                                        (t = (0, r.default)(this.trip.data.start_date).format('MM/DD/YYYY')),
                                                            (n = (0, r.default)(this.trip.data.end_date).format('MM/DD/YYYY')),
                                                            document
                                                            ...
                                                            document.querySelectorAll('#standardAvail .rateRow').forEach(function (e) {
                                                                ...
                                                                var t = e.querySelector('.full-stay').innerText,
                                                                    n = Number(t.split(' ')[0]).toLocaleString(),
                                                                    r = document.querySelector('.trip-price-mobile'),
                                                                    o = document.querySelector('.trip-price-desktop');
                                                                (r.innerText = '$'.concat(n)), (o.innerText = '$'.concat(n));
                                                                var i = document.querySelector('.trip-ctas'),
                                                                    a = e.querySelector('.bookRoom');
                                                                a.classList.remove('bookRoom'),
                                                                    a.classList.add('book-button'),
                                                                    a.classList.add('new-cta'),
                                                                    (a.innerText = 'BOOK TRIP'),
                                                                    i.appendChild(a);
                                                                var c = e.querySelector('.holdRoom');
                                                                c &&
                                                                    (c.classList.remove('holdRoom'),
                                                                    c.classList.add('hold-button'),
                                                                    c.classList.add('new-cta'),
                                                                    (c.innerText = 'HOLD TRIP'),
                                                                    i.appendChild(c));
                                                                var s = document.querySelector('.trip-price-cta-container'),
                                                                    u = e.querySelector('.ArnRateCancelPolicyContainer'),
                                                                    l = e.querySelector('.ArnRateCancelAnchor');
                                                                l.classList.add('cancellation-policy'), s.appendChild(l), s.appendChild(u);
                                                                var d = e.querySelector('.ArnRateFromTo'),
                                                                    f = e.querySelector('.ArnNightlyRate'),
                                                                    p = e.querySelector('.RateCalendarPopupAnchor'),
                                                                    h = e.querySelector('.RateCalendarPopupContainer');
                                                                d.remove(), f.remove(), p.remove(), h.remove();
                                                                var m = e.innerText;
                                                                console.log(m);
                                                                var y = e.innerText.split(':');
                                                                console.log('room text_array', y);
                                                                var v = document.querySelector('.trip-item-name'),
                                                                    g = y[0].trim(),
                                                                    S = document.querySelector('.trip-item-description'),
                                                                    b = e.innerText.indexOf(':') + 1,
                                                                    w = e.innerText.slice(b).trim();
                                                                try {
                                                                    if (!m.includes(':') || !g || !w) return void (S.innerText = m.trim());
                                                                } catch (e) {
                                                                    console.error('Error inside room_title and room_description verification: ', e);
                                                                }
                                                                (S.innerText = w), (v.innerText = g);
                                                            });
                                                    case 9:
                                                    case 'end':
                                                        return e.stop();
                                    ...
                                    return regeneratorRuntime.wrap(function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                ...
                                                case 2:
                                                    if (((t = document.querySelector('.carousel-container')), (n = document.querySelector('.bottom-carousel-article')), t && n)) {
                                                        e.next = 6;
                                                        break;
                                                    }
                                                    return e.abrupt('return');
                                ...
                                regeneratorRuntime.mark(function e() {
                                    ...
                                    return regeneratorRuntime.wrap(function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    return (e.next = 2), S.waitForSelectorInDOM('.resConfirmationButton');
                                                case 2:
                                                    (t = document.querySelectorAll('input#theConfirmationButton, .WBConfirmedBooking .submit')),
                                                        console.log('submit button in updateCheckoutInterface', t),
                                                        (t[0].value = 'CONFIRM RESERVATIONS');
                                                case 5:
                                                case 'end':
                                                    return e.stop();
                                            }
        ...
        var r = n(2),
            ...
            Z = function (e, t, n) {
                return (
                    ...
                    g(n),
                    o(H, t)
                        ? (n.enumerable ? (o(e, Y) && e[Y][t] && (e[Y][t] = !1), (n = k(n, {enumerable: x(0, !1)}))) : (o(e, Y) || T(e, Y, x(1, {})), (e[Y][t] = !0)), W(e, t, n))
                        : T(e, t, n)
                );
            },
            J = function (e, t) {
            ...
            Q = function (e) {
                ...
                return !(this === N && o(H, e) && !o(B, e)) && (!(t || !o(this, e) || !o(H, e) || (o(this, Y) && this[Y][e])) || t);
            },
            K = function (e, t) {
                if (((e = w(e)), (t = _(t, !0)), e !== N || !o(H, t) || o(B, t))) {
                    var n = E(e, t);
                    return !n || !o(H, t) || (o(e, Y) && e[Y][t]) || (n.enumerable = !0), n;
                }
            },
            X = function (e) {
                for (var t, n = P(w(e)), r = [], i = 0; n.length > i; ) o(H, (t = n[i++])) || t == Y || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = P(n ? B : w(e)), i = [], a = 0; r.length > a; ) !o(H, (t = r[a++])) || (n && !o(N, t)) || i.push(H[t]);
                return i;
            };
        U ||
            (c(
            ...
            (n(42).f = Q),
            (L.f = ee),
            i && !n(21) && c(N, 'propertyIsEnumerable', Q, !0),
            (h.f = function (e) {
                return V(p(e));
            })),
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, d, f) {
            ...
            if (i(v)) {
                for (p = c(e.length); p > S; S++) if ((y = t ? g(a((h = e[S]))[0], h[1]) : g(e[S])) === u || y === l) return y;
    ...
    function (e, t, n) {
        n(5) && 'g' != /./g.flags && n(7).f(RegExp.prototype, 'flags', {configurable: !0, get: n(45)});
    },
    function (e, t, n) {
        var r = n(4),
            o = n(32),
        ...
        e.exports = {
            set:
                ...
                ('__proto__' in {}
                    ? (function (e, t, r) {
                          try {
                              (r = n(14)(Function.call, n(33).f(Object.prototype, '__proto__').set, 2))(e, []), (t = !(e instanceof Array));
                          } catch (e) {
                              t = !0;
                          }
                          return function (e, n) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t) {
            ...
            return function (t, c, h) {
                for (var m, y, v = i(t), g = o(v), S = r(c, h, 3), b = a(g.length), w = 0, _ = n ? p(t, b) : s ? p(t, 0) : void 0; b > w; w++)
                    if ((f || w in g) && ((y = S((m = g[w]), w, v)), e))
                        if (n) _[w] = y;
                        else if (y)
                            switch (e) {
                                case 3:
    ...
    function (e, t, n) {
        ...
        var y = new r.default(),
            ...
            g = (function () {
                ...
                var t, n, r, i, a, s, u, m, g, S, b, w, _, x;
                return (
                    (t = e),
                    (n = [
                        {
                                                    ...
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 2:
                                                            return (
                                                                (e.prev = 2),
                                                                (e.next = 5),
                                                                fetch('https://'.concat(f, '/components/lrg-form/lrg-form.html')).then(function (e) {
                                                                    return e.text();
                                                                })
                                                            );
                                                        case 5:
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: x ? L : w('values'), keys: y ? L : w('keys'), entries: q}), v)) for (S in g) S in A || i(A, S, g[S]);
    ...
    function (e, t, n) {
        'use strict';
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(18), n(19), n(37), n(20);
        var r,
            o = (r = n(38)) && r.__esModule ? r : {default: r};
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(18), n(20), n(70), n(49), n(19), n(71), n(37);
        var a = n(27),
            c = n(50);
        a.extend(c);
        var s = (function () {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            ...
            n(18),
            n(19);
        var a = new ((r = n(38)) && r.__esModule ? r : {default: r}).default();
        function c() {
            return (c = i(
                regeneratorRuntime.mark(function e(t, n) {
                    return regeneratorRuntime.wrap(function (e) {
    ...
    function (e, t, n) {
        ...
        var o = new ((r = n(72)) && r.__esModule ? r : {default: r}).default(),
