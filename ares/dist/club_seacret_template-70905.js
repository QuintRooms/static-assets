!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', _ = 0, x = 0; x < g.length; x++) {
                        S = g[x];
                        for (var k = String(S[0]), A = u(l(a(S.index), f.length), 0), M = [], q = 1; q < S.length; q++) M.push(void 0 === (b = S[q]) ? b : String(b));
                        var L = S.groups;
                        if (p) {
    ...
    function (e, t, n) {
        ...
        var r = n(2),
            ...
            X = function (e) {
                for (var t, n = P(w(e)), r = [], i = 0; n.length > i; ) o(H, (t = n[i++])) || t == D || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: x ? q : w('values'), keys: y ? q : w('keys'), entries: L}), v)) for (S in g) S in A || i(A, S, g[S]);
