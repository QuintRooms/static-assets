!(function (e) {
    ...
    function (e, t, n) {
        'use strict';
        n(2), n(19), n(53), n(72), n(75), n(76), n(78), n(80), n(85);
        var r = a(n(86)),
            o = a(n(123)),
            i = a(n(109));
        function a(e) {
        ...
        new ((function (e) {
            ...
            function b() {
                ...
                return (
                    ...
                    m(((e = h((t = p.call(this, v)))), y(b.prototype)), 'init', e).call(e),
                    t.init(),
                    (t.ref = ''),
                    (t.trips = {}),
                    (t.trip = {}),
            ...
            return (
                ...
                (n = [
                                        ...
                                        function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 8:
                                                        this.getTrip(), this.insertTripDetailsIntoHtml();
                                                    case 10:
                                                    case 'end':
                                                        return e.stop();
                                                }
                    ...
                    },
                    {
                        key: 'getTrip',
                        value: function () {
                            var e = g.getUrlParameter('tripId');
                            return (
                                (this.trip = this.trips.results.find(function (t) {
                                    return t.id === e;
                                })),
                                this.trip
                            );
                                    ...
                                    return regeneratorRuntime.wrap(
                                        function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (e.next = 2), g.waitForSelectorInDOM('#itinerary-section-title');
                                                    case 2:
                                                        (t = document.getElementById('itinerary-section-title')),
                                                            console.log(t),
                                                            (n = document.body.querySelector('.trip-item-description')),
                                                            console.log(n),
                                                            document
                                                                ...
                                                                .insertAdjacentHTML(
                                                                    ...
                                                                    "\n            <div class='title-date-container'>\n                <h1 class='trip-title'>"
                                                                        .concat(this.trip.data.trip_name[0].text, "</h1>\n                <h2 class='trip-date'>")
                                                                        .concat(this.trip.data.start_date, ' - ')
                                                                        .concat(this.trip.data.end_date, '</h2>\n            </div>\n        ')
                                                                ),
                                                            this.trip.data.itinerary.reverse().forEach(function (e) {
                                                                document
    ...
    function (e, t, n) {
        ...
        U ||
            ...
            (n(44).f = J),
            (L.f = ee),
            i && !n(6) && c(N, 'propertyIsEnumerable', J, !0),
            (h.f = function (e) {
                return V(p(e));
            })),
        ...
        a(a.S + a.F * ie, 'Object', {
            ...
            R.prototype[j] || n(22)(R.prototype, j, R.prototype.valueOf),
            d(R, 'Symbol'),
            d(Math, 'Math', !0),
            d(r.JSON, 'JSON', !0);
    },
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, d, f) {
            ...
            if (i(v)) {
                for (p = c(e.length); p > b; b++) if ((y = t ? g(a((h = e[b]))[0], h[1]) : g(e[b])) === u || y === l) return y;
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t) {
            ...
            return function (t, c, h) {
                for (var m, y, v = i(t), g = o(v), b = r(c, h, 3), S = a(g.length), w = 0, _ = n ? p(t, S) : s ? p(t, 0) : void 0; S > w; w++)
                    if ((f || w in g) && ((y = b((m = g[w]), w, v)), e))
                        if (n) _[w] = y;
                        else if (y)
                            switch (e) {
                                case 3:
    ...
    function (e, t, n) {
        ...
        var y = new r.default(),
            ...
            g = (function () {
                ...
                var t, n, r, i, a, s, u, m, g, b, S, w, _, x;
                return (
                    (t = e),
                    (n = [
                        {
    ...
    function (e, t, n) {
        ...
        var r = n(12),
            o = n(96),
            i = n(90);
        n(91)('search', 1, function (e, t, n, a) {
            return [
                function (n) {
                    var r = e(this),
                        o = null == n ? void 0 : n[t];
    ...
    function (e, t, n) {
        ...
        var r = n(12),
            ...
            f = /\$([$&`']|\d\d?|<[^>]*>)/g,
            p = /\$([$&`']|\d\d?)/g;
        n(91)('replace', 2, function (e, t, n, h) {
            return [
                function (r, o) {
                    var i = e(this),
                        a = null == r ? void 0 : r[t];
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var S = 0, w = 0, _ = []; w < f.length; ) {
                            ...
                            var x,
                                k = s(g, h ? f : f.slice(w));
                            if (null === k || (x = d(c(g.lastIndex + (h ? 0 : w)), f.length)) === S) w = a(f, w, y);
                            else {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(95), n(99), n(72), n(110), n(111), n(115), n(53), n(75), n(85);
        var a = n(117),
            c = (function () {
                function e() {
                    !(function (e, t) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: x ? L : w('values'), keys: y ? L : w('keys'), entries: q}), v)) for (b in g) b in A || i(A, b, g[b]);
    ...
    function (e, t, n) {
        'use strict';
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(53), n(75), n(95), n(85);
        var r,
            o = (r = n(109)) && r.__esModule ? r : {default: r};
                ...
                u = function (e, n, r) {
                    try {
                        ...
                        var g = u || 0,
                            ...
                            S = d || 0,
                            w = f || 0;
                        return p ? new Date(Date.UTC(y, v, m, g, b, S, w + 60 * p.offset * 1e3)) : r ? new Date(Date.UTC(y, v, m, g, b, S, w)) : new Date(y, v, m, g, b, S, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(53), n(85), n(110), n(111), n(75), n(115), n(95);
        var a = n(117),
            c = n(119);
        a.extend(c);
        var s = (function () {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            ...
            n(53),
            n(75);
        var a = new ((r = n(109)) && r.__esModule ? r : {default: r}).default();
        function c() {
            return (c = i(
                regeneratorRuntime.mark(function e(t, n) {
                    return regeneratorRuntime.wrap(function (e) {
    ...
    function (e, t, n) {
        ...
        var o = new ((r = n(121)) && r.__esModule ? r : {default: r}).default(),
