!(function (e) {
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            var y = new r.default(),
                ...
                v = (function () {
                    ...
                    var t, n, r, s, i, c, u, h, v, _, j, b, w, S;
                    return (
                        (t = e),
                        (n = [
                            {
                                    ...
                                    document.querySelector('.exclusive-rate') ||
                                        ...
                                        'property-detail' === this.page_name &&
                                            document.querySelectorAll('div.rateRow').forEach(function (t) {
                                                (t.querySelector('table.SB16') || (t.querySelector('table.SB20') && '' !== s.site_config.exclusive_rate_text)) &&
                                                    (function (e, t, n) {
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            var i = n(/*! dayjs */ './node_modules/dayjs/dayjs.min.js'),
                a = (function () {
                    ...
                    var t, n, r, a, c, u, l, d, m, f, p, h, y, g, v;
                    return (
                        (t = e),
                        (n = [
                            {
    ...
    ***************************************************************************** */ var e = function (
                        ...
                        var n =
                            (function (e) {
                                ...
                                var n = t[2] && 0 === t[2].indexOf('native'),
                                    s = t[2] && 0 === t[2].indexOf('eval'),
                                    i = o.exec(t[2]);
                                return (
                                    s && null != i && ((t[2] = i[1]), (t[3] = i[2]), (t[4] = i[3])),
                                    {
                                        file: n ? null : t[2],
                ...
                function p(e, t) {
                    ...
                    return (function e(r, o) {
                        ...
                        if ('object' == typeof r) {
                            ...
                            for (var i in r) {
                                var a = r[i];
                                Object.prototype.hasOwnProperty.call(r, i) && null != i && null != a && (s[i] = e(a, o + 1));
                            }
                            return s;
                        }
                        return r;
                ...
                function h(e) {
                    ...
                    if (e)
                        ...
                        } else t = 'object' == typeof e ? f(e) : {message: String(e)};
                    else t = {};
                    return t;
                }
                function y(e, t, n) {
                ...
                function g(e, t) {
                    if (_('Object', e)) {
                        ...
                        return (function e(r) {
                            var o, s;
                            if (_('Object', r) || _('Array', r)) {
                                if (-1 !== n.indexOf(r)) return '[CIRCULAR DATA STRUCTURE]';
                                n.push(r);
                            }
                            if (_('Object', r)) {
                                for (o in ((s = {}), r)) v(o, t) ? (s[o] = '[FILTERED]') : (s[o] = e(r[o]));
                                return s;
                            }
                            return _('Array', r)
                                ? r.map(function (t) {
                    ...
                    return (
                        n.split(/[&]\s?/).forEach(function (e) {
                            var n = e.split('=', 2),
                                o = n[0],
                                s = n[1];
                            v(o, t) && (r = r.replace(o + '=' + s, o + '=[FILTERED]'));
                        }),
                        r
                    );
                }
                var b = {name: 'honeybadger-js', url: 'https://github.com/honeybadger-io/honeybadger-js', version: '3.2.2'},
                    w = /,/,
                    S = /[^\w]/g,
                    x = /\S/,
                    k = (function () {
                        ...
                        return (
                            ...
                            (e.prototype.notify = function (e, t, r) {
                                ...
                                var o = this.__constructTags(e.tags),
                                    s = this.__constructTags(this.__context.tags),
                                    i = this.__constructTags(this.config.tags),
                                    a = o.concat(s).concat(i),
                            ...
                            (e.prototype.addBreadcrumb = function (e, t) {
                                if (this.config.breadcrumbsEnabled) {
                                    var n = f((t = t || {}).metadata),
                                        r = t.category || 'custom',
                                        o = new Date().toISOString();
                                    this.__breadcrumbs.push({category: r, message: e, metadata: n, timestamp: o});
                                    var s = this.config.maxBreadcrumbs;
                                    return this.__breadcrumbs.length > s && (this.__breadcrumbs = this.__breadcrumbs.slice(this.__breadcrumbs.length - s)), this;
                                }
                            }),
                            ...
                            (e.prototype.__buildPayload = function (e) {
                                ...
                                return {
                                    ...
                                    request: {
                                        url: j(e.url, this.config.filters),
                    ...
                    return (
                        ...
                        (r.prototype.__buildPayload = function (e) {
                            var t,
                                r,
                                o,
                                s = {HTTP_USER_AGENT: void 0, HTTP_REFERER: void 0, HTTP_COOKIE: void 0};
                            (s.HTTP_USER_AGENT = navigator.userAgent),
                                document.referrer.match(/\S/) && (s.HTTP_REFERER = document.referrer),
                            ...
                            var i = n.prototype.__buildPayload.call(this, e);
                            return (i.request.cgi_data = l(s, i.request.cgi_data)), i;
                        }),
                        (r.prototype.__send = function (e) {
                            ...
                            var n,
                                ...
                                s = Array.prototype.slice.call(this.__afterNotifyHandlers);
                            e.afterNotify && s.unshift(e.afterNotify);
                            try {
                                ...
                                i.open(
                                    ...
                                    i.setRequestHeader('X-API-Key', this.config.apiKey),
                                    i.setRequestHeader('Content-Type', 'application/json'),
                                    i.setRequestHeader('Accept', 'text/json, application/json'),
                                    i.send(JSON.stringify(p(o, this.config.maxObjectDepth))),
                                    (i.onload = function () {
                                        if (201 !== i.status)
                                            return (
                                                m(e, s, new Error('Bad HTTP response: ' + i.status)),
                                                void t.logger.debug('Unable to send error report: ' + i.status + ': ' + i.statusText, i, e)
                                            );
                                        m(l(e, {id: JSON.parse(i.response).id}), s), t.logger.debug('Error report sent', e);
                                    });
                            } catch (t) {
                                m(e, s, t), this.logger.error('Unable to send error report: error while initializing request', t, e);
                            }
                            return !0;
                        }),
                                    ...
                                    var n = function (t, n, r, o, s) {
                                        ...
                                        if (e.config.enableUncaught)
                                            if (0 === r && /Script error\.?/.test(t))
                                                ...
                                                var i = h(s);
                                                i.name || (i.name = 'window.onerror'),
                                                    i.message || (i.message = t),
                                                    i.stack || (i.stack = [i.message, '\n    at ? (', n || 'unknown', ':', r || 0, ':', o || 0, ')'].join('')),
                                                    e.addBreadcrumb('window.onerror' !== i.name && i.name ? 'window.onerror: ' + i.name : 'window.onerror', {
                                                        category: 'error',
                                                        metadata: {name: i.name, message: i.message, stack: i.stack},
                                                    }),
                                                    e.notify(i);
                                            }
                                    };
                                    return function (e, r, o, s, i) {
                                        return n(e, r, o, s, i), 'function' == typeof t && t.apply(window, arguments);
                                    };
                                });
                            },
                        }),
                                                    ...
                                                    if ((t.logger.debug('window.onunhandledrejection callback invoked', arguments), t.config.enableUnhandledRejection)) {
                                                        ...
                                                        if (r instanceof Error) {
                                                            var o = 'unknown',
                                                                ...
                                                                i = r.message + '\n    at ? (' + o + ':' + s + ')',
                                                                a = r.stack || i,
                                                                c = {name: r.name, message: 'UnhandledPromiseRejectionWarning: ' + r, stack: a};
                                                            return t.addBreadcrumb('window.onunhandledrejection: ' + c.name, {category: 'error', metadata: c}), void t.notify(c);
                                                        }
                                            ...
                                            r &&
                                                ...
                                                (y(r, 'addEventListener', function (e) {
                                                    ...
                                                    return function (n, o, s, i) {
                                                        ...
                                                        return e.call(this, n, t.__wrap(o, r), s, i);
                                                    };
                                                }),
                                                y(r, 'removeEventListener', function (e) {
                                                    return function (n, r, o, s) {
                                                        return e.call(this, n, r, o, s), e.call(this, n, t.__wrap(r), o, s);
                                                    };
                                                }));
                                        });
                                    },
                                        ...
                                        !(function () {
                                                    ...
                                                    y(e.console, n, function (o) {
                                                        return function () {
                                                            var s = Array.prototype.slice.call(arguments),
                                                                i = r(s),
                                                                a = {category: 'log', metadata: {level: n, arguments: p(s, 3)}};
                                                            t.addBreadcrumb(i, a), 'function' == typeof o && Function.prototype.apply.call(o, e.console, arguments);
                                                        };
                                                    });
                                                });
                                        })(),
                                            ...
                                            n('network') &&
                                                (function () {
                                                    ...
                                                    if (E(window.fetch)) return !0;
                                                    try {
                                                        var e = document.createElement('iframe');
                                                        (e.style.display = 'none'), document.head.appendChild(e);
                                                        var t = e.contentWindow.fetch && E(e.contentWindow.fetch);
                                                ...
                                                y(e, 'fetch', function (n) {
                                                    return function () {
                                                        ...
                                                        'string' == typeof o
                                                            ...
                                                            ? ((r = o.url), o.method && (s = o.method))
                                                            : (r = String(o)),
                                                            arguments[1] && arguments[1].method && (s = arguments[1].method),
                                                            'string' == typeof s && (s = s.toUpperCase());
                                                        var i = s + ' ' + q(r),
                                                            a = {type: 'fetch', method: s, url: r};
                                                        return n
                                                            .apply(this, arguments)
                                                            .then(function (e) {
                                                                return (a.status_code = e.status), t.addBreadcrumb(i, {category: 'request', metadata: a}), e;
                                                            })
                                                            .catch(function (e) {
                                                                throw (t.addBreadcrumb('fetch error', {category: 'error', metadata: a}), e);
                                                            });
                                                    };
                                                }),
                                            (function () {
                                                if (n('navigation')) {
                                                    ...
                                                    y(e, 'onpopstate', function (t) {
                                                        ...
                                                        y(e.history, 'pushState', s),
                                                        y(e.history, 'replaceState', s);
                                                }
                                                function o(e, n) {
  ...
  \********************************************************/
        /*! no static exports found */ function (e, t, n) {
            var r = n(/*! ./_ctx */ './node_modules/core-js/modules/_ctx.js'),
                o = n(/*! ./_iobject */ './node_modules/core-js/modules/_iobject.js'),
                s = n(/*! ./_to-object */ './node_modules/core-js/modules/_to-object.js'),
                i = n(/*! ./_to-length */ './node_modules/core-js/modules/_to-length.js'),
                a = n(/*! ./_array-species-create */ './node_modules/core-js/modules/_array-species-create.js');
            e.exports = function (e, t) {
                ...
                return function (t, a, p) {
                    for (var h, y, g = s(t), v = o(g), _ = r(a, p, 3), j = i(v.length), b = 0, w = n ? f(t, j) : c ? f(t, 0) : void 0; j > b; b++)
                        if ((m || b in v) && ((y = _((h = v[b]), b, g)), e))
                            if (n) w[b] = y;
                            else if (y)
                                switch (e) {
                                    case 3:
  ...
  \********************************************************************/
        /*! no static exports found */ function (e, t, n) {
            var r = n(/*! ./_is-object */ './node_modules/core-js/modules/_is-object.js'),
                o = n(/*! ./_is-array */ './node_modules/core-js/modules/_is-array.js'),
                s = n(/*! ./_wks */ './node_modules/core-js/modules/_wks.js')('species');
            e.exports = function (e) {
                var t;
                return (
                    o(e) && ('function' != typeof (t = e.constructor) || (t !== Array && !o(t.prototype)) || (t = void 0), r(t) && null === (t = t[s]) && (t = void 0)),
                    void 0 === t ? Array : t
                );
            };
        },
  ...
  \***************************************************************/
        /*! no static exports found */ function (e, t, n) {
            var r = n(/*! ./_array-species-constructor */ './node_modules/core-js/modules/_array-species-constructor.js');
            e.exports = function (e, t) {
                return new (r(e))(t);
            };
        },
                ...
                c = function (e, t, n) {
                    ...
                    for (u in (p && (n = t), n))
                        (d = ((l = !f && v && void 0 !== v[u]) ? v : n)[u]),
                            (m = g && l ? a(d, r) : y && 'function' == typeof d ? a(Function.call, d) : d),
                            v && i(v, u, d, e & c.U),
                            _[u] != d && s(_, u, m),
                            y && j[u] != d && (j[u] = d);
                };
  ...
  \**************************************************************/
        /*! no static exports found */ function (e, t, n) {
            var r = n(/*! ./_is-object */ './node_modules/core-js/modules/_is-object.js'),
                o = n(/*! ./_set-proto */ './node_modules/core-js/modules/_set-proto.js').set;
            e.exports = function (e, t, n) {
                var s,
                    i = t.constructor;
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            e.exports = function (e, t, n, p, h, y, g) {
                ...
                var v,
                    ...
                    E = A || b(h),
                    M = h ? (S ? b('entries') : E) : void 0,
                    q = ('Array' == t && k.entries) || A;
                if (
                    (q && (j = l(q.call(new e()))) !== Object.prototype && j.next && (u(j, w, !0), r || 'function' == typeof j[d] || i(j, d, f)),
                    S &&
                        A &&
                        'values' !== A.name &&
                        ((x = !0),
                    ...
                    if (((v = {values: S ? E : b('values'), keys: y ? E : b('keys'), entries: M}), g)) for (_ in v) _ in k || s(k, _, v[_]);
            ...
            e.exports = {
                set:
                    ...
                    ('__proto__' in {}
                        ? (function (e, t, r) {
                              try {
                                  (r = n(/*! ./_ctx */ './node_modules/core-js/modules/_ctx.js')(
                                      Function.call,
  ...
  \******************************************************/
        /*! no static exports found */ function (e, t, n) {
            var r = n(/*! ./_export */ './node_modules/core-js/modules/_export.js'),
                o = n(/*! ./_defined */ './node_modules/core-js/modules/_defined.js'),
                s = n(/*! ./_fails */ './node_modules/core-js/modules/_fails.js'),
                i = n(/*! ./_string-ws */ './node_modules/core-js/modules/_string-ws.js'),
                a = '[' + i + ']',
                c = RegExp('^' + a + a + '*'),
                u = RegExp(a + a + '*$'),
                l = function (e, t, n) {
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            (m && f) ||
                ...
                'process' == n(/*! ./_cof */ './node_modules/core-js/modules/_cof.js')(d)
                    ...
                    : p
                    ? ((s = (o = new p()).port2), (o.port1.onmessage = _), (r = i(s.postMessage, s, 1)))
  ...
  \********************************************************/
        /*! no static exports found */ function (e, t, n) {
            'use strict';
            var r = n(/*! ./_export */ './node_modules/core-js/modules/_export.js'),
                o = n(/*! ./_array-methods */ './node_modules/core-js/modules/_array-methods.js')(5),
                s = !0;
            'find' in [] &&
                ...
                n(/*! ./_add-to-unscopables */ './node_modules/core-js/modules/_add-to-unscopables.js')('find');
        },
  ...
  \****************************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var r = n(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                i = n(/*! ./_inherit-if-required */ './node_modules/core-js/modules/_inherit-if-required.js'),
            ...
            if (!f(' 0o1') || !f('0b1') || f('+0x1')) {
                ...
                for (
                    ...
                    o(p, (_ = j[b])) && !o(f, _) && d(f, _, l(p, _));
                (f.prototype = h), (h.constructor = f), n(/*! ./_redefine */ './node_modules/core-js/modules/_redefine.js')(r, 'Number', f);
            }
        },
  ...
  \*****************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            T ||
                ...
                (s = function () {
                    var e = new r();
                    (this.promise = e), (this.resolve = u(Y, e, 1)), (this.reject = u(I, e, 1));
                }),
                (_.f = L = function (e) {
                ...
                return [
                    ...
                    function (e, t) {
                        ...
                        for (var j, b = '', w = 0, S = 0; S < v.length; S++) {
                            _ = v[S];
                            for (var x = String(_[0]), k = u(l(i(_.index), m.length), 0), A = [], E = 1; E < _.length; E++) A.push(void 0 === (j = _[E]) ? j : String(j));
                            var M = _.groups;
                            if (f) {
                                var q = [x].concat(A, k, m);
                                void 0 !== M && q.push(M);
                                var L = String(t.apply(void 0, q));
                            } else L = h(x, m, k, A, M, t);
                            k >= w && ((b += m.slice(w, k) + L), (w = k + x.length));
                        }
                        return b + m.slice(w);
                    },
                ];
                function h(e, t, r, s, i, a) {
                    var c = r + e.length,
                        u = s.length,
                        l = f;
                    return (
                        ...
                        ''.split(/.?/)[f]
                            ? function (e, t) {
                                  ...
                                  for (
                                      ...
                                      !(
                                          (i = h.lastIndex) > d &&
                                          (c.push(o.slice(d, s.index)), s[f] > 1 && s.index < o[f] && m.apply(c, s.slice(1)), (a = s[0][f]), (d = i), c[f] >= p)
                                      );

                                  )
                                      h.lastIndex === s.index && h.lastIndex++;
                                  return d === o[f] ? (!a && h.test('')) || c.push('') : c.push(o.slice(d)), c[f] > p ? c.slice(0, p) : c;
                              }
                            : '0'.split(void 0, 0)[f]
                            ? function (e, t) {
                    ...
                    [
                        ...
                        function (e, t) {
                            ...
                            for (var j = 0, b = 0, w = []; b < m.length; ) {
                                ...
                                var S,
                                    x = c(v, p ? m : m.slice(b));
                                if (null === x || (S = d(a(v.lastIndex + (p ? 0 : b)), m.length)) === j) b = i(m, b, y);
                                else {
                                    if ((w.push(m.slice(j, b)), w.length === _)) return w;
  ...
  \****************************************************/
        /*! no static exports found */ function (e, t, n) {
                ...
                (a(
                    (P = function () {
                        ...
                        var e = m(arguments.length > 0 ? arguments[0] : void 0),
                            t = function (n) {
                                this === N && t.call(B, n), o(this, D) && o(this[D], e) && (this[D][e] = !1), G(this, e, S(1, n));
                            };
            ...
            for (var te = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), ne = 0; te.length > ne; )
                f(te[ne++]);
            for (var re = q(f.store), oe = 0; re.length > oe; ) h(re[oe++]);
            i(i.S + i.F * !U, 'Symbol', {
                for: function (e) {
            ...
            i(i.S + i.F * se, 'Object', {
                ...
                P.prototype[I] || n(/*! ./_hide */ './node_modules/core-js/modules/_hide.js')(P.prototype, I, P.prototype.valueOf),
                d(P, 'Symbol'),
                d(Math, 'Math', !0),
                d(r.JSON, 'JSON', !0);
        },
        ...
        /*! no static exports found */ function (e, t, n) {
            for (
                ...
                var y,
                    ...
                    _ = i[g],
                    j = _ && _.prototype;
                if (j && (j[l] || a(j, l, m), j[d] || a(j, d, g), (c[g] = m), v)) for (y in r) j[y] || s(j, y, r[y], !0);
            }
        },
  ...
  \********************************************/
        /*! exports provided: Headers, Request, Response, DOMException, fetch */ function (e, t, n) {
            ...
            (A.polyfill = !0), r.fetch || ((r.fetch = A), (r.Headers = p), (r.Request = b), (r.Response = S));
        },
    './site_configs/club_seacret_template-70905/js/70905-config.js':
        /*!*********************************************************************!*\
  !*** ./site_configs/club_seacret_template-70905/js/70905-config.js ***!
  \*********************************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            Object.defineProperty(t, '__esModule', {value: !0}),
                (t.default = function () {
                    return {
                        ...
                        header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(s, '/img/logo.png'), logo_outbound_url: 'https://seacretdirect.com'},
            ...
            var o = new ((r = n(/*! ../../../js/build_tools/path */ './js/build_tools/path.js')) && r.__esModule ? r : {default: r}).default(),
                s = 'club_seacret_template-'.concat(70905);
        },
    './site_configs/club_seacret_template-70905/js/70905.js':
        /*!**************************************************************!*\
  !*** ./site_configs/club_seacret_template-70905/js/70905.js ***!
  \**************************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            n(/*! core-js/modules/es7.symbol.async-iterator */ './node_modules/core-js/modules/es7.symbol.async-iterator.js'),
                ...
                n(/*! core-js/modules/es6.array.find */ './node_modules/core-js/modules/es6.array.find.js'),
                n(/*! regenerator-runtime/runtime */ './node_modules/regenerator-runtime/runtime.js');
            var r = a(n(/*! dayjs */ './node_modules/dayjs/dayjs.min.js')),
                o = a(n(/*! ../../../js/build */ './js/build.js')),
                s = a(n(/*! ./70905-config */ './site_configs/club_seacret_template-70905/js/70905-config.js')),
            ...
            var v = n(/*! @honeybadger-io/js */ './node_modules/@honeybadger-io/js/dist/browser/honeybadger.js');
            v.configure({apiKey: 'hbp_x1ihf9kzxy3wZAP1p6r17OtymLIQVd0c61O2', environment: 'development'});
            var _ = new s.default(),
                j = new i.default();
            v.setContext({user_email: j.getMetaTagContent('email')}),
                new ((function (e) {
                    !(function (e, t) {
                                            ...
                                            return regeneratorRuntime.wrap(
                                                function (e) {
                                                    for (;;)
                                                        switch ((e.prev = e.next)) {
                                                            case 0:
                                                                return (e.next = 2), j.waitForSelectorInDOM('.bottom-carousel-article');
                                                            case 2:
                                                                if (
                                                                    (null === (t = this.trip) ||
                                                                    void 0 === t ||
                                                                    ...
                                                                    void 0 === s
                                                                        ? void 0
                                                                        : s.text) &&
                                                                    (null === (i = this.trip.data.property_name) || void 0 === i || null === (a = i[0]) || void 0 === a
                                                                        ? void 0
                                                                        : a.text) &&
                                                                    (null === (c = this.trip.data.trip_location) || void 0 === c || null === (u = c[0]) || void 0 === u
                                                                        ? void 0
                                                                        : u.text) &&
                                                                ...
                                                                return (
                                                                    ...
                                                                    e.abrupt(
                                                                        'return',
                                                                        v.notify('Trip object, trip data, trip name, property name, trip date, or trip location not found.', {
                                                            ...
                                                            case 5:
                                                                if (
                                                                    ((h = (0, r.default)(this.trip.data.start_date).format('MM/DD/YYYY')),
                                                                    ...
                                                                    document
                                                                        ...
                                                                        .insertAdjacentHTML(
                                                                            ...
                                                                            "\n            <div class='hero-text-container'>\n                <h1 class='trip-title'>"
                                                                                ...
                                                                                .concat(
                                                                                    y,
                                                                                    '</h2>\n                </div>\n            </div>\n            <style>\n                .hero-container{\n                    background: linear-gradient(rgba(255, 255, 255, 0) 55%, rgba(255, 255, 255, 0.9)), linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url('
                                                                                )
                                                                                .concat(
                                                                    ...
                                                                    void 0 === m
                                                                        ? void 0
                                                                        : m.text) &&
                                                                        (null === (f = this.trip.data.itinerary[0].description) ||
                                                                        void 0 === f ||
                                                                        null === (p = f[0]) ||
                                                                        void 0 === p
                                                                            ? void 0
                                                                ...
                                                                return (
                                                                    ...
                                                                    e.abrupt(
                                                                        'return',
                                                                        v.notify('Itinerary object, itinerary day, or itinerary description not found.', {
                                                                            params: {trip: this.trip},
                                                                        })
                                                                    )
                                                                );
                                                            case 11:
                                                                if (
                                                                    (this.trip.data.itinerary.forEach(function (e) {
                                                                        document
                                                                ...
                                                                return (
                                                                    ...
                                                                    e.abrupt('return', v.notify('ARN property rooms array from DOM is not found.'))
                                                                );
                                                            case 16:
                                                                document.querySelectorAll('#standardAvail .rateRow').forEach(function (e) {
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        return (
                                                                            ...
                                                                            v.notify('ARN Full-stay price for trip is not found.')
                                                                        );
                                                                    var o = e.querySelector('.full-stay').innerText,
                                                                        s = Number(o.split(' ')[0]).toLocaleString(),
                                                                        i = document.querySelector('.trip-price-mobile'),
                                                                        a = document.querySelector('.trip-price-desktop');
                                                                    if (
                                                                        ((i.innerText = '$'.concat(s)),
                                                                        (a.innerText = '$'.concat(s)),
                                                                        !(null === (n = e.querySelector('.bookRoom')) || void 0 === n ? void 0 : n.innerText))
                                                                    )
                                                                        return (
                                                                            window.alert('Sorry, there was an error. Please contact support.'),
                                                                            v.notify('ARN book cta is not found.')
                                                                        );
                                                                    var c = document.querySelector('.trip-ctas'),
                                                                        u = e.querySelector('.bookRoom');
                                                                    u.classList.remove('bookRoom'),
                                                                        u.classList.add('book-button'),
                                                                        u.classList.add('new-cta'),
                                                                        (u.innerText = 'BOOK TRIP'),
                                                                        c.appendChild(u);
                                                                    var l = e.querySelector('.holdRoom');
                                                                    l &&
                                                                        (l.classList.remove('holdRoom'),
                                                                        l.classList.add('hold-button'),
                                                                        l.classList.add('new-cta'),
                                                                        (l.innerText = 'HOLD TRIP'),
                                                                        c.appendChild(l)),
                                                                        (e.querySelector('.ArnRateCancelPolicyContainer') && e.querySelector('.ArnRateCancelAnchor')) ||
                                                                            v.notify('ARN cancel policy container or anchor are not found.');
                                                                    var d = document.querySelector('.trip-price-cta-container'),
                                                                        m = e.querySelector('.ArnRateCancelPolicyContainer'),
                                                                        f = e.querySelector('.ArnRateCancelAnchor');
                                                                    f.classList.add('cancellation-policy'), d.appendChild(f), d.appendChild(m);
                                                                    var p = e.querySelector('.ArnRateFromTo'),
                                                                        h = e.querySelector('.ArnNightlyRate'),
                                                                        y = e.querySelector('.RateCalendarPopupAnchor'),
                                                                        g = e.querySelector('.RateCalendarPopupContainer');
                                                                    p.remove(),
                                                                        h.remove(),
                                                                        y.remove(),
                                                                        g.remove(),
                                                                    ...
                                                                    var _ = e.innerText,
                                                                        j = e.innerText.split(':'),
                                                                        b = document.querySelector('.trip-item-name'),
                                                                        w = j[0].trim(),
                                                                        S = document.querySelector('.trip-item-description'),
                                                                        x = e.innerText.indexOf(':') + 1,
                                                                        k = e.innerText.slice(x).trim();
                                                                    try {
                                                                        if (!_.includes(':') || !w || !k) return void (S.innerText = _.trim());
                                                                    } catch (t) {
                                                                        v.notify('Room description colon is not found in room index '.concat(e)),
                                                                            console.error('Error inside room_title and room_description verification: ', t);
                                                                    }
                                                                    (S.innerText = k), (b.innerText = w);
                                                                });
                                                            case 18:
                                                            case 'end':
                                                                return e.stop();
                                        ...
                                        regeneratorRuntime.mark(function e() {
                                            ...
                                            return regeneratorRuntime.wrap(function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return (e.next = 2), j.waitForSelectorInDOM('.carousel-container');
                                                        case 2:
                                                            if (
                                                                ((t = document.querySelector('.carousel-container')),
                                                                (n = document.querySelector('.bottom-carousel-article')),
                                                                t && n)
                                                            ) {
                                                                e.next = 6;
                                                                break;
                                        ...
                                        regeneratorRuntime.mark(function e() {
                                            ...
                                            return regeneratorRuntime.wrap(function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return console.log('before await in updatecheckoutinterface'), (e.next = 3), j.waitForSelectorInDOM('.discountRow');
                                                        case 3:
    ...
    './site_configs/club_seacret_template-70905/styles/70905.scss':
        /*!********************************************************************!*\
  !*** ./site_configs/club_seacret_template-70905/styles/70905.scss ***!
  \********************************************************************/
        /*! no static exports found */ function (e, t, n) {},
  ...
  \**********************/
        /*! no static exports found */ function (e, t, n) {
            'use strict';
            n(/*! ../site_configs/club_seacret_template-70905/js/70905 */ './site_configs/club_seacret_template-70905/js/70905.js'),
                n(/*! ../site_configs/club_seacret_template-70905/styles/70905.scss */ './site_configs/club_seacret_template-70905/styles/70905.scss');
        },
});
