    ...
    function (e, t, n) {
        ...
        var p = new (function () {
                return {
                    ...
                    show_date_prompt: !1,
                    fav_icon_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/favicon-gold.png'),
                    has_custom_styles: !0,
                    custom_styles_url: ''.concat(o.path, '/site_configs/').concat(i, '/39624.css'),
        ...
        !(function () {
            ...
            v('#theUserNameAjax input', 'Email', 'placeholder'),
            v('#theUserNameAjax input', 'email', 'type'),
            v('#theFirstNameAjax input', 'First Name', 'placeholder'),
            v('#theLastNameAjax input', 'Last Name', 'placeholder'),
            v('#theEditablePasswordAjax input', 'Create a Password', 'placeholder'),
            v('#theEditableConfirmPasswordAjax input', 'Confirm Password', 'placeholder'),
            ...
            b('.SinglePropDetail .rateRow'),
            jQuery(document).on('ratesReadyEvent', function () {
                setTimeout(function () {
                    b('.SearchHotels .ArnContainer');
                }, 1);
            }),
            (function () {
            ...
            document.querySelector('.SinglePropDetail') && w(['#standardAvail legend', '#thePropertyReviews legend', '#theGeneralInfo legend']),
            document.querySelector('.CheckOutForm') &&
                setTimeout(function () {
                    w(['#theConfirmationContainer legend', '#theHotel legend']);
                }, 1),
            m.updateHTML(
                '.ArnSupportChatTable',
            ...
            document.querySelector('.WBSupportFormContainer') &&
                (v('#theNameAjax input', 'Name', 'placeholder'),
                v('#theDaytimePhoneNumberAjax input', 'Phone Number', 'placeholder'),
                v('#theEmailAjax input', 'Email', 'placeholder'),
                v('#theEmailAjax input', 'email', 'type'),
                v('#theReservationConfirmationNumberAjax input', 'Booking Number', 'placeholder'),
                v('#theDateOfArrivalAjax input', 'Check In Date', 'placeholder'),
                v('#theHotelNameAjax input', 'Hotel', 'placeholder'),
                v('#theCommentsAjax textarea', 'Comments', 'placeholder'),
