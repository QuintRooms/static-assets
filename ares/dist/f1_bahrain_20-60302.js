!(function (e) {
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var S = 0, w = 0, _ = []; w < d.length; ) {
                            ...
                            var x,
                                k = s(g, p ? d : d.slice(w));
                            if (null === k || (x = f(c(g.lastIndex + (p ? 0 : w)), d.length)) === S) w = a(d, w, y);
                            else {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: x ? q : w('values'), keys: y ? q : w('keys'), entries: M}), v)) for (b in g) b in A || i(A, b, g[b]);
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    ...
                                                                    return e.abrupt('return');
                                                                case 2:
                                                                    return (e.next = 4), c.fetchHTMLFromFile(''.concat(s.path, '/html/f1/footer.html'));
                                                                case 4:
                                                            ...
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (
                                                                        ...
                                                                        (e.next = 3),
                                                                        c.fetchHTMLFromFile(''.concat(s.path, '/html/f1/mobile-hamburger-menu.html'))
                                                                    );
                                                                case 3:
                                                                    return (
                                                                        (o = e.sent),
                                                ...
                                                regeneratorRuntime.mark(function e(t) {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (e) {
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (e.next = 2), c.fetchHTMLFromFile(''.concat(s.path, '/html/f1/f1-header.html'));
                                                                case 2:
                                                                    if (
                                                                        ((o = e.sent),
                                ...
                                case 8:
                                    (n = document.querySelector('header')), (r = document.querySelector('#language')), o(t), u(t), f();
                                case 13:
                                case 'end':
                                    return e.stop();
                            }
    ...
    function (e, t, n) {
        ...
        n(34), n(21), n(115), n(32), n(31), n(69), n(70), n(33), n(66), n(57);
        function r(e, t, n, r, o, i, a) {
            try {
                var c = e[i](a),
                    s = c.value;
                                                        ...
                                                        return regeneratorRuntime.wrap(function (n) {
                                                            for (;;)
                                                                switch ((n.prev = n.next)) {
                                                                    ...
                                                                    case 2:
                                                                        return ((r = new a()).params = []), (n.next = 6), r.getPropertyLatLong();
                                                                    case 6:
            ...
            (function (e, t, n, r) {
                if (document.querySelector('.SearchHotels') || document.querySelector('.SinglePropDetail')) {
                    ...
                    document.querySelector('#theCheckIn').addEventListener('click', function () {
                        localStorage.getItem('weekendTwoPopup') || a(o, i);
                    }),
