!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(2),
            i = n(112),
            o = n(46);
        n(47)('search', 1, function (e, t, n, a) {
            return [
                function (n) {
                    var r = e(this),
                        i = null == n ? void 0 : n[t];
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', S = 0, k = 0; k < g.length; k++) {
                        ...
                        } else R = m(x, h, A, E, L, t);
                        A >= S && ((w += h.slice(S, A) + R), (S = A + x.length));
                    }
                    return w + h.slice(S);
                },
            ];
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, v) {
            ...
            if (
                ...
                if (((g = {values: k ? q : w('values'), keys: y ? q : w('keys'), entries: L}), v)) for (_ in g) _ in A || o(A, _, g[_]);
        ...
        var r = n(1),
            ...
            K = function (e, t, n) {
                return (
                    ...
                    g(n),
                    i(B, t)
                        ? (n.enumerable ? (i(e, j) && e[j][t] && (e[j][t] = !1), (n = x(n, {enumerable: k(0, !1)}))) : (i(e, j) || P(e, j, k(1, {})), (e[j][t] = !0)), W(e, t, n))
                        : P(e, t, n)
                );
            },
            Q = function (e, t) {
            ...
            J = function (e) {
                ...
                return !(this === N && i(B, e) && !i(Y, e)) && (!(t || !i(this, e) || !i(B, e) || (i(this, j) && this[j][e])) || t);
            },
            Z = function (e, t) {
                if (((e = w(e)), (t = S(t, !0)), e !== N || !i(B, t) || i(Y, t))) {
                    var n = R(e, t);
                    return !n || !i(B, t) || (i(e, j) && e[j][t]) || (n.enumerable = !0), n;
                }
            },
            X = function (e) {
                for (var t, n = T(w(e)), r = [], o = 0; n.length > o; ) i(B, (t = n[o++])) || t == j || t == c || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = T(n ? Y : w(e)), o = [], a = 0; r.length > a; ) !i(B, (t = r[a++])) || (n && !i(N, t)) || o.push(B[t]);
                return o;
            };
        $ ||
            (s(
                (M = function () {
                    ...
                    var e = h(arguments.length > 0 ? arguments[0] : void 0),
                        t = function (n) {
                            this === N && t.call(Y, n), i(this, j) && i(this[j], e) && (this[j][e] = !1), W(this, e, k(1, n));
                        };
    ...
    function (e, t, n) {
        ...
        e.exports = function (e) {
            return function (t) {
                for (var n, s = o(t), c = i(s), u = c.length, l = 0, d = []; u > l; ) (n = c[l++]), (r && !a.call(s, n)) || d.push(e ? [n, s[n]] : s[n]);
                return d;
            };
        };
    },
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(81), n(82), n(43), n(14), n(92), n(94), n(24), n(107), n(37), n(26), n(110), n(45), n(114), n(49), n(72), n(73), n(75), n(27);
                            ...
                            value: function (e, t, n) {
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (o) {
                                    ...
                                    52342 === e.site_id || ('standard' === n.getMetaTagContent('theme') && 16980 !== e.affiliate_id)
                                        ? ((u = j(document.querySelector('input#theCheckIn').value, 'M/D/YYYY').format('M/D/YYYY')),
                                          (d = j(document.querySelector('input#theCheckOut').value, 'M/D/YYYY').format('M/D/YYYY')),
                                          (h = j(d).diff(j(u), 'days')))
                                        : 'mandarin' === n.getMetaTagContent('theme') || 'tw_mandarin' === n.getMetaTagContent('theme')
                                        ? ((u = j(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (d = j(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (h = j(d).diff(j(u), 'days')),
                                          (u = j(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('YYYY/M/D')),
                                          (d = j(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('YYYY/M/D')))
                                        : (16980 === e.affiliate_id || e.site_id,
                                          (u = j(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('M/D/YYYY')),
                                          (d = j(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('M/D/YYYY')),
                                          (h = j(d).diff(j(u), 'days')),
                                          (u = j(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('D/M/YYYY')),
                                          (d = j(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('D/M/YYYY'))),
        ...
        var z = new T(),
            ...
            K = (function () {
                ...
                var t, n, r, i, o, a, s, c, u, l, d, h, f, p;
                return (
                    (t = e),
                    (n = [
                        {
                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    ...
                                                                    return e.abrupt('return');
                                                                case 2:
                                                                    return (e.next = 4), ee.fetchHTMLFromFile(''.concat(te.path, '/html/f1/footer.html'));
                                                                case 4:
                                                            ...
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (
                                                                        ...
                                                                        (e.next = 3),
                                                                        ee.fetchHTMLFromFile(''.concat(te.path, '/html/f1/mobile-hamburger-menu.html'))
                                                                    );
                                                                case 3:
                                                                    return (
                                                                        (o = e.sent),
                                                ...
                                                regeneratorRuntime.mark(function e(o) {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (e) {
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (e.next = 2), ee.fetchHTMLFromFile(''.concat(te.path, '/html/f1/f1-header.html'));
                                                                case 2:
                                                                    if (
                                                                        ((a = e.sent),
                                                                        (s =
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            ...
                                                            (i = function () {
                                                                var e = new URLSearchParams(ce.getMetaTagContent('originalParams')).get('properties');
                                                                if (e)
                                                    ...
                                                    case 8:
                                                        (t = []),
                                                            ...
                                                            (l = [].slice.call(t).sort(function (e, t) {
                                                                return u(e.querySelector('.distanceLabel').textContent) > u(t.querySelector('.distanceLabel').textContent) ? 1 : -1;
                                                            })),
                                                            o(),
        ...
        var ge = new (function () {
                return {
                    ...
                    lodging: {event_id: 11111, event_name: 'Bahrain Grand Prix', event_dates: '11/27/2020 - 11/29/2020', is_lrg: !1},
        ...
        !(function (e) {
            ...
            (function (e, t, n, r) {
                if (document.querySelector('.SearchHotels') || document.querySelector('.SinglePropDetail')) {
                    var i = e.site_id.toString() === document.querySelector('meta[name="siteId"]').content ? r : n,
                        o = e.site_id.toString() === document.querySelector('meta[name="siteId"]').content ? t : e.lodging.event_name;
                    document.querySelector('#theCheckIn').addEventListener('click', function () {
                        localStorage.getItem('weekendTwoPopup') || a(i, o);
                    }),
                ...
                function a(e, t) {
                    document.body.classList.toggle('hidden'), window.localStorage.setItem('weekendTwoPopup', 'true');
                    var n = document.querySelector('.SearchHotels') ? '.ArnSearchContainerMainDiv' : '#theBody';
                    document
                        .querySelector(n)
                        .insertAdjacentHTML(
                            'afterbegin',
                            '\n            <div id="popup-modal" class="modal-overlay show-modal">\n                <div id="weekend-popup" class="modal-container">\n                    <div class="modal-header">\n                        <div id="header-text">\n                            <h3>'
                                ...
                                .concat(e, '">Check Rates</a>\n                </div>\n            </div>\n            ')
                        ),
                        document.querySelector('.close-modal').addEventListener('click', function () {
                            document.body.classList.toggle('hidden'), (document.querySelector('.modal-overlay').style.display = 'none');
                        });
                }
            })(
                ge,
