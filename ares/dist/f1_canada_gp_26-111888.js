!(function (e) {
        ...
        var r,
            ...
            M = !!(function () {
                try {
                    ...
                    return (P || 'function' == typeof PromiseRejectionEvent) && e.then(T) instanceof t && 0 !== E.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            O = function (e) {
                var t;
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, y, m, v) {
            ...
            var g,
                ...
                k = !1,
                L = e.prototype,
                E = L[h] || L['@@iterator'] || (y && L[y]),
                A = E || w(y),
                P = y ? (x ? w('entries') : A) : void 0,
                T = ('Array' == t && L.entries) || E;
            if (
                ...
                if (((g = {values: x ? A : w('values'), keys: m ? A : w('keys'), entries: P}), v)) for (_ in g) _ in L || i(L, _, g[_]);
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, S = []; w < f.length; ) {
                            ...
                            if (null === k || (x = h(s(g.lastIndex + (p ? 0 : w)), f.length)) === b) w = a(f, w, m);
                                ...
                                for (var L = 1; L <= k.length - 1; L++) if ((S.push(k[L]), S.length === _)) return S;
                                w = b = x;
                            }
                        }
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', S = 0, x = 0; x < g.length; x++) {
                        _ = g[x];
                        for (var k = String(_[0]), L = u(l(a(_.index), f.length), 0), E = [], A = 1; A < _.length; A++) E.push(void 0 === (b = _[A]) ? b : String(b));
                        var P = _.groups;
                        if (d) {
                            var T = [k].concat(E, L, f);
                            void 0 !== P && T.push(P);
                            var q = String(t.apply(void 0, T));
                        } else q = y(k, f, L, E, P, t);
                        L >= S && ((w += f.slice(S, L) + q), (S = L + k.length));
                    }
                    return w + f.slice(S);
                },
            ];
    ...
    function (e, t, n) {
        ...
        (0, a.default)(b.site_id, b.lodging.event_name, 'Montreal CA', '#000'),
            new w(),
            new s.default(),
            (function () {
                S.apply(this, arguments);
            })();
        var x = _.getMetaTagContent('theme');
        function k() {
            return (k = h(
                u().mark(function e() {
                    return u().wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (e.next = 2), _.waitForSelectorInDOM('.translateMe');
                                case 2:
                                    'french' === x ? _.updateHTML('.translateMe', 'Modifier La Recherche') : _.updateHTML('.translateMe', 'Update Search');
                                case 3:
                                case 'end':
                                    return e.stop();
                            }
                ...
                u().mark(function e() {
                    return u().wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (e.next = 2), _.waitForSelectorInDOM('.span.open-modal');
                                case 2:
    ...
    function (e, t, n) {
            ...
            (t.default = function () {
                return {
                    ...
                    header: {
                        ...
                        email_logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/email-logo_2024.png'),
        ...
        var o = new ((r = n(62)) && r.__esModule ? r : {default: r}).default(),
            i = 'f1_canada_gp_26-'.concat(111888);
    },
    function (e, t, n) {
        'use strict';
        function r(e) {
