!(function (e) {
                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    ...
                                                                    return e.abrupt('return');
                                                                case 2:
                                                                    return (e.next = 4), c.fetchHTMLFromFile(''.concat(s.path, '/clients/formula-1/html/footer.html'));
                                                                case 4:
                                                            ...
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (
                                                                        ...
                                                                        (e.next = 3),
                                                                        c.fetchHTMLFromFile(''.concat(s.path, '/clients/formula-1/html/mobile-hamburger-menu.html'))
                                                                    );
                                                                case 3:
                                                                    return (
                                                                        (i = e.sent),
                                                ...
                                                regeneratorRuntime.mark(function e(i) {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (e) {
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (e.next = 2), c.fetchHTMLFromFile(''.concat(s.path, '/clients/formula-1/html/f1-header.html'));
                                                                case 2:
                                                                    if (
                                                                        ((a = e.sent),
                                                                        (u =
    ...
    function (e, t, n) {
        ...
        var m,
            y = new (function () {
                return {
                    ...
                    fav_icon_url: ''.concat(i.path, '/clients/formula-1/images/favicon.png'),
                    header: {
                    ...
                    map_marker_image_url: ''.concat(i.path, '/clients/formula-1/images/favicon.png'),
                    theme: 'light',
        ...
        Object(c.a)(y.site_id),
            (m = 'Check back on 13th November for additional and exclusive Dutch GP hotel rates.'),
            document.querySelector('.SearchHotels') &&
                setTimeout(function () {
                    var e;
                    (e = m),
