!(function (t) {
    ...
    function (t, e, n) {
        ...
        Object.defineProperty(e, '__esModule', {value: !0}), (e.default = void 0), n(25), n(49), n(37), n(50), n(36), n(54), n(17), n(12), n(18);
        var i = n(26),
            c = (function () {
                function t() {
                    !(function (t, e) {
                            ...
                            switch ((t.prev = t.next)) {
                                                            ...
                                                            switch ((t.prev = t.next)) {
                                                                            ...
                                                                            null !== o &&
                                                                                (t.matches
                                                                                    ...
                                                                                    : (document.querySelector('#tickets .language').insertAdjacentElement('afterbegin', o),
                                                                                      document.querySelector('.currency').insertAdjacentElement('afterBegin', a)));
                                                                        }),
                                                                        (t.next = 3),
                                                                ...
                                                                case 11:
                                                                    document.querySelector('.navbar-hamburger').addEventListener('click', function () {
                                                                        ...
                                                                        (f = window.matchMedia('(max-width: 1100px)')),
                                                                        l(f),
                                                                        f.addListener(l);
                                                                case 15:
                                                                case 'end':
                                ...
                                case 10:
                                    (r = document.querySelector('header')),
                                        ...
                                        (a = document.querySelector('.currencies-container')),
                                        l(e, n),
                                        p(e, n),
                                        h(),
                                        v();
