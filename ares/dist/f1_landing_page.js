!(function (t) {
    ...
    function (t, e, n) {
        ...
        var r,
            ...
            A = !!(function () {
                try {
                    ...
                    return (j || 'function' == typeof PromiseRejectionEvent) && t.then(E) instanceof e && 0 !== L.indexOf('6.6') && -1 === _.indexOf('Chrome/66');
                } catch (t) {}
            })(),
            T = function (t) {
                var e;
        ...
        A ||
            ...
            (a = function () {
                var t = new r();
                (this.promise = t), (this.resolve = s(F, t, 1)), (this.reject = s($, t, 1));
            }),
            (x.f = O = function (t) {
    ...
    function (t, e, n) {
        ...
        var r = n(1),
            o = n(95),
            a = n(33);
        n(34)('search', 1, function (t, e, n, i) {
            return [
                function (n) {
                    var r = t(this),
                        o = null == n ? void 0 : n[e];
    ...
    function (t, e, n) {
        t.exports = (function () {
            ...
            (b.l = y),
                (b.i = g),
                (b.w = function (t, e) {
                    return x(t, {locale: e.$L, utc: e.$u, $offset: e.$offset});
                });
            var _ = (function () {
                    function p(t) {
    ...
    function (t, e, n) {
        ...
        Object.defineProperty(e, '__esModule', {value: !0}), (e.default = void 0), n(25), n(50), n(37), n(49), n(36), n(54), n(17), n(12), n(18);
        var i = n(26),
            c = (function () {
                function t() {
                    !(function (t, e) {
                ...
                var e, n, r, c, u, s, l, f, p, d, h, m, v, g, y;
                return (
                    (e = t),
                    (n = [
                        {
    ...
    function (t, e, n) {
        for (
            ...
            var v,
                ...
                x = i[g],
                b = x && x.prototype;
            if (b && (b[l] || c(b, l, p), b[f] || c(b, f, g), (u[g] = p), y)) for (v in r) b[v] || a(b, v, r[v], !0);
        }
    },
    function (t, e, n) {
        'use strict';
            ...
            return [
                ...
                function (t, e) {
                    ...
                    for (var y = []; ; ) {
                        ...
                        if (null === x) break;
                        if ((y.push(x), !v)) break;
                        '' === String(x[0]) && (f.lastIndex = c(p, a(f.lastIndex), g));
                    }
                    for (var b, _ = '', w = 0, S = 0; S < y.length; S++) {
                        x = y[S];
                        for (var k = String(x[0]), M = s(l(i(x.index), p.length), 0), L = [], P = 1; P < x.length; P++) L.push(void 0 === (b = x[P]) ? b : String(b));
                        var j = x.groups;
                        if (d) {
                        ...
                        M >= w && ((_ += p.slice(w, M) + O), (w = M + k.length));
                    }
                    return _ + p.slice(w);
                },
            ];
    ...
    function (t, e, n) {
        ...
        (p && d) ||
            ...
            'process' == n(13)(f)
                ...
                : h
                ? ((a = (o = new h()).port2), (o.port1.onmessage = x), (r = i(a.postMessage, a, 1)))
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, h, m, v, g) {
            ...
            var y,
                ...
                P = L || _(m),
                j = m ? (S ? _('entries') : P) : void 0,
                E = ('Array' == e && M.entries) || L;
            if (
                (E && (b = l(E.call(new t()))) !== Object.prototype && b.next && (s(b, w, !0), r || 'function' == typeof b[f] || i(b, f, d)),
                S &&
                    L &&
                    'values' !== L.name &&
                    ((k = !0),
                ...
                if (((y = {values: S ? P : _('values'), keys: v ? P : _('keys'), entries: j}), g)) for (x in y) x in M || a(M, x, y[x]);
    ...
    function (t, e, n) {
        ...
        ((e = t.exports = function (t, e, n, f, p) {
            ...
            if (a(g)) {
                for (d = c(t.length); d > x; x++) if ((v = e ? y(i((h = t[x]))[0], h[1]) : y(t[x])) === s || v === l) return v;
            } else for (m = g.call(t); !(h = m.next()).done; ) if ((v = o(m, y, h.value, e)) === s || v === l) return v;
        }).BREAK = s),
            (e.RETURN = l);
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
        ...
        var c = new (o(n(35)).default)(),
            u = 'hotelsforhope.com',
            s = new r.default(),
            l = c.getMetaTagContent('theme');
        function f() {
            return (f = i(
                regeneratorRuntime.mark(function t(e, n, r, o) {
                    var a, f, p, d, h, m, v, g, y, x, b;
                    return regeneratorRuntime.wrap(function (t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                                ...
                                                regeneratorRuntime.mark(function t() {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (t) {
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    return (t.next = 2), c.waitForSelectorInDOM('.lucid-banner');
                                                                case 2:
                                                                    (n = 'in'),
                                                                        60301 === e && (n = 'near'),
                                                        ...
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                            ...
                                                                            null !== f &&
                                                                                (t.matches
                                                                                    ? (document
                                                                                          ...
                                                                                          .insertAdjacentElement('afterbegin', f),
                                                                                      document
                                                                                          .querySelector('.mobile-nav-lower-ul .currency-mobile-li')
                                                                                          .insertAdjacentElement('afterBegin', p))
                                                                                    : (document.querySelector('#tickets .language').insertAdjacentElement('afterbegin', f),
                                                                                      document.querySelector('.currency').insertAdjacentElement('afterBegin', p)));
                                                                        }),
                                                                        (t.next = 3),
                                                                ...
                                                                case 3:
                                                                    return (
                                                                        (r = t.sent),
                                                                        a.insertAdjacentHTML('afterBegin', r),
                                ...
                                case 10:
                                    (a = document.querySelector('header')),
                                        (f = document.querySelector('#language')),
                                        (p = document.querySelector('.currencies-container')),
                                        d(),
                                        m(),
                                        g(),
                                        x();
    ...
    function (t, e, n) {
        ...
        (0, a(n(125)).default)(document.querySelector('meta[name="siteId"]').content);
        var i,
            c = new o.default();
