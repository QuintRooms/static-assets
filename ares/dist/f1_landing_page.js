!(function (t) {
    ...
    function (t, e, n) {
        ...
        Object.defineProperty(e, '__esModule', {value: !0}), (e.default = void 0), n(31), n(32), n(33), n(22), n(71), n(73), n(77);
        var i = n(79),
            c = (function () {
                function t() {
                    !(function (t, e) {
        ...
        var r,
            ...
            O = !!(function () {
                try {
                    ...
                    return (E || 'function' == typeof PromiseRejectionEvent) && t.then(A) instanceof e && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
                } catch (t) {}
            })(),
            T = function (t) {
                var e;
    ...
    function (t, e, n) {
        ...
        (0, a(n(80)).default)(document.querySelector('meta[name="siteId"]').content);
        var i,
            c = new o.default();
        ...
        r(
            ...
            'Array',
            {
                slice: function (t, e) {
                    ...
                    for (var o = i(t, n), s = i(e, n), l = c(s - o), f = new Array(l), p = 0; p < l; p++) f[p] = 'String' == r ? this.charAt(o + p) : this[o + p];
                    return f;
                },
            }
        );
    ...
    function (t, e, n) {
        ...
        var r;
        Object.defineProperty(e, '__esModule', {value: !0}), (e.default = void 0);
        var o = new ((r = n(29)) && r.__esModule ? r : {default: r}).default(),
            a = {
                races_2021: {
    ...
    function (t, e, n) {
        ...
        ((e = t.exports = function (t, e, n, f, p) {
            ...
            if (a(g)) {
                for (d = c(t.length); d > _; _++) if ((v = e ? y(i((h = t[_]))[0], h[1]) : y(t[_])) === s || v === l) return v;
    ...
    function (t, e, n) {
        n(3) && 'g' != /./g.flags && n(7).f(RegExp.prototype, 'flags', {configurable: !0, get: n(21)});
    },
    function (t, e, n) {
        'use strict';
        var r = n(2),
            ...
            return [
                ...
                function (t, e) {
                    ...
                    for (var b, x = '', w = 0, S = 0; S < y.length; S++) {
                        _ = y[S];
                        for (var k = String(_[0]), M = s(l(i(_.index), p.length), 0), P = [], j = 1; j < _.length; j++) P.push(void 0 === (b = _[j]) ? b : String(b));
                        var E = _.groups;
                        if (d) {
                            var A = [k].concat(P, M, p);
                            void 0 !== E && A.push(E);
                            var L = String(e.apply(void 0, A));
                        } else L = m(k, p, M, P, E, e);
                        M >= w && ((x += p.slice(w, M) + L), (w = M + k.length));
                    }
                    return x + p.slice(w);
                },
            ];
        ...
        t.exports = (function () {
            ...
            var t = 6e4,
                ...
                g = {
                    ...
                    p: function (t) {
                        return (
                            {M: u, y: l, w: c, d: i, D: f, h: a, m: o, s: r, ms: n, Q: s}[t] ||
                            String(t || '')
                                .toLowerCase()
                                .replace(/s$/, '')
                        );
                    ...
                    return (
                        ...
                        (v.startOf = function (t, e) {
                            var n = this,
                                ...
                                h = function (t, e) {
                                    return S.w(n.toDate()[t].apply(n.toDate('s'), (s ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), n);
                                },
                                m = this.$W,
                                v = this.$M,
                                g = this.$D,
                            ...
                            switch (p) {
                                ...
                                case u:
                                    return s ? d(1, v) : d(0, v + 1);
                                case c:
                                    var _ = this.$locale().weekStart || 0,
                                        b = (m < _ ? m + 7 : m) - _;
                                    return d(s ? g - b : g + (6 - b), v);
                                case i:
                                case f:
                                    return h(y + 'Hours', 0);
                                case a:
                        ...
                        (v.add = function (n, s) {
                            ...
                            if (d === i) return h(1);
                            if (d === c) return h(7);
                            var m = ((f = {}), (f[o] = t), (f[a] = e), (f[r] = 1e3), f)[d] || 1,
