!(function (t) {
    ...
    function (t, e, n) {
        ...
        (h && d) ||
            ...
            'process' == n(13)(f)
                ...
                : p
                ? ((i = (o = new p()).port2), (o.port1.onmessage = x), (r = a(i.postMessage, i, 1)))
    ...
    function (t, e, n) {
        ...
        var r = n(2),
            ...
            h = /\$([$&`']|\d\d?|<[^>]*>)/g,
            d = /\$([$&`']|\d\d?)/g;
        n(41)('replace', 2, function (t, e, n, p) {
            return [
                function (r, o) {
                    var i = t(this),
                        a = null == r ? void 0 : r[e];
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, p, v, m, y) {
            ...
            if (
                (j && (b = l(j.call(new t()))) !== Object.prototype && b.next && (s(b, S, !0), r || 'function' == typeof b[f] || a(b, f, d)),
                _ &&
                    M &&
                    'values' !== M.name &&
                    ((k = !0),
    ...
    function (t, e, n) {
        ...
        ((e = t.exports = function (t, e, n, f, h) {
            ...
            if (i(y)) {
                for (d = c(t.length); d > x; x++) if ((m = e ? g(a((p = t[x]))[0], p[1]) : g(t[x])) === s || m === l) return m;
                            ...
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (
                                                        ...
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    ...
                                                                    return t.abrupt('return');
                                                                case 2:
                                                                    return (t.next = 4), l.fetchHTMLFromFile(''.concat(f.path, '/html/f1/footer.html'));
                                                                case 4:
                                                            ...
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    return (
                                                                        ...
                                                                        (t.next = 3),
                                                                        l.fetchHTMLFromFile(''.concat(f.path, '/html/f1/mobile-hamburger-menu.html'))
                                                                    );
                                                                case 3:
                                                                    return (
                                                                        (r = t.sent),
                                                                        ...
                                                                        ).href = 'href="https://events.hotelsforhope.com/v6/support?siteId='.concat(
                                                                            document.querySelector('meta[name="siteId"]').content,
                                                                            '"'
                                                                        )),
                                                                        (t.next = 8),
                                                                        l.waitForSelectorInDOM('.navbar-hamburger')
                                                                    );
                                                                case 8:
                                                ...
                                                regeneratorRuntime.mark(function t() {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (t) {
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    return (t.next = 2), l.fetchHTMLFromFile(''.concat(f.path, '/html/f1/f1-header.html'));
                                                                case 2:
                                                                    if (
                                                                        ((r = t.sent),
                                        ...
                                        (t.next = 8),
                                        l.waitForSelectorInDOM('header')
                                    );
                                case 8:
                                    (e = document.querySelector('header')), (n = document.querySelector('#language')), r(siteId), i(siteId), c();
                                case 13:
                                case 'end':
                                    return t.stop();
                            }
            ...
            document
                ...
                (function (t, e) {
                    ...
                    Object.keys(t).forEach(function (r) {
                        d.checkForPastDate(t[r].race_expiry) ||
                            n.insertAdjacentHTML(
                                'beforeend',
                                '\n                <div class="race">\n                    <div class="race-info">\n                        <div class="date">\n                            <div class="days">'
                                    .concat(t[r].days, '</div>\n                            <div class="month">')
