    ...
    function (t, e, n) {
        for (
            ...
            var v,
                ...
                _ = i[y],
                b = _ && _.prototype;
            if (b && (b[l] || c(b, l, p), b[f] || c(b, f, y), (u[y] = p), g)) for (v in r) b[v] || a(b, v, r[v], !0);
        }
    },
    function (t, e) {
        t.exports = function (t, e) {
        ...
        var r,
            ...
            O = !!(function () {
                try {
                    ...
                    return (j || 'function' == typeof PromiseRejectionEvent) && t.then(E) instanceof e && 0 !== L.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
                } catch (t) {}
            })(),
            T = function (t) {
                var e;
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, h, m, v, y) {
            ...
            if (
                ...
                if (((g = {values: S ? P : x('values'), keys: v ? P : x('keys'), entries: j}), y)) for (_ in g) _ in M || a(M, _, g[_]);
        ...
        n(67)('replace', 2, function (t, e, n, h) {
            return [
                ...
                function (t, e) {
                    ...
                    for (var b, x = '', w = 0, S = 0; S < g.length; S++) {
                        _ = g[S];
                        for (var k = String(_[0]), M = s(l(i(_.index), p.length), 0), L = [], P = 1; P < _.length; P++) L.push(void 0 === (b = _[P]) ? b : String(b));
                        var j = _.groups;
                        if (d) {
                        ...
                        M >= w && ((x += p.slice(w, M) + A), (w = M + k.length));
                    }
                    return x + p.slice(w);
                },
            ];
