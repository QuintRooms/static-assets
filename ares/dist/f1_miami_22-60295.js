!(function (e) {
    ...
    function (e, t, n) {
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                ...
                                case 2:
                                    if (((t = window.localStorage), (n = t.getItem('active_item')))) {
                                        e.next = 6;
                                        break;
                                    }
                                    return e.abrupt('return');
                                case 6:
                                    document.querySelectorAll('.active').forEach(function (e) {
                                        ...
                                        console.log('active_class', n),
                                        (r = document.querySelector('.'.concat(n))).classList.add('active'),
                                        console.log('active_item.classList', r.classList);
                                case 12:
                                case 'end':
                                    return e.stop();
                            }
                ...
                regeneratorRuntime.mark(function e(t) {
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    (n = document.querySelector('.'.concat(t))), window.localStorage.setItem('active_item', t), (r = n.href), (window.location.href = r);
                                case 5:
                                case 'end':
                                    return e.stop();
                            }
        ...
        (0, o.default)(g.site_id, g.lodging.event_name, 'South Florida'),
            new _(),
            new a.default(),
            (function () {
                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                ...
                                                                case 2:
                                                                    document.querySelector(
                                                                        '.lucid-content'
                                                                    ).innerHTML = '<span style="text-align: center;">Look for the Exclusive Rate tag - these are the guaranteed lowest rates'.concat(
                                                                        t ? ' in  '.concat(t) : '',
                                                                        '!</span>'
                                                                    );
                                                                case 3:
