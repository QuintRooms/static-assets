                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                ...
                                                                case 2:
                                                                    document.querySelector(
                                                                        '.lucid-content'
                                                                    ).innerHTML = '<span style="text-align: center;">Look for <span class="exclusive-rate" style="margin-left: 2px; margin-right: 2px; position: static; font-size: 14px; font-weight: lighter;">Exclusive Rate</span> - these hotels have the guaranteed lowest rates'.concat(
                                                                        t ? ' in  '.concat(t) : '',
                                                                        '!</span>'
                                                                    );
                                                                case 3:
