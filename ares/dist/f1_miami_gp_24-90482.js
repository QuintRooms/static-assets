!(function (e) {
    ...
    function (e, t, n) {
        ...
        (0, a.default)(b.site_id, b.lodging.event_name, 'Miami FL', '#000'),
            new w(),
            new s.default(),
            (function () {
                            ...
                            ((e = a().mark(function e(t, n) {
                                return a().wrap(function (e) {
                                    for (;;)
                                        switch ((e.prev = e.next)) {
                                            case 0:
                                                return (e.next = 2), f.waitForSelectorInDOM(t);
                                            case 2:
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n) {
                            ...
                            return 52342 === n ||
                                ...
                                ? ((r = l(a, 'M/D/YYYY').format('M/D/YYYY')), (o = l(s, 'M/D/YYYY').format('M/D/YYYY')), {check_in_value: r, nights: (i = l(o).diff(l(r), 'days'))})
                                : 'mandarin' === e || 'tw_mandarin' === e
                                ? ((r = l(a, 'YYYY/M/D').format('YYYY/M/D')), (o = l(s, 'YYYY/M/D').format('YYYY/M/D')), {check_in_value: r, nights: (i = l(o).diff(l(r), 'days'))})
                                : ((r = l(a, 'D/M/YYYY').format('M/D/YYYY')),
                                  (o = l(s, 'D/M/YYYY').format('M/D/YYYY')),
                                  (i = l(o).diff(l(r), 'days')),
                                  (r = l(a, 'D/M/YYYY').format('D/M/YYYY')),
                                  (o = l(s, 'D/M/YYYY').format('D/M/YYYY')),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            this.appendParamsToURL(n, {
                                ...
                                currency: {key: 'currency', value: f.getMetaTagContent('currency') ? f.getMetaTagContent('currency') : 'USD'},
                                ...
                                memberToken: {key: 'memberToken', value: f.getMetaTagContent('memberToken')},
                            }),
                                'search-results' === this.page_name &&
                                    'lodging' === this.site_config.site_type.toLowerCase() &&
                                    this.appendParamsToURL(n, {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            document.querySelector('form#searchForm').addEventListener('submit', function (t) {
                                t.preventDefault();
                                var n = e.setDateFormat(f.getMetaTagContent('theme'), e.site_config.affiliate_id, e.site_config.site_id);
                                e.constructUrl(n);
                            });
                        },
                    },
