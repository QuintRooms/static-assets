!(function (e) {
    ...
    function (e, t, n) {
        ...
        var a = n(26),
            s = (function () {
                ...
                var t, n, r, s, c, u, l, d, h, p, f, m, y, v, g;
                return (
                    (t = e),
                    (n = [
                        {
                ...
                u = function (e, n, r) {
                    try {
                        var i = (function (e) {
                            ...
                            y = o || f.getFullYear(),
                            v = 0;
                        (o && !a) || (v = a > 0 ? a - 1 : f.getMonth());
                        var g = u || 0,
                            _ = l || 0,
                            b = d || 0,
                            w = h || 0;
                        return p ? new Date(Date.UTC(y, v, m, g, _, b, w + 60 * p.offset * 1e3)) : r ? new Date(Date.UTC(y, v, m, g, _, b, w)) : new Date(y, v, m, g, _, b, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, S = []; w < h.length; ) {
                            ...
                            var k,
                                x = c(g, f ? h : h.slice(w));
                            if (null === x || (k = d(s(g.lastIndex + (f ? 0 : w)), h.length)) === b) w = a(h, w, y);
                            else {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, f, m, y, v) {
            c(n, t, f);
            var g,
                _,
                b,
            ...
            if (
                (C && (b = l(C.call(new e()))) !== Object.prototype && b.next && (u(b, S, !0), r || 'function' == typeof b[d] || a(b, d, p)),
                k &&
                    q &&
                    'values' !== q.name &&
                    ((x = !0),
                ...
                if (((g = {values: k ? E : w('values'), keys: y ? E : w('keys'), entries: L}), v)) for (_ in g) _ in A || o(A, _, g[_]);
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, d, h) {
            ...
            if (o(v)) {
                for (p = s(e.length); p > _; _++) if ((y = t ? g(a((f = e[_]))[0], f[1]) : g(e[_])) === u || y === l) return y;
            } else for (m = v.call(e); !(f = m.next()).done; ) if ((y = i(m, g, f.value, t)) === u || y === l) return y;
        }).BREAK = u),
            (t.RETURN = l);
    },
    function (e, t, n) {
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                'french' === g && (this.site_config.dayjs_date_format = 'D/M/YYYY'),
                                    y.createHTML(
                        ...
                        (this._addToQueue = this._addToQueue.bind(this)),
                            ...
                            (this._store = function () {
                                if ('redis' === this.datastore || 'ioredis' === this.datastore || null != this.connection)
                                    return (r = v.load(t, this.redisStoreDefaults, {})), new f(this, i, r);
    ...
    function (e, t, n) {
            ...
            _ = (function (e) {
                ...
                function n() {
                    ...
                    return (
                        ...
                        m(((e = f((r = t.call(this, g)))), y(n.prototype)), 'init', e).call(e),
                        r
                    );
                }
                return n;
                ...
                regeneratorRuntime.mark(function e() {
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (e.next = 2), v.waitForSelectorInDOM('.f1-policy');
                                case 2:
                                    document
        ...
        (0, o.default)(g.site_id, g.lodging.event_name, 'Montreal CA', '#000'),
            new _(),
            new a.default(),
            (function () {
                b.apply(this, arguments);
            })();
        var w = v.getMetaTagContent('theme');
        function S() {
            return (S = u(
                regeneratorRuntime.mark(function e() {
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (e.next = 2), v.waitForSelectorInDOM('.translateMe');
                                case 2:
                                    'french' === w ? v.updateHTML('.translateMe', 'Modifier La Recherche') : v.updateHTML('.translateMe', 'Update Search');
                                case 3:
                                case 'end':
                                    return e.stop();
                            }
                ...
                regeneratorRuntime.mark(function e() {
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    return (e.next = 2), v.waitForSelectorInDOM('.span.open-modal');
                                case 2:
                                    document.querySelector('#policies-fees').addEventListener('click', function (e) {
                                        document.querySelector('span.open-modal').click();
                                    });
