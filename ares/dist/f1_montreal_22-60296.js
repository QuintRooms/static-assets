!(function (e) {
                                ...
                                switch ((e.prev = e.next)) {
                                                            ...
                                                            for (;;)
                                                                switch ((e.prev = e.next)) {
                                                                    ...
                                                                    case 2:
                                                                        (n = 'in'),
                                                                            60301 === t && (n = 'near'),
                                                                            (s = document.querySelector('#language-label span').innerText),
                                                                            ...
                                                                            (o = function (e) {
                                                                                null !== l &&
                                                                                    (e.matches
                                                                                        ...
                                                                                        : (document.querySelector('#tickets .language').insertAdjacentElement('afterbegin', l),
                                    ...
                                    case 10:
                                        (s = document.querySelector('header')),
                                            (l = document.querySelector('#language')),
                                                                                                    ...
                                                                                                    switch ((t.prev = t.next)) {
                                                                                                        ...
                                                                                                        case 3:
                                                                                                            return (
                                                                                                                ...
                                                                                                                'English' ===
                                                                                                                    document.querySelector('#language-label span').innerText &&
                                                                                                        ...
                                                                                                        case 31:
                                                                                                            ...
                                                                                                            return (t.next = 35), _.waitForSelectorInDOM('#ArnPropertyMap');
                                                                                                        case 35:
                                                                                                            document.querySelector('.leaflet-control-scale-line') ||
                                                                                                                L.control.scale().addTo(window.ArnMap),
                                                                                                                e.useLogoForVenueMapMarker(),
        ...
        /*! no static exports found */ function (e, t, n) {
            ...
            e.exports = function (e, t, n, p, f, _, y) {
                ...
                if (
                    ...
                    if (((g = {values: k ? q : j('values'), keys: _ ? q : j('keys'), entries: E}), y)) for (v in g) v in x || s(x, v, g[v]);
            ...
            var r,
                ...
                P = !!(function () {
                    try {
                        ...
                        return (E || 'function' == typeof PromiseRejectionEvent) && e.then(L) instanceof t && 0 !== A.indexOf('6.6') && -1 === j.indexOf('Chrome/66');
                    } catch (e) {}
                })(),
                R = function (e) {
                    var t;
                ...
                I = function (e) {
                    y.call(c, function () {
                        var t;
                        E ? S.emit('rejectionHandled', e) : (t = c.onrejectionhandled) && t({promise: e, reason: e._v});
                    });
                },
                D = function (e) {
                    var t = this;
                ...
                return [
                    ...
                    function (e, t) {
                        ...
                        for (var b, j = '', w = 0, k = 0; k < g.length; k++) {
                            v = g[k];
                            for (var S = String(v[0]), x = u(l(i(v.index), m.length), 0), A = [], q = 1; q < v.length; q++) A.push(void 0 === (b = v[q]) ? b : String(b));
                            var E = v.groups;
                            if (h) {
                                var L = [S].concat(A, x, m);
                                void 0 !== E && L.push(E);
                                var C = String(t.apply(void 0, L));
                            } else C = f(S, m, x, A, E, t);
                            x >= w && ((j += m.slice(w, x) + C), (w = x + S.length));
                        }
                        return j + m.slice(w);
                    },
                ];
  ...
  \****************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var r = n(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                E = n(/*! ./_object-dp */ './node_modules/core-js/modules/_object-dp.js'),
            ...
            for (var te = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), ne = 0; te.length > ne; )
                h(te[ne++]);
            for (var re = L(h.store), oe = 0; re.length > oe; ) f(re[oe++]);
            i(i.S + i.F * !U, 'Symbol', {
                for: function (e) {
            ...
            i(i.S + i.F * se, 'Object', {
                ...
                M.prototype[D] || n(/*! ./_hide */ './node_modules/core-js/modules/_hide.js')(M.prototype, D, M.prototype.valueOf),
                d(M, 'Symbol'),
                d(Math, 'Math', !0),
                d(r.JSON, 'JSON', !0);
        },
  ...
  \*******************************************************/
        /*! no static exports found */ function (e, t, n) {
            ...
            var w = document.querySelector('#language-label span').innerText;
            function k() {
                return (k = u(
                    regeneratorRuntime.mark(function e() {
                        return regeneratorRuntime.wrap(function (e) {
                            for (;;)
                                switch ((e.prev = e.next)) {
                                    ...
                                    case 2:
                                        'Français' === w ? y.updateHTML('.translateMe', 'Modifier La Recherche') : y.updateHTML('.translateMe', 'Update Search');
                                    case 3:
                                    case 'end':
                                        return e.stop();
                                }
                                ...
                                switch ((e.prev = e.next)) {
                                    ...
                                    case 2:
                                        'Français' === w
                                            ? y.updateHTML(
                                                  'span.confirmationAgreement',
                                                  'En cochant cette case, j\'accepte les <span id="policies-fees">Politiques Et Frais</span> ci-dessus et les <a id="t-and-cs" target="_blank" href="https://events.'.concat(
                                                      g,
                                            ...
                                            : y.updateHTML(
                                                  'span.confirmationAgreement',
                                                  'By checking this box I agree to the <span id="policies-fees">Policies & Fees</span> above and the <a id="t-and-cs" target="_blank" href="https://events.'.concat(
                                                      g,
