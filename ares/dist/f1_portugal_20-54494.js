!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            X = function (e) {
                for (var t, n = P(w(e)), r = [], o = 0; n.length > o; ) i(Y, (t = n[o++])) || t == I || t == c || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = P(n ? B : w(e)), o = [], s = 0; r.length > s; ) !i(Y, (t = r[s++])) || (n && !i(N, t)) || o.push(Y[t]);
                return o;
            };
        $ ||
            (a(
    ...
    function (e, t, n) {
        ...
        var y = new (function () {
                return {
                    ...
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(s, '/img/logo.png'), logo_outbound_url: 'https://autodromodoalgarve.com/'},
