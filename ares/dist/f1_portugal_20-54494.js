!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var k = String(b[0]), A = u(l(a(b.index), d.length), 0), L = [], M = 1; M < b.length; M++) L.push(void 0 === (S = b[M]) ? S : String(S));
                        var q = b.groups;
                        if (h) {
                            var E = [k].concat(L, A, d);
                            void 0 !== q && E.push(q);
                            var C = String(t.apply(void 0, E));
                        } else C = m(k, d, A, L, q, t);
                                                                ...
                                                                case 9:
                                                                    'cug' === e.site_config.site_type &&
                                                                        ...
                                                                        document.querySelector('.RootBody') &&
                                                                            (N.init(e.site_config, e.page_name, B),
                                                                        ...
                                                                        'search-results' === e.page_name && N.init(e.site_config, e.page_name, B),
                                                                        jQuery('#theBody').on(
                                                                            'arnMapLoadedEvent',
                                                                            H(
                                                                                                ...
                                                                                                switch ((t.prev = t.next)) {
                                                                                                    ...
                                                                                                    case 3:
                                                                                                        return (
                                                                                                            ...
                                                                                                            B.updateHTML('.ArnSortBy', '<div class="sort">Sort</div>'),
                                                                                                    ...
                                                                                                    case 34:
                                                                                                        ...
                                                                                                        return (t.next = 38), B.waitForSelectorInDOM('#ArnPropertyMap');
                                                                                                    case 38:
                                                                                                        document.querySelector('.leaflet-control-scale-line') ||
                                                                                                            L.control.scale().addTo(window.ArnMap),
                                                                                                            e.useLogoForVenueMapMarker(),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                o &&
                                    ...
                                    B.createHTML('<span class="date-container">'.concat(e, ' - ').concat(n), '#theHotelAddress', 'beforeBegin'),
                                                        ...
                                                        return (
                                                            ...
                                                            (n = function (e) {
                                                                ...
                                                                t.insertAdjacentElement('beforeEnd', n),
                                                                    B.createDropdownMenu('#currency-label', t, '.currency-content', '.dropdown');
                                                            }),
                                                            (r = function () {
    ...
    function (e, t, n) {
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                                        ...
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    ...
                                                                    return e.abrupt('return');
                                                                case 2:
                                                                    return (e.next = 4), u.fetchHTMLFromFile(''.concat(l.path, '/html/f1/footer.html'));
                                                                case 4:
                                                            ...
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (
                                                                        ...
                                                                        (e.next = 3),
                                                                        u.fetchHTMLFromFile(''.concat(l.path, '/html/f1/mobile-hamburger-menu.html'))
                                                                    );
                                                                case 3:
                                                                    return (
                                                                        (o = e.sent),
                                                ...
                                                regeneratorRuntime.mark(function e(t) {
                                                    ...
                                                    return regeneratorRuntime.wrap(function (e) {
                                                        for (;;)
                                                            switch ((e.prev = e.next)) {
                                                                case 0:
                                                                    return (e.next = 2), u.fetchHTMLFromFile(''.concat(l.path, '/html/f1/f1-header.html'));
                                                                case 2:
                                                                    if (
                                                                        ((o = e.sent),
                                ...
                                case 8:
                                    (n = document.querySelector('header')), (r = document.querySelector('#language')), o(t), a(t), f();
                                case 13:
                                case 'end':
                                    return e.stop();
                            }
        ...
        n(34), n(21), n(125), n(67), n(68), n(66), n(46);
                                                        ...
                                                        return regeneratorRuntime.wrap(function (n) {
                                                            for (;;)
                                                                switch ((n.prev = n.next)) {
                                                                    ...
                                                                    case 2:
                                                                        return ((r = new m()).params = []), (n.next = 6), r.getPropertyLatLong();
                                                                    case 6:
            ...
            x = (function (e) {
                function t() {
                    ...
                    return (
                        ...
                        })(this, w(t).call(this, _))),
                        S(w(t.prototype), 'init', v(e)).call(v(e)),
                        e
                    );
                }
                return (
