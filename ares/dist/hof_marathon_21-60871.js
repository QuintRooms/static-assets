!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(65),
            o = new (n(13).a)(),
            i = 'hof_marathon_21-'.concat(60871);
        function a(e) {
            return (a =
        ...
        var d = new (function () {
            return {
                ...
                lodging: {event_id: 42001, event_name: 'Pro Football Hall of Fame Marathon', event_dates: '05/01/2021 - 05/02/2021', is_lrg: !1},
                ...
                banner_image_url: 'linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)), url('
                    ...
                    .concat(i, '/img/banner2.jpg) no-repeat center center /cover'),
...
//# sourceMappingURL=hof_marathon_21-60871.map
