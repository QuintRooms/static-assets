!(function (e) {
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (r) {
                                    ...
                                    'standard' === o.getMetaTagContent('theme')
                                        ...
                                        w({
                                            ...
                                            optionalHotel: {key: 'hotelname', value: _()},
                                        }),
                                        'search-results' === t &&
        ...
        /*! no static exports found */ function (e, t, o) {
            var n = o(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                a = function (e, t, o) {
                    ...
                    for (u in (p && (o = t), o))
                        (d = ((l = !f && g && void 0 !== g[u]) ? g : o)[u]),
                            (m = _ && l ? c(d, n) : y && 'function' == typeof d ? c(Function.call, d) : d),
                            g && i(g, u, d, e & a.U),
                            v[u] != d && s(v, u, m),
                            y && j[u] != d && (j[u] = d);
                };
  ...
  \*************************************************/
        /*! no static exports found */ function (e, t, o) {
            ...
            ((t = e.exports = function (e, t, o, d, m) {
                ...
                if (s(_)) {
                    for (f = c(e.length); f > v; v++) if ((y = t ? g(i((p = e[v]))[0], p[1]) : g(e[v])) === u || y === l) return y;
                } else for (h = _.call(e); !(p = h.next()).done; ) if ((y = r(h, g, p.value, t)) === u || y === l) return y;
            }).BREAK = u),
                (t.RETURN = l);
        },
  ...
  \******************************************************/
        /*! no static exports found */ function (e, t, o) {
            ...
            e.exports = function (e, t, o, p, h, y, _) {
                a(o, t, p);
                var g,
                    v,
                    j,
                ...
                if (
                    ...
                    if (((g = {values: S ? L : b('values'), keys: y ? L : b('keys'), entries: M}), _)) for (v in g) v in k || s(k, v, g[v]);
                    else r(r.P + r.F * (m || x), t, g);
                return g;
            };
        },
  ...
  \*****************************************************/
        /*! no static exports found */ function (e, t, o) {
            ...
            var n,
                ...
                _ = o(/*! ./_task */ './node_modules/core-js/modules/_task.js').set,
                ...
                return [
                    ...
                    function (e, t) {
                        ...
                        for (var g = []; ; ) {
                            ...
                            if (null === v) break;
                            if ((g.push(v), !y)) break;
                            '' === String(v[0]) && (d.lastIndex = c(m, s(d.lastIndex), _));
                        }
                        for (var j, b = '', w = 0, S = 0; S < g.length; S++) {
                            v = g[S];
                    ...
                    [
                        ...
                        function (e, t) {
                            ...
                            var u = r(e),
                                ...
                                g = new f(p ? u : '^(?:' + u.source + ')', _),
                                v = void 0 === t ? 4294967295 : t >>> 0;
                            if (0 === v) return [];
                            if (0 === m.length) return null === a(g, m) ? [m] : [];
                            for (var j = 0, b = 0, w = []; b < m.length; ) {
                                g.lastIndex = p ? b : 0;
                                var S,
                                    x = a(g, p ? m : m.slice(b));
                                if (null === x || (S = d(c(g.lastIndex + (p ? 0 : b)), m.length)) === j) b = i(m, b, y);
                                else {
  ...
  \****************************************************/
        /*! no static exports found */ function (e, t, o) {
            ...
            var n = o(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                _ = o(/*! ./_is-array */ './node_modules/core-js/modules/_is-array.js'),
                g = o(/*! ./_an-object */ './node_modules/core-js/modules/_an-object.js'),
                ...
                Z = function (e, t, o) {
                    return (
                        ...
                        g(o),
                        r(I, t)
                            ? (o.enumerable ? (r(e, H) && e[H][t] && (e[H][t] = !1), (o = x(o, {enumerable: S(0, !1)}))) : (r(e, H) || C(e, H, S(1, {})), (e[H][t] = !0)),
                              G(e, t, o))
                            : C(e, t, o)
                    );
                },
                ...
                Q = function (e) {
                    ...
                    return !(this === $ && r(I, e) && !r(N, e)) && (!(t || !r(this, e) || !r(I, e) || (r(this, H) && this[H][e])) || t);
                },
                K = function (e, t) {
                    if (((e = b(e)), (t = w(t, !0)), e !== $ || !r(I, t) || r(N, t))) {
                        var o = q(e, t);
                        return !o || !r(I, t) || (r(e, H) && e[H][t]) || (o.enumerable = !0), o;
                    }
                },
                X = function (e) {
                    for (var t, o = T(b(e)), n = [], s = 0; o.length > s; ) r(I, (t = o[s++])) || t == H || t == a || n.push(t);
                    return n;
                },
                ee = function (e) {
                    for (var t, o = e === $, n = T(o ? N : b(e)), s = [], i = 0; n.length > i; ) !r(I, (t = n[i++])) || (o && !r($, t)) || s.push(I[t]);
                    return s;
                };
            Y ||
                (c(
                    (P = function () {
                        ...
                        var e = m(arguments.length > 0 ? arguments[0] : void 0),
                            t = function (o) {
                                this === $ && t.call(N, o), r(this, H) && r(this[H], e) && (this[H][e] = !1), G(this, e, S(1, o));
                            };
                ...
                (L.f = ee),
                s && !o(/*! ./_library */ './node_modules/core-js/modules/_library.js') && c($, 'propertyIsEnumerable', Q, !0),
                (p.f = function (e) {
                    return z(f(e));
                })),
        ...
        /*! no static exports found */ function (e, t, o) {
            for (
                ...
                var y,
                    ...
                    v = i[_],
                    j = v && v.prototype;
                if (j && (j[l] || c(j, l, m), j[d] || c(j, d, _), (a[_] = m), g)) for (y in n) j[y] || s(j, y, n[y], !0);
            }
        },
                    ...
                    u = function (e, o, n) {
                        try {
                            var r = (function (e) {
                                ...
                                y = s || p.getFullYear(),
                                _ = 0;
                            (s && !i) || (_ = i > 0 ? i - 1 : p.getMonth());
                            var g = u || 0,
                                v = l || 0,
                                j = d || 0,
                                b = m || 0;
                            return f ? new Date(Date.UTC(y, _, h, g, v, j, b + 60 * f.offset * 1e3)) : n ? new Date(Date.UTC(y, _, h, g, v, j, b)) : new Date(y, _, h, g, v, j, b);
                        } catch (e) {
                            return new Date('');
                        }
                    };
  ...
  \*****************************************************/
        /*! no static exports found */ function (e, t, o) {
            var n = (function (e) {
                ...
                var _ = (f.prototype = d.prototype = Object.create(p));
                function g(e) {
                ...
                return (
                    ...
                    (e.mark = function (e) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(e, f) : ((e.__proto__ = f), c(e, i, 'GeneratorFunction')), (e.prototype = Object.create(_)), e;
                    }),
                    (e.awrap = function (e) {
                        return {__await: e};
                    }),
  ...
  \*******************************************************/
        /*! no exports provided */ function (e, t, o) {
            ...
            var d = new (o(/*! ./63711-config */ './site_configs/hof_points_cug-63711/js/63711-config.js').default)();
            new ((function (e) {
                !(function (e, t) {
