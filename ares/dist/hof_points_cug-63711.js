!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        ...
                        var C = b.groups;
                        if (p) {
                            var L = [A].concat(q, k, f);
                            void 0 !== C && L.push(C);
                            var T = String(t.apply(void 0, L));
                        } else T = m(A, f, k, q, C, t);
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: x ? M : w('values'), keys: y ? M : w('keys'), entries: C}), g)) for (b in v) b in k || a(k, b, v[b]);
    ...
    function (e, t, n) {
        'use strict';
        n(73), n(74), n(17), n(37), n(12), n(75), n(76), n(50), n(18);
        var r = a(n(333)),
            o = a(n(139));
        function a(e) {
            return e && e.__esModule ? e : {default: e};
