    ...
    function (e, t, n) {
        ...
        var te = new (function () {
            return {
                ...
                banner_image_url: 'linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)), url('.concat(V.path, '/site_configs/').concat(Z, '/img/banner.jpg) no-repeat center center'),
...
//# sourceMappingURL=hof_retail-60037.map
