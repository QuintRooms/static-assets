    ...
    function (e, t, n) {
        ...
        var d = new (function () {
            return {
                ...
                show_date_prompt: !1,
                fav_icon_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo.png'),
                has_custom_styles: !1,
                custom_styles_url: '',
                ...
                map_marker_image_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo.png'),
                theme: 'dark',
