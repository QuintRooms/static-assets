!(function (e) {
    ...
    function (e, t, n) {
        for (
            ...
            var y,
                ...
                S = a[v],
                b = S && S.prototype;
            if (b && (b[l] || c(b, l, d), b[f] || c(b, f, v), (s[v] = d), g)) for (y in r) b[y] || i(b, y, r[y], !0);
        }
    },
    function (e, t, n) {
        'use strict';
                ...
                return (
                    ...
                    (d.startOf = function (e, c) {
                        var u = this,
                            ...
                            f = S.p(e),
                            d = function (e, t) {
                                var n = S.w(u.$u ? Date.UTC(u.$y, t, e) : new Date(u.$y, t, e), u);
                                return l ? n : n.endOf(o);
                            },
                            h = function (e, t) {
                                return S.w(u.toDate()[e].apply(u.toDate('s'), (l ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(t)), u);
                            },
                            p = this.$W,
                            m = this.$M,
                            y = this.$D,
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var g = []; ; ) {
                        ...
                        if (null === S) break;
                        if ((g.push(S), !y)) break;
                        '' === String(S[0]) && (f.lastIndex = c(d, i(f.lastIndex), v));
                    }
                    for (var b, w = '', _ = 0, x = 0; x < g.length; x++) {
                        S = g[x];
    ...
    function (e, t, n) {
        'use strict';
        n(35), n(89), n(91), n(37), n(29), n(38), n(95), n(59), n(99), n(60), n(102), n(103), n(106), n(42);
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: 'calculateNights',
                            value: function () {
                                var e = C(document.querySelector('input#theCheckIn').value).format('MM/DD/YYYY'),
                                    t = C(document.querySelector('input#theCheckOut').value).format('MM/DD/YYYY');
                                return C(t).diff(C(e), 'days');
                            },
                        },
                        {
                            key: 'matchMediaQuery',
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                var t = C();
                                return C(e).diff(t, 'milliseconds') < 0;
                            },
                        },
                    ]) && q(t.prototype, n),
                    r && q(t, r),
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                    ...
                                    'standard' === n.getMetaTagContent('theme')
                                        ? ((u = j(document.querySelector('input#theCheckIn').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                          (f = j(document.querySelector('input#theCheckOut').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                          (d = j(f).diff(j(u), 'days')))
                                        ...
                                        ? ((u = j(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                          (f = j(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                          (d = j(f).diff(j(u), 'days')),
                                          (u = j(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('YYYY/M/D')),
                                          (f = j(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('YYYY/M/D')))
                                        : ((u = j(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                          (f = j(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                          (d = j(f).diff(j(u), 'days')),
                                          (u = j(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('D/M/YYYY')),
                                          (f = j(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('D/M/YYYY'))),
                                        'standard' !== n.getMetaTagContent('theme') &&
                                                                                            ...
                                                                                            for (;;)
                                                                                                switch ((t.prev = t.next)) {
                                                                                                    ...
                                                                                                    case 33:
                                                                                                        ...
                                                                                                        return (t.next = 37), W.waitForSelectorInDOM('#ArnPropertyMap');
                                                                                                    case 37:
                                                                                                        document.querySelector('.leaflet-control-scale-line') ||
                                                                                                            L.control.scale().addTo(window.ArnMap),
                                                                                                            e.useLogoForVenueMapMarker(),
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, f, d) {
            ...
            if (i(v)) {
                for (h = c(e.length); h > S; S++) if ((y = t ? g(a((p = e[S]))[0], p[1]) : g(e[S])) === u || y === l) return y;
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, v) {
            ...
            if (
                (q && (b = l(q.call(new e()))) !== Object.prototype && b.next && (u(b, _, !0), r || 'function' == typeof b[f] || a(b, f, h)),
                x &&
                    L &&
                    'values' !== L.name &&
                    ((A = !0),
                ...
                if (((g = {values: x ? M : w('values'), keys: y ? M : w('keys'), entries: E}), v)) for (S in g) S in k || i(k, S, g[S]);
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, _ = []; w < d.length; ) {
                            ...
                            var x,
                                A = s(g, p ? d : d.slice(w));
                            if (null === A || (x = f(c(g.lastIndex + (p ? 0 : w)), d.length)) === b) w = a(d, w, y);
                            else {
                ...
                s = function (e, n, r) {
                    try {
                        ...
                        var g = u || 0,
                            ...
                            b = f || 0,
                            w = d || 0;
                        return h ? new Date(Date.UTC(y, v, m, g, S, b, w + 60 * h.offset * 1e3)) : r ? new Date(Date.UTC(y, v, m, g, S, b, w)) : new Date(y, v, m, g, S, b, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
    ...
    function (e, t, n) {
        ...
        var d = new (function () {
            return {
                ...
                fav_icon_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'),
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://www.profootballhof.com/'},
                map_marker_image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'),
                theme: 'dark',
        ...
        new ((function (e) {
            function t() {
                ...
                return (
                    ...
                    })(this, f(t).call(this, d))),
                    l(f(t.prototype), 'init', s(e)).call(s(e)),
                    e
                );
            }
            return (
