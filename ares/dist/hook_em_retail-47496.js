        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    cug: {is_cug: !0, show_points: !1, allow_registration: !0, percent_off_text: 'off', show_percent_savings: !1},
                    ...
                    show_date_prompt: !1,
                    has_social_sharing: !1,
                    fav_icon_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/favicon.png'),
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo.png'), logo_outbound_url: ''},
