!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var A = String(b[0]), k = u(l(a(b.index), f.length), 0), M = [], q = 1; q < b.length; q++) M.push(void 0 === (S = b[q]) ? S : String(S));
                        var L = b.groups;
                        if (p) {
                            var C = [A].concat(M, k, f);
                            void 0 !== L && C.push(L);
                            var T = String(t.apply(void 0, C));
                        } else T = m(A, f, k, M, L, t);
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: x ? q : w('values'), keys: y ? q : w('keys'), entries: L}), g)) for (b in v) b in k || i(k, b, v[b]);
    ...
    function (e, t, n) {
        'use strict';
        n(73), n(74), n(33), n(17), n(75), n(76), n(70);
        var r = i(n(271)),
            o = i(n(139));
        function i(e) {
            return e && e.__esModule ? e : {default: e};
