!(function (e) {
  ...
  \***********************/
        /*! exports provided: default */ function (e, t, o) {
            ...
            o(/*! core-js/modules/es7.symbol.async-iterator */ './node_modules/core-js/modules/es7.symbol.async-iterator.js'),
                ...
                o(/*! core-js/modules/es6.regexp.replace */ './node_modules/core-js/modules/es6.regexp.replace.js'),
                o(/*! regenerator-runtime/runtime */ './node_modules/regenerator-runtime/runtime.js');
            var n = o(/*! ./build */ './js/build.js'),
                r = o(/*! ./utilities */ './js/utilities.js'),
                s = o(/*! ./path */ './js/path.js');
            function i(e) {
                return (i =
        ...
        /*! no static exports found */ function (e, t, o) {
            ...
            e.exports = function (e, t, o, p, h, y, g) {
                ...
                if (
                    ...
                    if (((v = {values: w ? q : b('values'), keys: y ? q : b('keys'), entries: M}), g)) for (_ in v) _ in A || s(A, _, v[_]);
            ...
            var n,
                ...
                T = !!(function () {
                    try {
                        ...
                        return (M || 'function' == typeof PromiseRejectionEvent) && e.then(L) instanceof t && 0 !== k.indexOf('6.6') && -1 === b.indexOf('Chrome/66');
                    } catch (e) {}
                })(),
                E = function (e) {
                    var t;
                ...
                return [
                    ...
                    function (e, t) {
                        ...
                        for (var j, b = '', S = 0, w = 0; w < v.length; w++) {
                            _ = v[w];
                            for (var x = String(_[0]), A = u(l(i(_.index), m.length), 0), k = [], q = 1; q < _.length; q++) k.push(void 0 === (j = _[q]) ? j : String(j));
                            var M = _.groups;
                            if (f) {
                                var L = [x].concat(k, A, m);
                                void 0 !== M && L.push(M);
            ...
            var n = o(/*! ./_global */ './node_modules/core-js/modules/_global.js'),
                ...
                K = function (e, t) {
                    if (((e = b(e)), (t = S(t, !0)), e !== N || !r(I, t) || r(Y, t))) {
                        var o = C(e, t);
                        return !o || !r(I, t) || (r(e, H) && e[H][t]) || (o.enumerable = !0), o;
                    }
                },
                X = function (e) {
                    for (var t, o = E(b(e)), n = [], s = 0; o.length > s; ) r(I, (t = o[s++])) || t == H || t == c || n.push(t);
                    return n;
                },
                ee = function (e) {
                ...
                (a(
                    (P = function () {
                        ...
                        var e = m(arguments.length > 0 ? arguments[0] : void 0),
                            t = function (o) {
                                this === N && t.call(Y, o), r(this, H) && r(this[H], e) && (this[H][e] = !1), G(this, e, w(1, o));
                            };
  ...
  \*******************************************************************/
        /*! exports provided: default */ function (e, t, o) {
            ...
            var n = o(/*! ../../../js/path */ './js/path.js'),
                r = new (o.n(n).a)(),
                s = 'resbeat_points_demo-'.concat(62725);
            function i() {
                return {
                    site_id: 62725,
                    directory_name: s,
                    ...
                    header: {logo_file_location: ''.concat(r.path, '/site_configs/').concat(s, '/img/logo.svg'), logo_outbound_url: 'https://hotels.resbeat.com'},
  ...
  \************************************************************/
        /*! no exports provided */ function (e, t, o) {
            ...
            o(/*! core-js/modules/es7.symbol.async-iterator */ './node_modules/core-js/modules/es7.symbol.async-iterator.js'),
                ...
                o(/*! regenerator-runtime/runtime */ './node_modules/regenerator-runtime/runtime.js'),
                o(/*! core-js/modules/es6.regexp.split */ './node_modules/core-js/modules/es6.regexp.split.js');
            var n = o(/*! ./62725-config */ './site_configs/resbeat_points_demo-62725/js/62725-config.js'),
                r = o(/*! ../../../js/resbeat */ './js/resbeat.js');
            function s(e) {
                return (s =
                    'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                        ? function (e) {
            ...
            var h = new (o(/*! ../../../js/utilities */ './js/utilities.js').default)(),
                y = new n.default();
            new ((function (e) {
                !(function (e, t) {
                    if ('function' != typeof t && null !== t) throw new TypeError('Super expression must either be null or a function');
                ...
                function d() {
                    ...
                    return (
                        ...
                        f(((e = m((t = i.call(this, y)))), p(d.prototype)), 'init', e).call(e),
                        t.init(),
                        t
                    );
                }
                                    ...
                                    regeneratorRuntime.mark(function e() {
                                        ...
                                        return regeneratorRuntime.wrap(function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (e.next = 2), h.waitForSelectorInDOM('.subHeaderContainer');
                                                    case 2:
                                                    ...
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            if (
                                                                    ...
                                                                    document.querySelector('.SearchHotels') && (e = document.querySelectorAll('.ArnProperty')),
                                                                        ...
                                                                        e.forEach(function (e, t) {
                                                                            var o = e.querySelector('.originalPrice'),
                                                                                n = '';
                                                                            if (
                                                                                (document.querySelector('.SearchHotels') && (n = e.querySelector('.ArnRateCell')),
                                                                                document.querySelector('.SinglePropDetail') && (n = e.querySelector('.bookRoomCell')),
                                                                                o && !e.querySelector('.points-applied'))
                                                                            ) {
                                                                                var r = o.getAttribute('amount').replace(/[^0-9.]/g, '');
                                                                                n.insertAdjacentHTML(
                                                                                    'afterBegin',
                                                                ...
                                                                (t = function () {
                                                                    var e = h.getMetaTagContent('memberMetaTag');
                                                                    if (e) {
                                                            ...
                                                            return e.abrupt('return');
                                                        case 5:
                                                            return (e.next = 7), h.waitForSelectorInDOM('header');
                                                        case 7:
                                                            t(),
                                                                n(),
                                                                document.querySelector('.SinglePropDetail') && o(),
                                                                document.querySelector('.SearchHotels') &&
                                                                    jQuery(document).on('ratesReadyEvent', function () {
                                                                        setTimeout(function () {
                                                                            o();
  ...
  \**********************/
        /*! no exports provided */ function (e, t, o) {
            'use strict';
            o.r(t);
            o(/*! ../site_configs/resbeat_points_demo-62725/js/62725 */ './site_configs/resbeat_points_demo-62725/js/62725.js'),
                o(/*! ../site_configs/resbeat_points_demo-62725/styles/62725.scss */ './site_configs/resbeat_points_demo-62725/styles/62725.scss');
        },
});
