!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r,
            ...
            H = function (e) {
                g.call(s, function () {
                    var t;
                    M ? A.emit('rejectionHandled', e) : (t = s.onrejectionhandled) && t({promise: e, reason: e._v});
                });
            },
            F = function (e) {
                var t = this;
    ...
    function (e, t, n) {
        ...
        })('versions', []).push({version: r.version, mode: n(18) ? 'pure' : 'global', copyright: '© 2019 Denis Pushkarev (zloirock.ru)'});
    },
    function (e, t) {
        e.exports = function (e, t) {
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            Q = function (e) {
                ...
                return !(this === U && o(D, e) && !o(N, e)) && (!(t || !o(this, e) || !o(D, e) || (o(this, H) && this[H][e])) || t);
            },
            K = function (e, t) {
            ...
            X = function (e) {
                for (var t, n = R(w(e)), r = [], i = 0; n.length > i; ) o(D, (t = n[i++])) || t == H || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === U, r = R(n ? N : w(e)), i = [], a = 0; r.length > a; ) !o(D, (t = r[a++])) || (n && !o(U, t)) || i.push(D[t]);
                return i;
            };
        Y ||
            (c(
                (P = function () {
                    ...
                    var e = f(arguments.length > 0 ? arguments[0] : void 0),
                        t = function (n) {
                            this === U && t.call(N, n), o(this, H) && o(this[H], e) && (this[H][e] = !1), G(this, e, _(1, n));
                        };
                    return i && W && G(U, e, {configurable: !0, set: t}), V(e);
                }).prototype,
                'toString',
                function () {
                    return this._k;
            ...
            (n(31).f = Q),
            (q.f = ee),
            i && !n(18) && c(U, 'propertyIsEnumerable', Q, !0),
            (h.f = function (e) {
                return V(p(e));
            })),
        ...
        a(a.S + a.F * ie, 'Object', {
            ...
            P.prototype[F] || n(9)(P.prototype, F, P.prototype.valueOf),
            d(P, 'Symbol'),
            d(Math, 'Math', !0),
            d(r.JSON, 'JSON', !0);
    },
    ...
    function (e, t, n) {
        n(4) && 'g' != /./g.flags && n(6).f(RegExp.prototype, 'flags', {configurable: !0, get: n(43)});
    },
    function (e, t, n) {
        'use strict';
        var r = n(14),
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: _ ? q : w('values'), keys: y ? q : w('keys'), entries: M}), g)) for (b in v) b in k || i(k, b, v[b]);
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(47), n(51), n(21), n(42), n(62), n(63), n(34), n(35), n(23), n(24), n(67), n(25), n(68);
        var r = n(11),
            o = n.n(r),
            i = new o.a(),
            a = 'resbeat_squad_test-'.concat(62686);
        n(70), n(71), n(104), n(72), n(106);
        var c = ('undefined' != typeof globalThis && globalThis) || ('undefined' != typeof self && self) || (void 0 !== c && c),
            s = 'URLSearchParams' in c,
            u = 'Symbol' in c && 'iterator' in Symbol,
            l =
                'FileReader' in c &&
                'Blob' in c &&
                (function () {
                    ...
                    (this.bodyUsed = this.bodyUsed),
                        ...
                        e
                            ? 'string' == typeof e
                                ...
                                : f && l && (t = e) && DataView.prototype.isPrototypeOf(t)
                                ? ((this._bodyArrayBuffer = x(e.buffer)), (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                                : f && (ArrayBuffer.prototype.isPrototypeOf(e) || h(e))
                        ...
                        this.headers.get('content-type') ||
                            ('string' == typeof e
                                ...
                                : s && URLSearchParams.prototype.isPrototypeOf(e) && this.headers.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'));
                }),
                l &&
                    ((this.blob = function () {
                        var e = b(this);
        ...
        (k.prototype.clone = function () {
            ...
            (M.prototype.clone = function () {
                return new M(this._bodyInit, {status: this.status, statusText: this.statusText, headers: new v(this.headers), url: this.url});
            }),
            (M.error = function () {
            ...
            return new Promise(function (n, r) {
                ...
                (i.onload = function () {
                    ...
                    'responseType' in i &&
                        (l
                            ? (i.responseType = 'blob')
                            : f && o.headers.get('Content-Type') && -1 !== o.headers.get('Content-Type').indexOf('application/octet-stream') && (i.responseType = 'arraybuffer')),
                    !t || 'object' != typeof t.headers || t.headers instanceof v
        ...
        (C.polyfill = !0), c.fetch || ((c.fetch = C), (c.Headers = v), (c.Request = k), (c.Response = M));
        n(108), n(73);
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: 'calculateNights',
                            value: function () {
                                var e = O(document.querySelector('input#theCheckIn').value).format('MM/DD/YYYY'),
                                    t = O(document.querySelector('input#theCheckOut').value).format('MM/DD/YYYY');
                                return O(t).diff(O(e), 'days');
                            },
                        },
                        {
                            key: 'matchMediaQuery',
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                var t = O();
                                return O(e).diff(t, 'milliseconds') < 0;
                            },
                        },
                    ]) && j(t.prototype, n),
                    r && j(t, r),
                        ...
                        value: function (e, t, n) {
                            ...
                            document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                ...
                                'standard' === n.getMetaTagContent('theme')
                                    ? ((u = D(document.querySelector('input#theCheckIn').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                      (d = D(document.querySelector('input#theCheckOut').value, e.dayjs_date_format).format(e.dayjs_date_format)),
                                      (f = D(d).diff(D(u), 'days')))
                                    : 'mandarin' === n.getMetaTagContent('theme') || 'tw_mandarin' === n.getMetaTagContent('theme')
                                    ? ((u = D(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                      (d = D(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format(e.dayjs_date_format)),
                                      (f = D(d).diff(D(u), 'days')),
                                      (u = D(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('YYYY/M/D')),
                                      (d = D(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('YYYY/M/D')))
                                    : ((u = D(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                      (d = D(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format(e.dayjs_date_format)),
                                      (f = D(d).diff(D(u), 'days')),
                                      (u = D(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('D/M/YYYY')),
                                      (d = D(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('D/M/YYYY'))),
                                    'standard' !== n.getMetaTagContent('theme') &&
                                    ...
                                    w({
                                        ...
                                        destination: {
                                            ...
                                            value:
                                                ...
                                                null !== document.querySelector(p).value ? document.querySelector(p).value : l.has('destination') ? l.get('destination') : void 0),
                                        },
                    ...
                    (n = [
                                                            ...
                                                            switch ((t.prev = t.next)) {
                                                                ...
                                                                case 9:
                                                                    'cug' === e.site_config.site_type &&
                                                                        z.waitForSelectorInDOM('#AdminControlsContainer').then(
                                                                            $(
                                                                                regeneratorRuntime.mark(function e() {
                                                                                    return regeneratorRuntime.wrap(function (e) {
                                                                                        for (;;)
                                                                                            switch ((e.prev = e.next)) {
                                                                                                case 0:
                                                                                                    z.appendToParent('#commands', 'header');
                                                                                                case 1:
                                                                                                case 'end':
                                                                                                    return e.stop();
                                                                                            }
                                                                        ...
                                                                        z.updateAttribute('.ArnSupportLinks a', '_blank', 'target'),
                                                                        'property-detail' === e.page_name &&
                                                                            (e.addImageSlideshow(),
                                                                            e.updateAmenitiesLegendTag(),
                                                                            z.updateHTML('.SinglePropDetail .Map a', 'Map'),
                                                                            z.updateHTML('.SinglePropDetail .Reviews a', 'Reviews'),
                                                                            z.updateHTML('.SinglePropDetail .OptionsPricing a', 'Rooms'),
                                                                            z.updateHTML('.SinglePropDetail .Details a', 'General Info'),
                                                                            e.isPropByGateway(
                                                                            ...
                                                                            z.moveElementIntoExistingWrapper(
                                                                        ...
                                                                        'checkout' === e.page_name &&
                                                                            ...
                                                                            z.updateAttribute('#theEmailAddressAjax input', 'email', 'type'),
                                                                            z.updateAttribute('.CheckOutForm #theCountryCode', 'numeric', 'inputmode'),
                                                                            z.updateAttribute('.CheckOutForm #theAreaCode', 'numeric', 'inputmode'),
                                                                            z.updateAttribute('.CheckOutForm #thePhoneNumber', 'numeric', 'inputmode'),
                                                                            z.updateAttribute('.CheckOutForm #theCreditCardNumber', 'numeric', 'inputmode'),
                                                                            z.updateAttribute('.CheckOutForm #theCvvCode', 'numeric', 'inputmode'),
                                                                            z.appendToParent('#theMarketingOptInAjax', '#theConfirmCheckboxesAjax'),
                                                                            z.updateHTML('#theCharges legend', 'Rate Info'),
                                                                            z.updateHTML('.taxFeeRow th', '<span>Taxes:</span>'),
                                                                            z.updateHTML('#theHotel legend', 'Reservation Summary'),
                                                                            e.formatCheckoutForm(),
                                                                            e.setupReservationSummaryContainer(),
                                                                            z.moveElementIntoExistingWrapper('#theBookingPage #theRateDescription', '#theHotel', 'beforeEnd'),
                                                                            z.emailVerificationSetup(),
                                                                            e.fixCheckoutInputTabOrder(),
                                                                            z.selectCheckboxOnLabelClick('.confirmationWarning, .confirmationAgreement, #theMarketingOptInAjax')),
                                                                        'confirmation' === e.page_name && (e.implementAds(), e.addMessagingToConfirmationPage()),
                                                                        document.querySelector('.RootBody') &&
                                                                            (Z.init(e.site_config, e.page_name, z),
                                                                            e.buildCurrencyDropdown(),
                                                                            z.updateHTML('.RootBody .ArnSearchHeader', 'Start Your Search'),
                                                                            z.createHTML(
                                                                            ...
                                                                            z.moveOrphanedElementsIntoNewWrapper(
                                                                            ...
                                                                            z.selectCheckboxOnLabelClick('.ArnSearchField div')),
                                                                        z.updateHTML('#thePassCodeAjax label', 'Promocode'),
                                                                        z.updateHTML('#theUserNameAjax label', 'Username/Email'),
                                                                        z.createHTML('<h1>Login</h1>', '#theWBLoginFormBody form', 'beforeBegin'),
                                                                        z.createHTML('<h1>Register</h1>', '#theWBValidatedRegistrationFormBody form', 'beforeBegin'),
                                                                        z.createHTML('<h1>Forgot Password?</h1>', '#theWBForgotPasswordFormBody form', 'beforeBegin'),
                                                                        z.createHTML(
                                                                        ...
                                                                        'search-results' === e.page_name && Z.init(e.site_config, e.page_name, z),
                                                                        jQuery('#theBody').on(
                                                                            'arnMapLoadedEvent',
                                                                            $(
                                                                                            ...
                                                                                            switch ((t.prev = t.next)) {
                                                                                                case 0:
                                                                                                    return (
                                                                                                        (e.map_loaded = !0),
                                                                                                        (t.next = 3),
                                                                                                        z.waitForSelectorInDOM('.pollingFinished')
                                                                                                    );
                                                                                                case 3:
                                                                        ...
                                                                        z.waitForSelectorInDOM('.pollingFinished').then(
                                                                            (function () {
                                                                                var t = $(
                                                                                    regeneratorRuntime.mark(function t(n) {
                                                                                        return regeneratorRuntime.wrap(function (t) {
                                                                                                ...
                                                                                                switch ((t.prev = t.next)) {
                                                                                                    case 0:
                                                                                                        if (
                                                                                                            ('hold-rooms' === e.page_name &&
                                                                                                                ...
                                                                                                                z.addClass('ArnSearchContainerMainDiv', 'ArnSubPage')),
                                                                                                    ...
                                                                                                    case 3:
                                                                                                        return (
                                                                                                            ...
                                                                                                            e.moveReviewsIntoPropNameContainer(),
                                                                                                            z.updateAttribute('.ArnShowRatesLink', '_blank', 'target'),
                                                                                                            e.movePropClassBelowPropName(),
                                                                                                            z.selectCheckboxOnLabelClick('.ArnSearchField div'),
                                                                                                            z.updateHTML('#ShowHotelOnMap', 'Open Map'),
                                                                                                            z.updateHTML('.ArnShowRatesLink', 'Book Rooms'),
                                                                                                            z.updateHTML('.lblRating', 'Stars'),
                                                                                                            z.updateHTML('.lblCurrency', 'Currency'),
                                                                                                            z.updateHTML('.lblAmenities', 'Amenities'),
                                                                                                            z.updateHTML('.lblNearbyCities', 'Nearby Cities'),
                                                                                                            z.updateHTML('.lblPropertyType', 'Property Type'),
                                                                                                            z.updateHTML('.ArnSortBy', '<div class="sort">Sort</div>'),
                                                                                                            z.updateHTML('.ArnSearchHeader', 'Update Search'),
                                                                                                            z.moveElementIntoExistingWrapper(
                                                                                                                '.ArnPropClass',
                                                                                                                '.ArnPropName',
                                                                                                                'beforeEnd'
                                                                                                            ...
                                                                                                            (t.next = 31),
                                                                                                            z.waitForSelectorInDOM('#pagerBottomAjax').then(function () {
                                                                                                                z.appendToParent('#pagerBottomAjax', '#currentPropertyPage');
                                                                                                            })
                                                                                                        );
                                                                                                    case 31:
                                                                                                        return (
                                                                                                            (t.next = 33),
                                                                                                            z.waitForSelectorInDOM('.ArnSortContainer').then(function () {
                                                                                                                z.createWrapper(
                                                                                                                    ...
                                                                                                                    e.createMobileSortAndFilter(),
                                                                                                                        ...
                                                                                                                        z.matchMediaQuery('min-width: 1105px') &&
                                                                                                                            document.body.insertAdjacentHTML(
                                                                                                                                'afterBegin',
                                                                                                                                '<style>.ArnSortContainer, .sort-wrapper{display: block !important}</style>'
                                                                                                                            ),
                                                                                                                        z.matchMediaQuery('max-width: 800px') &&
                                                                                                                            document.body.insertAdjacentHTML(
                                                                                                                                'afterBegin',
                                                                                                    ...
                                                                                                    case 33:
                                                                                                        ...
                                                                                                        return (t.next = 37), z.waitForSelectorInDOM('#ArnPropertyMap');
                                                                                                    case 37:
                                                                                                        document.querySelector('.leaflet-control-scale-line') ||
                                                                                                            L.control.scale().addTo(window.ArnMap),
                                                                                                            e.useLogoForVenueMapMarker(),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                window.matchMedia('(max-width:800px)').matches &&
                                    ...
                                    z.moveOrphanedElementsIntoNewWrapper(document.querySelectorAll('#theStayPolicies *'), 'policies-container', '#theStayPolicies', 'beforeEnd'),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                o &&
                                    ...
                                    ((t = o.textContent),
                                    (r = i.textContent),
                                    (e = V(t).format(this.site_config.dayjs_date_format)),
                                    (n = V(r).format(this.site_config.dayjs_date_format)),
                                    z.createHTML('<span class="date-container">'.concat(e, ' - ').concat(n), '#theHotelAddress', 'beforeBegin'),
                                    z.moveElementIntoExistingWrapper('.totalRow .discount', '.theHotelName', 'afterEnd'));
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                e.forEach(function (e) {
                                    (t += 1),
                                        ...
                                        z.updateHTML('#theCreditCardBillingNameAjax'.concat(t - 1, ' label'), "Cardholder's Name"),
                                        z.updateHTML('#theBillingAddressAjax'.concat(t - 1, ' label'), 'Billing Address'),
                                        z.updateHTML('.RoomNumber-'.concat(t, ' > legend'), 'Billing Info'),
                                        t > 1 && z.updateHTML('.RoomNumber-'.concat(t, ' > legend'), 'Billing Info - Room '.concat(t)),
                                        z.createHTML('<legend>Credit Card Info</legend>', '.RoomNumber-'.concat(t, ' .guestBillingAddress'), 'beforeBegin'),
                                        z.updateHTML(
                                            '.cardNumber label',
                            ...
                            value: function (e) {
                                document.querySelector('#theCopyInfoAjax input') &&
                                    document.querySelector('#theCopyInfoAjax input').addEventListener('click', function () {
                                        setTimeout(function () {
                                            z.updateHTML('.RoomNumber-'.concat(e, ' > legend'), 'Billing Info'),
                                                e > 1 && z.updateHTML('.RoomNumber-'.concat(e, ' > legend'), 'Billing Info - Room '.concat(e));
                                        }, 750);
                                    });
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.site_config &&
                                    e &&
                                    (z.createHTML('<link href="'.concat(this.site_config.google_font_url, '" rel="stylesheet">'), 'head', 'beforeEnd'),
                                    e.insertAdjacentHTML(
                                        'beforeend',
                                        '<link href="'
                                            .concat(G.path, '/site_configs/')
                        ...
                        },
                        {
                            ...
                            value: function () {
                                'light' !== this.site_config.theme.toLowerCase() &&
                                    document.querySelector('#h4h-styles').insertAdjacentHTML('beforeend', '<link href="'.concat(G.path, '/styles/dark.css" rel="stylesheet">'));
                            },
                        },
                        {
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            (t = function () {
                                                                fetch(''.concat(G.path, '/js/json/currencies.json'))
                                                                    .then(function (e) {
                                                                        if (!e.ok) throw e;
                                                                        return e.json();
                                                                    })
                                                            ...
                                                            (n = function (e) {
                                                                ...
                                                                t.insertAdjacentElement('beforeEnd', n),
                                                                    z.createDropdownMenu('#currency-label', t, '.currency-content', '.dropdown');
                                                            }),
                                                            (r = function () {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                'checkout' === this.page_name &&
                                    ...
                                    z.replaceSpecificText('.confirmedDueNowCharge .confirmationAgreement', /(^|)You(?=\s|$)/gi, 'I'),
                                    z.replaceSpecificText('.confirmedDueNowCharge .confirmationAgreement', /(^|)your(?=|$)/gi, 'my'),
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (r = document.querySelector(n)), (e.next = 5), z.fetchHTMLFromFile(t);
                                                    case 5:
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            ...
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (t = this.site_config.header.logo_outbound_url), (e.next = 5), z.waitForSelectorInDOM('.logo');
                                                        case 5:
                                        ...
                                        return regeneratorRuntime.wrap(
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            if (z.matchMediaQuery('max-width: 800px')) {
                                                                e.next = 2;
                                                                break;
                                                            }
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (e.next = 4), z.waitForSelectorInDOM('#theCheckIn');
                                                        case 4:
            ...
            ue = (function (e) {
                ...
                function u(e) {
                    ...
                    return (
                        ...
                        ie(((t = oe((n = s.call(this, e)))), ae(u.prototype)), 'init', t).call(t),
                        (n.site_config = e),
                        n
                    );
                }
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                ...
                                this.addLinkToRewardsPlatform(),
                                    ...
                                    document.querySelector('.WBLoginForm') && se.selectCheckboxOnLabelClick('#theRememberMeAjax'),
                                    document.querySelector('.SearchHotels') &&
                                        (se.waitForSelectorInDOM('.sort-wrapper').then(function () {
                                    ...
                                    document.querySelector('.WBValidatedRegistrationForm') &&
                                        ...
                                        se.removeMaskedElementFromTabIndex('#theUserNameAjax input')),
                                    document.querySelector('.WBSupportFormContainer') &&
                                        ...
                                        se.removeMaskedElementFromTabIndex('#theReservationConfirmationNumberAjax input')),
                                                    ...
                                                    for (;;)
                                                        switch ((e.prev = e.next)) {
                                                            case 0:
                                                                ...
                                                                return (e.next = 3), se.waitForSelectorInDOM('#faq-link');
                                                            case 3:
                                                                se.updateAttribute('#faq-link', se.getAttribute('.faqLink', 'href'), 'href'),
                                                                    se.updateAttribute('#customer-support-link', se.getAttribute('.supportLink', 'href'), 'href');
                                                            case 5:
                                                            case 'end':
                                                                return e.stop();
                                                        }
                                    ...
                                    se.addAttributeToInput('#theFirstNameAjax input', 'First Name', 'placeholder', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theLastNameAjax input', 'Last Name', 'placeholder', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theEditablePasswordAjax input', 'Create a Password', 'placeholder', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theEditableConfirmPasswordAjax input', 'Confirm Password', 'placeholder', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('.WBForgotPasswordFormFields #theUserNameAjax input', 'Email', 'placeholder', '.WBForgotPasswordForm'),
                                    se.addAttributeToInput('.WBForgotPasswordFormFields #theUserNameAjax input', !0, 'required', '.WBForgotPasswordForm'),
                                    se.addAttributeToInput('#theFirstNameAjax input', !0, 'required', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theLastNameAjax input', !0, 'required', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theEditablePasswordAjax input', !0, 'required', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#theEditableConfirmPasswordAjax input', !0, 'required', '.WBValidatedRegistrationForm'),
                                    se.addAttributeToInput('#commands .supportLink', '_blank', 'target', '.MemberAuthenticated'),
                                    se.addAttributeToInput('#commands .profileCommand', '_blank', 'target', '.MemberAuthenticated'),
                                    se.addAttributeToInput('#theNameAjax input', 'Name', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theDaytimePhoneNumberAjax input', 'Phone Number', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theEmailAjax input', 'Email', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theNameAjax input', !0, 'required', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theDaytimePhoneNumberAjax input', !0, 'required', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theEmailAjax input', !0, 'required', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theEmailAjax input', 'email', 'type', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theReservationConfirmationNumberAjax input', 'Booking Number', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theDateOfArrivalAjax input', 'Check In Date', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theHotelNameAjax input', 'Hotel', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theCommentsAjax textarea', 'Comments', 'placeholder', '.WBSupportFormContainer'),
                                    se.addAttributeToInput('#theEmailAddressAjax input', 'Email Address', 'placeholder', '.WBResendOrCancelForm'),
                                    se.addAttributeToInput('#theConfirmationNumberAjax input', 'Confirmation or Reference Number', 'placeholder', '.WBResendOrCancelForm'),
                                    se.updateHTML('#theReasonForInquiryAjax select > option:first-child', 'Reason for Inquiry'),
                                    se.updateHTML('.static-bookingLink', 'Booking Guide'),
                                    se.updateHTML('.static-rewardsLink', 'Rewards Guide');
                            },
                        },
                        {
                            key: 'updateLogin',
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (e.next = 4), se.waitForSelectorInDOM('#theWBLoginFormBody h1');
                                                    case 4:
                        ...
                        },
                        {
                            ...
                            value: function () {
                                if (document.querySelector('.CheckOutForm') && '62725' !== se.getMetaTagContent('siteId')) {
                                        ...
                                        return regeneratorRuntime.wrap(
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            if (document.querySelector('.SinglePropDetail') && '62725' !== se.getMetaTagContent('siteId')) {
                                                                e.next = 2;
                                                                break;
                                                            }
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (e.next = 4), se.waitForSelectorInDOM('.ArnNightlyRate');
                                                        case 4:
                                                ...
                                                regeneratorRuntime.mark(function t() {
                                                    return regeneratorRuntime.wrap(function (t) {
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    return (t.next = 2), se.waitForSelectorInDOM('#moreRates');
                                                                case 2:
                                                                    ie(ae(u.prototype), 'insertPercentageOffText', e).call(e, '.SinglePropDetail .rateRow'),
                                ...
                                if (i) {
                                    ...
                                    c.addEventListener('blur', function () {
                                        ...
                                        var e = setInterval(function () {
                                            document.querySelector('#'.concat(a.id)) || ((a = document.querySelector(o)), se.removeMaskedElementFromTabIndex(o), clearInterval(e));
                                        }, 500);
                                        a.focus(), a.blur();
                                    });
                                }
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                if (
                                    ...
                                    '62725' !== se.getMetaTagContent('siteId') &&
                                    (!document.querySelector('.beat-em') || 'search-results' !== se.page_name) &&
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = document.querySelector('#h4h-styles');
                                e && e.insertAdjacentHTML('beforeend', '<link href="'.concat(ce.path, '/styles/resbeat.css" rel="stylesheet">'));
                            },
                        },
                        {
                            key: 'removeAnchorTag',
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (e.next = 4), se.waitForSelectorInDOM('.confirmation-messaging a');
                                                    case 4:
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e,
                                    t = se.getMetaTagContent('memberMetaTag');
                                        ...
                                        return regeneratorRuntime.wrap(
                                            function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            return (e.next = 2), se.waitForSelectorInDOM('header #commands');
                                                        case 2:
                                                            if (
                                                                ((t = this.getLoginRedirectUrl()),
                                                                (n = encodeURIComponent(t)),
                                                                (r = se.getMetaTagContent('memberToken')),
        ...
        function ye(e, t) {
            return !t || ('object' !== le(t) && 'function' != typeof t) ? ge(e) : t;
        }
        function ge(e) {
            if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return e;
        ...
        new ((function (e) {
            ...
            function a() {
                ...
                return (
                    ...
                    ve(((e = ge((t = i.call(this, _e)))), be(a.prototype)), 'init', e).call(e),
                    t.init(),
                    t
                );
            }
                ...
                (n = [
                    {
                        ...
                        value: function () {
                            ...
                            this.addDemoSiteTextToHeader(),
                                ...
                                document.querySelector('.SearchHotels') &&
                                    xe.waitForTextInDOM('.ArnSearchHeader', 'Update Search').then(function () {
                                ...
                                document.querySelector('.SinglePropDetail') &&
                                    ...
                                    xe.waitForTextInDOM('.ArnLeftListContainer .translateMe', 'Update Search').then(function () {
                                ...
                                regeneratorRuntime.mark(function e() {
                                    ...
                                    return regeneratorRuntime.wrap(function (e) {
                                        for (;;)
                                            switch ((e.prev = e.next)) {
                                                case 0:
                                                    return (e.next = 2), xe.waitForSelectorInDOM('header');
                                                case 2:
                                    ...
                                    regeneratorRuntime.mark(function e() {
                                        ...
                                        return regeneratorRuntime.wrap(function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (e.next = 2), fetch(''.concat(we.path, '/site_configs/resbeat_squad_test-62686/js/gateways.json'));
                                                    case 2:
                                ...
                                document
                                    ...
                                    .insertAdjacentHTML(
                                        ...
                                        '\n            <span id="check-gds-rates">\n                <a href="'.concat(
                                            ...
                                            (t = Se(document.querySelector('meta[name="checkIn"]').content).format('M/D/YYYY')),
                                            (n = Se(document.querySelector('meta[name="checkOut"]').content).format('M/D/YYYY')),
                                            (r = Se(n).diff(Se(t), 'days')),
