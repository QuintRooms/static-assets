!(function (e) {
        ...
        var r,
            ...
            q = !!(function () {
                try {
                    ...
                    return (C || 'function' == typeof PromiseRejectionEvent) && e.then(M) instanceof t && 0 !== E.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            R = function (e) {
                var t;
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var A = String(b[0]), k = u(l(a(b.index), d.length), 0), E = [], L = 1; L < b.length; L++) E.push(void 0 === (S = b[L]) ? S : String(S));
                        var C = b.groups;
                        if (h) {
                            var M = [A].concat(E, k, d);
                            void 0 !== C && M.push(C);
                            var P = String(t.apply(void 0, M));
                        } else P = m(A, d, k, E, C, t);
    ...
    function (e, t, n) {
        ...
        !(function () {
            ...
            K('.SinglePropDetail .bookRoomCell'),
            jQuery(document).on('ratesReadyEvent', function () {
                setTimeout(function () {
                    K('.SearchHotels .ArnRateCell');
                }, 1);
            }),
            (function () {
