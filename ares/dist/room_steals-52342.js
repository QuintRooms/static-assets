!(function (e) {
        ...
        var r,
            ...
            M = !!(function () {
                try {
                    ...
                    return (C || 'function' == typeof PromiseRejectionEvent) && e.then(q) instanceof t && 0 !== L.indexOf('6.6') && -1 === _.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            R = function (e) {
                var t;
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            K = function (e, t) {
                if (((e = _(e)), (t = w(t, !0)), e !== U || !o(F, t) || o(N, t))) {
                    var n = P(e, t);
            ...
            ee = function (e) {
                for (var t, n = e === U, r = R(n ? N : _(e)), i = [], a = 0; r.length > a; ) !o(F, (t = r[a++])) || (n && !o(U, t)) || i.push(F[t]);
                return i;
            };
        $ ||
            (c(
    ...
    function (e, t, n) {
        ...
        e.exports =
            ...
            n(7)(function () {
                ...
                ? function (e, t) {
                      for (var n = c(e), u = arguments.length, l = 1, d = i.f, f = a.f; u > l; )
                          for (var h, p = s(arguments[l++]), m = d ? o(p).concat(d(p)) : o(p), y = m.length, g = 0; y > g; ) (h = m[g++]), (r && !f.call(p, h)) || (n[h] = p[h]);
                      return n;
                  }
                : u;
    },
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(63), n(64), n(72), n(34), n(86), n(56), n(89), n(92), n(57), n(39), n(40), n(96), n(98), n(59), n(101), n(102), n(62), n(41);
                            ...
                            value: function () {
                                ...
                                y('.RootBody', 'div#CitySearchContainer span', 'beforeEnd', '<input type="search" id="address-input" placeholder="Destination" required="true" />'),
                                    ...
                                    'search-results' === a.page_name &&
                                        'cug' !== a.site_config.site_type.toLowerCase() &&
                                        H.waitForSelectorInDOM('.algolia-places').then(function () {
        ...
        if ((document.querySelector('.MemberAuthenticated') && document.querySelector('.SearchHotels')) || document.querySelector('.SinglePropDetail')) {
            ...
            $.getRoomNights(),
                $.getMemberMetaData()
                    .then(function (e) {
                        $.getReferralID(), $.getPartner();
                    })
                    .then(function () {
                        $.getRoomStealsAPIData().then(function () {
                            $.setRoomStealsUser().then(function () {
                                $.checkIsRoomStealsTrialUser().then(function () {
                                    $.setPropertyURL().then(function () {
                                        ...
                                        document.querySelector('.SinglePropDetail') && $.showCustomerSavings();
                                });
                            });
                        });
                    });
        ...
        var X = new P(),
            K = new (function () {
                return {
                    ...
                    has_custom_styles: !0,
                    custom_styles_url: ''.concat(W.path, '/site_configs/').concat(G, '/52342.css'),
                    has_social_sharing: !0,
                    header: {
                        logo_file_location: ''.concat(W.path, '/site_configs/').concat(G, '/img/logo.png'),
                    ...
                    banner_image_url: 'linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)), url('
                        .concat(W.path, '/site_configs/')
                        .concat(G, '/img/banner.jpg) no-repeat center center /cover'),
            ...
            Q = (function (e) {
                function t() {
                    ...
                    return (
                        ...
                        (e = (function (e, t) {
                            return !t || ('object' !== z(t) && 'function' != typeof t) ? V(e) : t;
                        })(this, Z(t).call(this, K))),
                        J(Z(t.prototype), 'init', V(e)).call(V(e)),
                        e
                    );
                }
                return (
        ...
        X.updateAttribute('.profileCommand', 'https://roomsteals.com/settings', 'href'),
            X.updateHTML(
