!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', _ = 0, x = 0; x < v.length; x++) {
                        S = v[x];
                        for (var k = String(S[0]), A = u(l(a(S.index), d.length), 0), L = [], q = 1; q < S.length; q++) L.push(void 0 === (b = S[q]) ? b : String(b));
                        var M = S.groups;
                        if (h) {
                            var E = [k].concat(L, A, d);
                            void 0 !== M && E.push(M);
                            var C = String(t.apply(void 0, E));
                        } else C = m(k, d, A, L, M, t);
                        A >= _ && ((w += d.slice(_, A) + C), (_ = A + k.length));
                    }
                    return w + d.slice(_);
                },
            ];
    ...
    function (e, t, n) {
        ...
        (A.polyfill = !0), self.fetch || ((self.fetch = A), (self.Headers = h), (self.Request = b), (self.Response = _));
        n(109);
        var q = n(44);
        n(49);
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, _ = []; w < d.length; ) {
                            ...
                            var x,
                                k = s(v, p ? d : d.slice(w));
                            if (null === k || (x = f(c(v.lastIndex + (p ? 0 : w)), d.length)) === b) w = a(d, w, y);
                            else {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: x ? q : w('values'), keys: y ? q : w('keys'), entries: M}), g)) for (S in v) S in A || i(A, S, v[S]);
                else o(o.P + o.F * (d || k), t, v);
            return v;
        };
    },
    function (e, t, n) {
