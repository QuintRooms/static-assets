!(function (e) {
        ...
        var r,
            ...
            P = !!(function () {
                try {
                    ...
                    return (q || 'function' == typeof PromiseRejectionEvent) && e.then(E) instanceof t && 0 !== L.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            T = function (e) {
                var t;
    ...
    function (e, t, n) {
        var r = (function (e) {
            ...
            return (
                ...
                (e.mark = function (e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, h) : ((e.__proto__ = h), c(e, a, 'GeneratorFunction')), (e.prototype = Object.create(g)), e;
                }),
                (e.awrap = function (e) {
                    return {__await: e};
                }),
    ...
    function (e, t, n) {
        for (
            ...
            var y,
                ...
                S = a[g],
                b = S && S.prototype;
            if (b && (b[l] || c(b, l, d), b[f] || c(b, f, g), (s[g] = d), v)) for (y in r) b[y] || i(b, y, r[y], !0);
        }
    },
    function (e, t, n) {
        'use strict';
    ...
    function (e, t, n) {
        ...
        var r = n(2),
            ...
            d = /\$([$&`']|\d\d?|<[^>]*>)/g,
            h = /\$([$&`']|\d\d?)/g;
        n(43)('replace', 2, function (e, t, n, p) {
            return [
                function (r, o) {
                    var i = e(this),
                        a = null == r ? void 0 : r[t];
                ...
                function (e, t) {
                    ...
                    for (var v = []; ; ) {
                        ...
                        if (null === S) break;
                        if ((v.push(S), !y)) break;
                        '' === String(S[0]) && (f.lastIndex = c(d, i(f.lastIndex), g));
                    }
                    for (var b, w = '', _ = 0, x = 0; x < v.length; x++) {
                        S = v[x];
                        for (var A = String(S[0]), k = u(l(a(S.index), d.length), 0), L = [], M = 1; M < S.length; M++) L.push(void 0 === (b = S[M]) ? b : String(b));
                        var q = S.groups;
                        if (h) {
                            var E = [A].concat(L, k, d);
                            void 0 !== q && E.push(q);
                            var C = String(t.apply(void 0, E));
                        } else C = m(A, d, k, L, q, t);
    ...
    function (e, t, n) {
        e.exports = (function () {
            ...
            (b.l = v),
                (b.i = g),
                (b.w = function (e, t) {
                    return S(e, {locale: t.$L, utc: t.$u, $offset: t.$offset});
                });
            var w = (function () {
                    function d(e) {
                    ...
                    return (
                        ...
                        (h.startOf = function (e, c) {
                            var l = this,
                                ...
                                p = function (e, t) {
                                    return b.w(l.toDate()[e].apply(l.toDate('s'), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(t)), l);
                                },
                                m = this.$W,
                                y = this.$M,
                                g = this.$D,
                            ...
                            switch (d) {
                                ...
                                case a:
                                    return f ? h(1, y) : h(0, y + 1);
                                case i:
                                    var S = this.$locale().weekStart || 0,
                                        w = (m < S ? m + 7 : m) - S;
                                    return h(f ? g - w : g + (6 - w), y);
                                case o:
                                case u:
                                    return p(v + 'Hours', 0);
                                case r:
    ...
    function (e, t, n) {
        ...
        (d && h) ||
            ...
            'process' == n(15)(f)
                ...
                : p
                ? ((i = (o = new p()).port2), (o.port1.onmessage = S), (r = a(i.postMessage, i, 1)))
                ...
                (m =
                    ...
                    ''.split(/.?/)[h]
                        ? function (e, t) {
                              ...
                              return f === o[h] ? (!c && m.test('')) || s.push('') : s.push(o.slice(f)), s[h] > p ? s.slice(0, p) : s;
                          }
                        : '0'.split(void 0, 0)[h]
                        ? function (e, t) {
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        var u = o(e),
                            ...
                            v = new h(p ? u : '^(?:' + u.source + ')', g),
                            S = void 0 === t ? 4294967295 : t >>> 0;
                        if (0 === S) return [];
                        if (0 === d.length) return null === s(v, d) ? [d] : [];
                        for (var b = 0, w = 0, _ = []; w < d.length; ) {
                            v.lastIndex = p ? w : 0;
                            var x,
                                A = s(v, p ? d : d.slice(w));
                            if (null === A || (x = f(c(v.lastIndex + (p ? 0 : w)), d.length)) === b) w = a(d, w, y);
                            else {
                                if ((_.push(d.slice(b, w)), _.length === S)) return _;
                                for (var k = 1; k <= A.length - 1; k++) if ((_.push(A[k]), _.length === S)) return _;
                                w = b = x;
                            }
                        }
                ...
                u = function (e, n, r) {
                    try {
                        ...
                        var v = u || 0,
                            ...
                            b = f || 0,
                            w = d || 0;
                        return h ? new Date(Date.UTC(y, g, m, v, S, b, w + 60 * h.offset * 1e3)) : r ? new Date(Date.UTC(y, g, m, v, S, b, w)) : new Date(y, g, m, v, S, b, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
                ...
                o.parse = function (t) {
                    ...
                    if ('string' == typeof c) {
                        var s = !0 === a[2],
                            ...
                            d = a[2];
                        l && (d = a[2]),
                            s || (e = d ? r.Ls[d] : this.$locale()),
                            (this.$d = u(n, c, o)),
                            this.init(),
                            d && !0 !== d && (this.$L = this.locale(d).$L),
                            f && n !== this.format(c) && (this.$d = new Date(''));
                    } else if (c instanceof Array)
                        for (var h = c.length, p = 1; p <= h; p += 1) {
                            a[1] = c[p - 1];
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            K = function (e, t) {
                if (((e = w(e)), (t = _(t, !0)), e !== N || !o(I, t) || o(F, t))) {
                    var n = C(e, t);
                    return !n || !o(I, t) || (o(e, D) && e[D][t]) || (n.enumerable = !0), n;
                }
            },
            X = function (e) {
                for (var t, n = T(w(e)), r = [], i = 0; n.length > i; ) o(I, (t = n[i++])) || t == D || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = T(n ? F : w(e)), i = [], a = 0; r.length > a; ) !o(I, (t = r[a++])) || (n && !o(N, t)) || i.push(I[t]);
                return i;
            };
        U ||
            (c(
            ...
            (n(27).f = Q),
            (M.f = ee),
            i && !n(17) && c(N, 'propertyIsEnumerable', Q, !0),
            (p.f = function (e) {
                return z(h(e));
            })),
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, f, d) {
            ...
            if (i(g)) {
                for (h = c(e.length); h > S; S++) if ((y = t ? v(a((p = e[S]))[0], p[1]) : v(e[S])) === u || y === l) return y;
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            var v,
                ...
                M = L || w(m),
                q = m ? (x ? w('entries') : M) : void 0,
                E = ('Array' == t && k.entries) || L;
            if (
                (E && (b = l(E.call(new e()))) !== Object.prototype && b.next && (u(b, _, !0), r || 'function' == typeof b[f] || a(b, f, h)),
                x &&
                    L &&
                    'values' !== L.name &&
                    ((A = !0),
                ...
                if (((v = {values: x ? M : w('values'), keys: y ? M : w('keys'), entries: q}), g)) for (S in v) S in k || i(k, S, v[S]);
    ...
    function (e, t, n) {
        'use strict';
        n.r(t);
        n(68), n(69), n(39), n(20), n(79), n(81), n(30), n(94), n(41), n(31), n(98), n(62), n(102), n(45), n(105), n(106), n(65), n(32);
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                var t = P();
                                return P(e).diff(t, 'milliseconds') < 0;
                            },
                        },
                        {
                            key: 'percentDiff',
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                    ...
                                    52342 === e.site_id || ('standard' === n.getMetaTagContent('theme') && 16980 !== e.affiliate_id)
                                        ? ((u = D(document.querySelector('input#theCheckIn').value, 'M/D/YYYY').format('M/D/YYYY')),
                                          (f = D(document.querySelector('input#theCheckOut').value, 'M/D/YYYY').format('M/D/YYYY')),
                                          (d = D(f).diff(D(u), 'days')))
                                        : 'mandarin' === n.getMetaTagContent('theme') || 'tw_mandarin' === n.getMetaTagContent('theme')
                                        ? ((u = D(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (f = D(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('M/D/YYYY')),
                                          (d = D(f).diff(D(u), 'days')),
                                          (u = D(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('YYYY/M/D')),
                                          (f = D(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('YYYY/M/D')))
                                        : (16980 === e.affiliate_id || e.site_id,
                                          (u = D(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('M/D/YYYY')),
                                          (f = D(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('M/D/YYYY')),
                                          (d = D(f).diff(D(u), 'days')),
                                          (u = D(document.querySelector('input#theCheckIn').value, 'D/M/YYYY').format('D/M/YYYY')),
                                          (f = D(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('D/M/YYYY'))),
            ...
            J = (function () {
                function e(t) {
                    !(function (e, t) {
                        ...
                        (this.map_loaded = !1),
                        (this.selected_currency = z.getMetaTagContent('currency') ? z.getMetaTagContent('currency') : 'USD');
                }
                var t, n, r, o, i, a, c, s, u, l, f, d, h;
                return (
                    (t = e),
                    (n = [
                        {
                                                                ...
                                                                case 9:
                                                                    'cug' === e.site_config.site_type &&
                                                                        ...
                                                                        document.querySelector('.RootBody') &&
                                                                            (V.init(e.site_config, e.page_name, z),
                                                                        ...
                                                                        'search-results' === e.page_name &&
                                                                            (V.init(e.site_config, e.page_name, z), e.showOriginalPrice('.ArnProperty', '.arnPrice')),
                                                                        jQuery('#theBody').on(
                                                                            'arnMapLoadedEvent',
                                                                            N(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                'light' !== this.site_config.theme.toLowerCase() &&
                                    document.querySelector('#h4h-styles').insertAdjacentHTML('beforeend', '<link href="'.concat($.path, '/styles/dark.css" rel="stylesheet">'));
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                function d(r, o) {
                                    (e = W(u.value, r).format('M/D/YYYY')),
                                        (t = W(l.value, r).format('M/D/YYYY')),
                                        (n = W(t).diff(W(e), 'days')),
                                        (e = W(u.value, r).format(o)),
                                        (t = W(l.value, r).format(o));
                                }
                                this.site_config &&
                                    c &&
                                    s &&
                                                      ...
                                                      ? 'standard' !== o || 'standard' === i || i.includes('mandarin')
                                                          ? 'standard' === o || o.includes('mandarin') || 'standard' === i || i.includes('mandarin')
                                                              ? o.includes('mandarin') && 'standard' !== i
                                                                  ...
                                                                  : 'standard' !== o && i.includes('mandarin')
                                                                  ? d('YYYY/M/D', 'D/M/YYYY')
                                                                  : 16980 === r.site_config.affilaite_id && d('D/M/YYYY', 'D/M/YYYY')
                                                              : d('D/M/YYYY', 'D/M/YYYY')
                                                          : d('D/M/YYYY', 'M/D/YYYY')
                                                      : d('M/D/YYYY', 'D/M/YYYY'),
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            (t = function () {
                                                                fetch(''.concat($.path, '/js/json/currencies.json'))
                                                                    .then(function (e) {
                                                                        if (!e.ok) throw e;
                                                                        return e.json();
                                                                    })
                            ...
                            value: function (e, t) {
                                return new Promise(function (t) {
                                    var n,
                                        ...
                                        o,
                                        i,
                                        a = z.getMetaTagContent('showFullTotals');
                                    a ||
                                        (document.querySelector('.SearchHotels') &&
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        case 0:
                                                            ...
                                                            return e.abrupt('return');
                                                        case 2:
                                                            return (e.next = 4), z.waitForSelectorInDOM('.pollingFinished');
                                                        case 4:
                                                            document.querySelectorAll(t).forEach(function (e) {
        ...
        var X = (function () {
            function e(t, n, r, o, i, a, c, s, u, l, f) {
                !(function (e, t) {
                    if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
                })(this, e),
                    (this.api_token = 'NWJzBYUfpAmNXtJzayXGfxE2owHVPQ5fWxkvPSNMdMp3FKPpDs0TBWyvqrUa'),
                    (this.member_meta_data = t),
                    (this.additional_info_data = n),
                    (this.partner = r),
                    (this.referral_id = o),
                    (this.room_steals_api_data = i),
                    (this.partner_model = a),
                    (this.user_plan = c),
                    (this.subscribe_url = s),
                    (this.is_room_steals_trial_user = u),
                    (this.room_nights = l),
                    (this.property_url = f);
            }
            ...
            return (
                ...
                (n = [
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 5:
                                                        return (this.member_meta_data = JSON.parse(t.getAttribute('content'))), e.abrupt('return', this.member_meta_data);
                                                    case 7:
                                                    case 'end':
                                                        return e.stop();
                                                }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (this.member_meta_data && this.member_meta_data.Names && this.member_meta_data.Names[0] && this.member_meta_data.Names[0].ReferralId)
                                return (this.referral_id = this.member_meta_data.Names[0].ReferralId.split('-')[1]), this.referral_id;
                        },
                    },
                    {
                        key: 'getPartner',
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        if (
                                                            ...
                                                            !this.additional_info_data || !this.additional_info_data.partner)
                                                        ) {
                                                            e.next = 6;
                                                            break;
                                                        }
                                                        return (this.partner = this.additional_info_data.partner), e.abrupt('return', this.partner);
                                                    case 6:
                                                    case 'end':
                                                        return e.stop();
                                                }
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            (e.next = 2),
                                                            fetch(
                                                                'https://roomsteals.com/api/partners/'
                                                                    .concat(this.partner, '/users/')
                                                                    .concat(this.referral_id, '?api_token=')
                                                                    .concat(this.api_token)
                                                            )
                                                        );
                                                    case 2:
                                                        if (((t = e.sent), void 0 === this.partner || void 0 === this.referral_id)) {
                                                            e.next = 7;
                                                            break;
                                                        }
                                                        return (e.next = 6), t.json();
                                                    case 6:
                                                        this.room_steals_api_data = e.sent;
                                                    case 7:
                                                    case 'end':
                                                        return e.stop();
                                                }
                                    ...
                                    return regeneratorRuntime.wrap(
                                        function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        'roomsteals.com' === this.partner && null === this.user_plan
                                                            ? (this.is_room_steals_trial_user = !0)
                                                            : (this.is_room_steals_trial_user = !1);
                                                    case 1:
                                                    case 'end':
                                                        return e.stop();
                                                }
                    ...
                    {
                        key: 'updateBookingButtons',
                        value: function () {
                            var e = this;
                            if (document.querySelector('.SearchHotels')) {
                                var t = document.querySelectorAll('.ArnRateButton');
                                if (!t) return;
                                !0 === this.is_room_steals_trial_user
                                    ? t.forEach(function (e) {
                                          e.querySelector('.ArnShowRatesLink').textContent = 'Show More';
                                      })
                                    : t.forEach(function (e) {
                                          e.querySelector('.ArnShowRatesLink').textContent = 'See My Rate';
                                      });
                            }
                            if (document.querySelector('.SinglePropDetail')) {
                                var n,
                                    r,
                                    o = document.querySelectorAll('.bookRoom');
                                if (!o) return;
                                !0 === this.is_room_steals_trial_user
                                    ? o.forEach(function (t) {
                                          (r = t.parentNode.querySelector('.ArnNightlyRate')) &&
                                              ((n = r.getAttribute('total')),
                                              (t.text = 'Subscribe to Book'),
                                              t.setAttribute('href', ''.concat(e.subscribe_url, '/?return_to=').concat(e.property_url, '&total=').concat(n)));
                                      })
                                    : o.forEach(function (e) {
                                          e.textContent = 'Book My Room';
                                      });
                            }
                            return !1;
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (e && t) {
                                var n = new Date(e.value),
                                    r = new Date(t.value),
                                    o = Math.abs(r - n),
                                    i = Math.ceil(o / 864e5);
                                return (this.room_nights = i), this.room_nights;
                            }
                        },
                    },
                    {
                        key: 'showCustomerSavings',
                        value: function () {
                            var e = this;
                            if (!0 === this.is_room_steals_trial_user) {
                                var t = '',
                                    n = '';
                                document.querySelector('.SearchHotels') && (t = document.querySelectorAll('.ArnContainer')),
                                    document.querySelector('.SinglePropDetail') && (t = document.querySelectorAll('.rateRow')),
                                    t.forEach(function (t) {
                                        var r = t.querySelector('.originalPrice');
                                        if (
                                            (document.querySelector('.SearchHotels')
                                                ? (n = t.querySelector('.ArnRateButton'))
                                                : document.querySelector('.SinglePropDetail') && (n = t.querySelector('.bookRoom')),
                                            r)
                                        ) {
                                            var o = r.getAttribute('amount').replace(/\D+/g, '') * e.room_nights - 5900;
                                            o > 500 &&
                                                ((o = o.toString().slice(0, -2)),
                                                t.querySelector('.savings-tag') ||
                                                    n.insertAdjacentHTML(
                                                        'afterEnd',
                                                        '<div class="savings-tag">With the $59 subscription, you\'d still save <strong>$'.concat(
                                                            o,
                                                            '</strong> on this reservation!</div>\n                        <style>\n                        /* Savings Tag */\n                            .savings-tag {\n                                max-width: 250px;\n                                text-align: center;\n                                width: 100%;\n                                margin-top: 8px;\n                                letter-spacing: -.2px;\n                                margin-left: auto;\n                                font-size: 13px;\n                                padding: 4px;\n                                background: #faaf18;\n                                color: #333;\n                            }\n\n                            .SinglePropDetail .bookRoom, .SinglePropDetail .holdRoom{\n                                max-width: 165px;\n                            }\n\n                            .SinglePropDetail .ArnContentGeneralInfo.ArnRateList>tbody>tr>td:nth-child(2){\n                                width: 25%;\n                            }\n                            \n                            .SinglePropDetail .savings-tag{\n                                margin-bottom: 8px;\n                            }\n\n                            @media screen and (max-width: 600px) {\n                                .ArnRateCell{\n                                    display: grid !important;\n                                }\n\n                                .savings-tag {\n                                    grid-column-start: 2;\n                                    grid-row-start: 2;\n                                    margin-top: 0;\n                                }\n\n                                .ArnRateButton{\n                                    grid-column-start: 2;\n                                    grid-row-start: 1;\n                                    margin-left: auto;\n                                }\n                            }\n\n                            @media screen and (max-width: 560px){\n                                .SinglePropDetail .ArnContentGeneralInfo.ArnRateList>tbody>tr>td:nth-child(2){\n                                    width: 100%;\n                                }\n                            }\n                            @media screen and (max-width: 412px){\n                                .SinglePropDetail .bookRoomCell{\n                                    grid-template-rows: 1fr .5fr .25fr;\n                                }\n                            }\n                        </style>'
                                                        )
                                                    ));
                                        }
                                    });
                                        ...
                                        function (e) {
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        document.querySelector('.SinglePropDetail') &&
                                                            ((t = document.querySelector('meta[name="aPropertyId"]')),
                                                            (n = document.querySelector('meta[name="checkIn"]')),
                                                            t && n && ((t = t.getAttribute('content')), (n = n.getAttribute('content'))),
                                                            (this.property_url = encodeURI(
                                                                'https://hotels.roomsteals.com/v6?siteid=52342&type=property&property='
                                                                    .concat(t, '&checkin=')
                                                                    .concat(n, '&nights=')
                                                                    .concat(this.room_nights)
                                                            )));
                                                    case 1:
                                                    case 'end':
                                                        return e.stop();
        ...
        if ((document.querySelector('.MemberAuthenticated') && document.querySelector('.SearchHotels')) || document.querySelector('.SinglePropDetail')) {
            ...
            ee.getRoomNights(),
                ee
                    .getMemberMetaData()
                    .then(function (e) {
                        ee.getReferralID(), ee.getPartner();
                    })
                    .then(function () {
                        ee.getRoomStealsAPIData().then(function () {
                            ee.setRoomStealsUser().then(function () {
                                ee.checkIsRoomStealsTrialUser().then(function () {
                                    ee.setPropertyURL().then(function () {
                                        ee.updateBookingButtons();
                                    }),
                                        document.querySelector('.SearchHotels') &&
                                            jQuery(document).on('ratesReadyEvent', function () {
                                                ee.showCustomerSavings();
                                            }),
                                        document.querySelector('.SinglePropDetail') && ee.showCustomerSavings();
                                });
                            });
                        });
                    });
        ...
        function ce(e, t) {
            return !t || ('object' !== re(t) && 'function' != typeof t) ? se(e) : t;
        }
        function se(e) {
        ...
        var fe = new T(),
            de = new (function () {
                return {
                    ...
                    cug: {is_cug: !0, show_points: !1, allow_registration: !1, percent_off_text: 'off', show_percent_savings: !0},
                    ...
                    fav_icon_url: ''.concat(te.path, '/site_configs/').concat(ne, '/img/favicon.png'),
                    header: {logo_file_location: ''.concat(te.path, '/site_configs/').concat(ne, '/img/logo.png'), logo_outbound_url: 'https://roomsteals.com/home/'},
                    map_marker_image_url: ''.concat(te.path, '/site_configs/').concat(ne, '/img/favicon.png'),
                    theme: 'light',
        ...
        new ((function (e) {
            ...
            function i() {
                ...
                return (
                    ...
                    ue(((e = se((t = o.call(this, de)))), le(i.prototype)), 'init', e).call(e),
                    t.init(),
                    t
                );
            }
                ...
                (n = [
                    {
                        ...
                        value: function () {
                            this.showFullStayToggle('.SearchHotels'),
                                ...
                                document.querySelector('.CheckOutForm') && fe.updateAttribute('#theConfirmationButton', 'Reserve My Room', 'value'),
                                fe.updateAttribute('.profileCommand', 'https://roomsteals.com/settings', 'href'),
                                fe.updateHTML(
                    ...
                    {
                        key: 'showFullStayToggle',
                        value: function (e) {
                            if (document.querySelector(e)) {
                                var t = document.querySelector('meta[name="theme"]'),
                                ...
                                if (t) {
                                    ...
                                    n.insertAdjacentHTML(
                                        ...
                                        'international' === r.toLowerCase() && (document.querySelector('#rs-toggle').checked = !0),
                                        document.querySelector('#rs-tax-inclusive').addEventListener('click', function (e) {
                                            'standard' === r.toLowerCase() ? arnChangeTheme('international') : arnChangeTheme('standard');
                                        });
                                }
                            }
                        },
