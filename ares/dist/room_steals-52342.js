!(function (e) {
    ...
    function (e, t, n) {
        ...
        n(57), n(38), n(108), n(40), n(41), n(42);
        ...
        var r,
            ...
            R = !!(function () {
                try {
                    ...
                    return (C || 'function' == typeof PromiseRejectionEvent) && e.then(P) instanceof t && 0 !== L.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            q = function (e) {
                var t;
    ...
    function (e, t, n) {
        'use strict';
        n(40), n(62), n(90), n(93), n(57), n(38), n(41), n(97), n(99), n(63), n(102), n(103), n(64), n(42);
                                                                ...
                                                                case 12:
                                                                    'cug' === e.site_config.site_type &&
                                                                        ...
                                                                        'checkout' === e.page_name &&
                                                                            ...
                                                                            j.updateAttribute('.CheckOutForm #theAreaCode', 'inputmode'),
                                                                                                ...
                                                                                                switch ((t.prev = t.next)) {
                                                                                                    ...
                                                                                                    case 3:
                                                                                                        return (
                                                                                                            ...
                                                                                                            j.updateHTML('.ArnSearchHeader', 'Search'),
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var _, S = '', w = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var A = String(b[0]), k = u(l(a(b.index), d.length), 0), L = [], E = 1; E < b.length; E++) L.push(void 0 === (_ = b[E]) ? _ : String(_));
                        var C = b.groups;
                        if (h) {
                            var P = [A].concat(L, k, d);
                            void 0 !== C && P.push(C);
                            var M = String(t.apply(void 0, P));
                        } else M = m(A, d, k, L, C, t);
                        k >= w && ((S += d.slice(w, k) + M), (w = k + A.length));
                    }
                    return S + d.slice(w);
                },
            ];
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var _ = 0, S = 0, w = []; S < d.length; ) {
                            ...
                            var x,
                                A = s(v, h ? d : d.slice(S));
                            if (null === A || (x = f(c(v.lastIndex + (h ? 0 : S)), d.length)) === _) S = a(d, S, y);
                            else {
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            ...
            J = function (e, t, n) {
                return (
                    ...
                    v(n),
                    o(D, t)
                        ? (n.enumerable ? (o(e, B) && e[B][t] && (e[B][t] = !1), (n = A(n, {enumerable: x(0, !1)}))) : (o(e, B) || R(e, B, x(1, {})), (e[B][t] = !0)), z(e, t, n))
                        : R(e, t, n)
                );
            },
            Z = function (e, t) {
            ...
            Q = function (e) {
                for (var t, n = q(S(e)), r = [], i = 0; n.length > i; ) o(D, (t = n[i++])) || t == B || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === $, r = q(n ? N : S(e)), i = [], a = 0; r.length > a; ) !o(D, (t = r[a++])) || (n && !o($, t)) || i.push(D[t]);
                return i;
            };
        U ||
            (c(
        ...
        for (var te = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), ne = 0; te.length > ne; )
            h(te[ne++]);
        for (var re = P(h.store), oe = 0; re.length > oe; ) m(re[oe++]);
        a(a.S + a.F * !U, 'Symbol', {
            for: function (e) {
    ...
    function (e, t, n) {
        n(3) && 'g' != /./g.flags && n(5).f(RegExp.prototype, 'flags', {configurable: !0, get: n(34)});
    },
    function (e, t, n) {
        'use strict';
        var r = n(2),
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            var v,
                ...
                E = L || S(m),
                C = m ? (x ? S('entries') : E) : void 0,
                P = ('Array' == t && k.entries) || L;
            if (
                (P && (_ = l(P.call(new e()))) !== Object.prototype && _.next && (u(_, w, !0), r || 'function' == typeof _[f] || a(_, f, h)),
                x &&
                    L &&
                    'values' !== L.name &&
                    ((A = !0),
                ...
                if (((v = {values: x ? E : S('values'), keys: y ? E : S('keys'), entries: C}), g)) for (b in v) b in k || i(k, b, v[b]);
    ...
    function (e, t, n) {
        ...
        var s = (function () {
            ...
            return (
                ...
                (n = [
                    ...
                    {
                        key: 'showSubscribeNowButtonsForTrialUsers',
                        value: function () {
                            var e = this;
                            ...
                            u.setRoomStealsUser().then(function () {
                                u.checkIsRoomStealsTrialUser().then(function () {
                                    u.setPropertyURL().then(function () {
                                        u.showSubscribeNowButtonsForTrialUsers();
                                    }),
                                        document.querySelector('.SearchHotels') &&
                                            jQuery(document).on('ratesReadyEvent', function () {
            ...
            b = (function (e) {
                function t() {
                    ...
                    return (
                        ...
                        })(this, y(t).call(this, v))),
                        m(y(t.prototype), 'init', h(e)).call(h(e)),
                        e
                    );
                }
                return (
        ...
        g.updateAttribute('.profileCommand', 'https://roomsteals.com/settings', 'href'),
            g.updateHTML(
