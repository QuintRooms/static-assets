!(function (e) {
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var b, w = '', _ = 0, k = 0; k < v.length; k++) {
                        S = v[k];
                        for (var x = String(S[0]), A = u(l(i(S.index), f.length), 0), M = [], C = 1; C < S.length; C++) M.push(void 0 === (b = S[C]) ? b : String(b));
                        var q = S.groups;
                        if (p) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: k ? C : w('values'), keys: y ? C : w('keys'), entries: q}), g)) for (S in v) S in A || a(A, S, v[S]);
    ...
    function (e, t, n) {
        ...
        U ||
            ...
            (n(46).f = K),
            (C.f = ee),
            a && !n(23) && c(N, 'propertyIsEnumerable', K, !0),
            (h.f = function (e) {
                return V(p(e));
            })),
