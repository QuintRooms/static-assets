!(function (e) {
        ...
        var r,
            ...
            T = !!(function () {
                try {
                    ...
                    return (q || 'function' == typeof PromiseRejectionEvent) && e.then(L) instanceof t && 0 !== M.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
                } catch (e) {}
            })(),
            P = function (e) {
                var t;
                                    ...
                                    try {
                                        c
                                            ? (o || (2 == e._h && D(e), (e._h = 1)),
                                              ...
                                              n === t.promise ? u(k('Promise-chain cycle')) : (a = P(n)) ? a.call(n, s, u) : s(n))
                                            : u(r);
                                    } catch (e) {
                                        l && !i && l.exit(), u(e);
                                    }
    ...
    function (e, t, n) {
        var r = (function (e) {
            ...
            return (
                ...
                (e.mark = function (e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : ((e.__proto__ = p), c(e, i, 'GeneratorFunction')), (e.prototype = Object.create(v)), e;
                }),
                (e.awrap = function (e) {
                    return {__await: e};
                }),
    ...
    function (e, t, n) {
        ...
        var i = n(25),
            c = (function () {
                ...
                var t, n, r, c, s, u, l, d, f, p, h, m, y, v, g;
                return (
                    (t = e),
                    (n = [
                        {
    ...
    function (e, t, n) {
        ...
        var r = n(1),
            o = n(103),
            a = n(32);
        n(33)('search', 1, function (e, t, n, i) {
            return [
                function (n) {
                    var r = e(this),
                        o = null == n ? void 0 : n[t];
                ...
                u = function (e, n, r) {
                    try {
                        var o = (function (e) {
                            ...
                            y = a || h.getFullYear(),
                            v = 0;
                        (a && !i) || (v = i > 0 ? i - 1 : h.getMonth());
                        var g = u || 0,
                            S = l || 0,
                            b = d || 0,
                            w = f || 0;
                        return p ? new Date(Date.UTC(y, v, m, g, S, b, w + 60 * p.offset * 1e3)) : r ? new Date(Date.UTC(y, v, m, g, S, b, w)) : new Date(y, v, m, g, S, b, w);
                    } catch (e) {
                        return new Date('');
                    }
                };
            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var g = []; ; ) {
                        ...
                        if (null === S) break;
                        if ((g.push(S), !y)) break;
                        '' === String(S[0]) && (d.lastIndex = c(f, a(d.lastIndex), v));
                    }
                    for (var b, w = '', _ = 0, k = 0; k < g.length; k++) {
                        S = g[k];
                        for (var A = String(S[0]), x = u(l(i(S.index), f.length), 0), M = [], C = 1; C < S.length; C++) M.push(void 0 === (b = S[C]) ? b : String(b));
                        var q = S.groups;
                        if (p) {
                            var L = [A].concat(M, x, f);
                            void 0 !== q && L.push(q);
                            var E = String(t.apply(void 0, L));
                        } else E = m(A, f, x, M, q, t);
                        x >= _ && ((w += f.slice(_, x) + E), (_ = x + A.length));
                    }
                    return w + f.slice(_);
                },
            ];
    ...
    function (e, t, n) {
        for (
            ...
            var y,
                ...
                S = i[v],
                b = S && S.prototype;
            if (b && (b[l] || c(b, l, f), b[d] || c(b, d, v), (s[v] = f), g)) for (y in r) b[y] || a(b, y, r[y], !0);
        }
    },
    function (e, t, n) {
        var r = n(39),
    ...
    function (e, t, n) {
        ...
        (f && p) ||
            ...
            'process' == n(13)(d)
                ...
                : h
                ? ((a = (o = new h()).port2), (o.port1.onmessage = S), (r = i(a.postMessage, a, 1)))
                ...
                [
                    ...
                    function (e, t) {
                        ...
                        for (var b = 0, w = 0, _ = []; w < f.length; ) {
                            ...
                            var k,
                                A = s(g, h ? f : f.slice(w));
                            if (null === A || (k = d(c(g.lastIndex + (h ? 0 : w)), f.length)) === b) w = i(f, w, y);
                            else {
                                if ((_.push(f.slice(b, w)), _.length === S)) return _;
                                for (var x = 1; x <= A.length - 1; x++) if ((_.push(A[x]), _.length === S)) return _;
                                w = b = k;
                            }
                        }
    ...
    function (e, t, n) {
        ...
        var r = n(2),
            ...
            Q = function (e, t, n) {
                return (
                    ...
                    g(n),
                    o(H, t)
                        ? (n.enumerable ? (o(e, D) && e[D][t] && (e[D][t] = !1), (n = A(n, {enumerable: k(0, !1)}))) : (o(e, D) || T(e, D, k(1, {})), (e[D][t] = !0)), G(e, t, n))
                        : T(e, t, n)
                );
            },
            Z = function (e, t) {
            ...
            K = function (e) {
                ...
                return !(this === N && o(H, e) && !o(B, e)) && (!(t || !o(this, e) || !o(H, e) || (o(this, D) && this[D][e])) || t);
            },
            J = function (e, t) {
                if (((e = w(e)), (t = _(t, !0)), e !== N || !o(H, t) || o(B, t))) {
                    var n = E(e, t);
                    return !n || !o(H, t) || (o(e, D) && e[D][t]) || (n.enumerable = !0), n;
                }
            },
            X = function (e) {
                for (var t, n = P(w(e)), r = [], a = 0; n.length > a; ) o(H, (t = n[a++])) || t == D || t == s || r.push(t);
                return r;
            },
            ee = function (e) {
                for (var t, n = e === N, r = P(n ? B : w(e)), a = [], i = 0; r.length > i; ) !o(H, (t = r[i++])) || (n && !o(N, t)) || a.push(H[t]);
                return a;
            };
        U ||
            (c(
            ...
            (n(39).f = K),
            (C.f = ee),
            a && !n(20) && c(N, 'propertyIsEnumerable', K, !0),
            (h.f = function (e) {
                return V(p(e));
            })),
        ...
        for (var te = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), ne = 0; te.length > ne; )
            p(te[ne++]);
        for (var re = L(p.store), oe = 0; re.length > oe; ) m(re[oe++]);
        i(i.S + i.F * !U, 'Symbol', {
            for: function (e) {
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, h, m, y, v) {
            ...
            var g,
                ...
                A = !1,
                x = e.prototype,
                M = x[d] || x['@@iterator'] || (m && x[m]),
                C = M || w(m),
                q = m ? (k ? w('entries') : C) : void 0,
                L = ('Array' == t && x.entries) || M;
            if (
                (L && (b = l(L.call(new e()))) !== Object.prototype && b.next && (u(b, _, !0), r || 'function' == typeof b[d] || i(b, d, p)),
                k &&
                    M &&
                    'values' !== M.name &&
                    ((A = !0),
                ...
                if (((g = {values: k ? C : w('values'), keys: y ? C : w('keys'), entries: q}), v)) for (S in g) S in x || a(x, S, g[S]);
    ...
    function (e, t, n) {
        ...
        ((t = e.exports = function (e, t, n, d, f) {
            ...
            if (a(v)) {
                for (p = c(e.length); p > S; S++) if ((y = t ? g(i((h = e[S]))[0], h[1]) : g(e[S])) === u || y === l) return y;
            } else for (m = v.call(e); !(h = m.next()).done; ) if ((y = o(m, g, h.value, t)) === u || y === l) return y;
        }).BREAK = u),
            (t.RETURN = l);
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
        ...
        var m = new r.default(),
            ...
            v = (function () {
                ...
                var t, n, r, a, i, s, u, h, v, g, S, b, w, _;
                return (
                    (t = e),
                    (n = [
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e,
                                    ...
                                    a = new URLSearchParams(document.querySelector('meta[name="originalParams"]').content),
                                    i = '',
                                    c = '',
                                    s = '',
                                ...
                                u &&
                                    ...
                                    (('cug' === this.site_config.site_type.toLowerCase() && null !== o.get('destination')) ||
                                        ...
                                        (i = o.get('destination')),
                                    (null !== o.get('destination') && 'location' !== i) || (i = a.get('destination')),
                                    m.createHTML(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e,
                                    ...
                                    a = document.querySelector('.checkOutRow td'),
                                ...
                                document.querySelector('.exclusive-rate') ||
                                    ('search-results' === this.page_name &&
                                        document.querySelectorAll('div.ArnProperty').forEach(function (r) {
                                            var i, c;
                                            r.classList.contains('ArnPropertyTierTwo') && '' !== n && a(n, r),
                                                r.classList.contains('ArnPropertyTierThree') && '' !== t && a(t, r),
                                                (r.classList.contains('S16') || r.classList.contains('S20') || (r.classList.contains('S33') && '' !== e)) &&
                                                    ((i = e),
                                                    (c = r),
                                                    '' !== o.site_config.exclusive_rate_text &&
                                                        c.querySelector('div.ArnPropThumb').insertAdjacentHTML('afterbegin', '<span class="exclusive-rate">'.concat(i, '</span>')));
                                        }),
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            ...
            n(17),
            n(12);
        var i = new ((r = n(34)) && r.__esModule ? r : {default: r}).default();
        function c() {
            return (c = a(
                regeneratorRuntime.mark(function e(t, n) {
                    return regeneratorRuntime.wrap(function (e) {
    ...
    function (e, t, n) {
            ...
            g = function (e) {
                ...
                if ('string' == typeof t && t.length > 2) {
                    var n,
                        r,
                        o,
                        a = (t = v ? t.trim() : f(t, 3)).charCodeAt(0);
                    if (43 === a || 45 === a) {
                        ...
                        for (var i, s = t.slice(2), u = 0, l = s.length; u < l; u++) if ((i = s.charCodeAt(u)) < 48 || i > o) return NaN;
                        return parseInt(s, r);
                    }
                }
                return +t;
        ...
        if (!p(' 0o1') || !p('0b1') || p('+0x1')) {
            ...
            for (
                ...
                o(h, (S = b[w])) && !o(p, S) && d(p, S, l(h, S));
            (p.prototype = m), (m.constructor = p), n(8)(r, 'Number', p);
        }
    },
    ,
    ,
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(a, '/img/logo-main.png'), logo_outbound_url: 'https://roomcash.com/dashboard'},
    ...
    function (e, t, n) {
        'use strict';
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(17), n(12), n(68), n(69), n(49), n(141), n(70), n(18);
        var r = i(n(34)),
            o = i(n(48)),
            a = i(n(329));
        function i(e) {
        ...
        var l = new o.default(),
            ...
            f = (function () {
                ...
                var t, n, r, o, i, c, f, p, h, m, y, v, g, S, b;
                return (
                    (t = e),
                    (n = [
                        {
                                                    ...
                                                    case 0:
                                                        (r = document.querySelector(n)),
                                                            ...
                                                            r.addEventListener('change', function (e) {
                                                                o.handleEvent(document.querySelectorAll('#sort-select option')[r.selectedIndex]);
                                                            });
                                                    case 3:
                                                    case 'end':
                                                        return e.stop();
                                                    ...
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 4:
                                                            (n = document.querySelector('.ArnSortByPrice')),
                                                                (r = document.querySelector('.ArnSortByDealAmount')),
                                                                document
                                                                ...
                                                                document.querySelector('#DealAmount').insertAdjacentElement('afterbegin', r),
                                                                document.querySelector('#BestValue').insertAdjacentElement('afterbegin', n),
                                                                (r.textContent = 'RoomCash Savings'),
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (e.next = 2), d.waitForSelectorInDOM(t);
                                                    case 2:
                                                        document.querySelector(t).setAttribute(n, r);
                                                    case 3:
                                                    case 'end':
                                                        return e.stop();
                                                }
                                            ...
                                            for (;;)
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        ...
                                                        return e.abrupt('return');
                                                    case 2:
                                                        return (e.next = 4), d.waitForSelectorInDOM(o);
                                                    case 4:
                                                        document.querySelectorAll(t).forEach(function (e) {
                                                            e.querySelector(n).insertAdjacentElement(r, e.querySelector(o));
                                                        });
                                                    case 6:
                                                    case 'end':
                                                        return e.stop();
                                ...
                                if (a) {
                                    ...
                                    c.addEventListener('blur', function () {
                                        ...
                                        var e = setInterval(function () {
                                            document.querySelector('#'.concat(i.id)) || ((i = document.querySelector(o)), d.removeMaskedElementFromTabIndex(o), clearInterval(e));
                                        }, 500);
                                        i.focus(), i.blur();
                                    });
                                }
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    ...
                                                    case 2:
                                                        (n = document.querySelector('#balance')),
                                                            (r = n.textContent.substring(1).replace(',', '')),
                                                            (o = n.textContent.substring(0, 1)),
                                                            (a = parseInt(r, 10) + t),
                                                            (n.textContent = ''.concat(o).concat(a.toLocaleString()));
                                                    case 7:
                                                    case 'end':
                                                        return e.stop();
                                                }
        ...
        e.exports = {
            set:
                ...
                ('__proto__' in {}
                    ? (function (e, t, r) {
                          try {
                              (r = n(26)(Function.call, n(51).f(Object.prototype, '__proto__').set, 2))(e, []), (t = !(e instanceof Array));
                          } catch (e) {
                              t = !0;
                          }
                          return function (e, n) {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}), (t.default = void 0), n(141), n(68), n(69), n(50), n(37), n(12);
            ...
            i = (function () {
                function e(t, n, r, o) {
                    !(function (e, t) {
                        ...
                        (this.property = t),
                        (this.index = n),
                        (this.insert_element = r),
                        (this.insert_position = o),
                ...
                return (
                    ...
                    (n = [
                            ...
                            value: function () {
                                ...
                                if (this.values)
                                    if (this.values.your_cash_value && this.values.roomcash_value && this.values.width && this.values.currency) {
                                        ...
                                        if (document.querySelector('.SearchHotels')) {
                                            var r = this.property.querySelector('.ArnRateButton');
                                            this.insertElement('.ArnPropName', 'beforeend', r),
                                                this.insertHTML(
                                                    '.ArnRateButton',
                                                    'afterend',
                                    ...
                                    var o = this.property.querySelector('.RateCalendarPopupAnchor');
                                    this.insertElement('.ArnRateCancelAnchor', 'afterend', o);
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: 'addTooltips',
                            value: function (e) {
                                a.addToolTip('#rc-'.concat(e, ' .roomcash-amount p'), 'beforeend', 'Maximum amount of your RoomCash we can apply.', '?', '#fff', '#000'),
                                    a.addToolTip('#rc-'.concat(e, ' .your-cash-amount p'), 'beforeend', "How much you'll pay when you book today.", '?', '#fff', '#000');
                            },
                        },
                        {
                            key: 'insertElement',
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (e && !(parseInt(e, 10) < 18)) {
                                    ...
                                    this.property.querySelector('.bar').style.backgroundImage = '-webkit-linear-gradient(134deg, #1C8747 '.concat(t, '%, #CC9831 ').concat(e, '%)');
                                }
                            },
                        },
                    ]) && o(t.prototype, n),
