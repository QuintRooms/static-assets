    ...
    function (e, t, n) {
        ...
        var f = new (function () {
                return {
                    ...
                    header: {
                        logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo-white.png'),
        ...
        new ((function (e) {
            ...
            h.addHeaderButtonLink('https://stay22.com/embed/republic-of-texas-motorcycle-rally?hidebrandlogo=true', 'Find Your Airbnb Rental');
    },
]);
