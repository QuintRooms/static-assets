    ...
    function (e, t, n) {
                            ...
                            value: function (e, t, n) {
                                ...
                                document.querySelector('form#searchForm').addEventListener('submit', function (i) {
                                    ...
                                    var a,
                                        ...
                                        y = new URL(d),
                                        g = T(document.querySelector('input#theCheckIn').value).format('MM/DD/YYYY'),
                                        v = T(document.querySelector('input#theCheckOut').value).format('MM/DD/YYYY'),
                                        b = T(v).diff(T(g), 'days');
                                    function S(e) {
        ...
        var K = new (function () {
                return {
                    ...
                    header: {
                        logo_file_location: ''.concat(W.path, '/site_configs/').concat(G, '/img/logo-white.png'),
        ...
        new ((function (e) {
            ...
            Q.addHeaderButtonLink('https://stay22.com/embed/republic-of-texas-motorcycle-rally?hidebrandlogo=true', 'Find Your Airbnb Rental');
    },
]);
