            ...
            return [
                ...
                function (e, t) {
                    ...
                    for (var S, w = '', _ = 0, x = 0; x < v.length; x++) {
                        b = v[x];
                        for (var k = String(b[0]), A = u(l(a(b.index), d.length), 0), M = [], L = 1; L < b.length; L++) M.push(void 0 === (S = b[L]) ? S : String(S));
                        var q = b.groups;
                        if (h) {
                            var E = [k].concat(M, A, d);
                            void 0 !== q && E.push(q);
                            var C = String(t.apply(void 0, E));
                        } else C = m(k, d, A, M, q, t);
                            ...
                            document.querySelector('form#searchForm').addEventListener('submit', function (o) {
                                ...
                                52342 === e.site_id || ('standard' === n.getMetaTagContent('theme') && 16980 !== e.affiliate_id)
                                    ? ((l = a(document.querySelector('input#theCheckIn').value, 'M/D/YYYY').format('M/D/YYYY')),
                                      (f = a(document.querySelector('input#theCheckOut').value, 'M/D/YYYY').format('M/D/YYYY')),
                                      (h = a(f).diff(a(l), 'days')))
                                    ...
                                    ? ((l = a(document.querySelector('input#theCheckIn').value, 'YYYY/M/D').format('M/D/YYYY')),
                                      (f = a(document.querySelector('input#theCheckOut').value, 'YYYY/M/D').format('M/D/YYYY')),
                                      (h = a(f).diff(a(l), 'days')),
                                    ...
                                    : (16980 === e.affiliate_id || e.site_id,
                                      ...
                                      (f = a(document.querySelector('input#theCheckOut').value, 'D/M/YYYY').format('M/D/YYYY')),
                                      (h = a(f).diff(a(l), 'days')),
        ...
        new ((function (e) {
            ...
            function n() {
                ...
                return (
                    ...
                    d(((e = f((r = t.call(this, m)))), h(n.prototype)), 'init', e).call(e),
                    r
                );
            }
            return n;
        })(r.default))(),
            p.prepopulateDatePopupWithTodaysDate(),
            p.addMultipleHeaderLogos({
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    header: {logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo.png'), logo_outbound_url: 'https://www.shakykneesfestival.com/'},
