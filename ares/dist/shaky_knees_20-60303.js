    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, p, m, y, g) {
            ...
            if (
                ...
                if (((v = {values: x ? M : w('values'), keys: y ? M : w('keys'), entries: E}), g)) for (S in v) S in k || i(k, S, v[S]);
        ...
        var h = new o.a(),
            p = new (function () {
                return {
                    ...
                    fav_icon_url: ''.concat(a.path, '/site_configs/').concat(c, '/img/favicon.png'),
                    header: {logo_file_location: ''.concat(a.path, '/site_configs/').concat(c, '/img/logo.png'), logo_outbound_url: 'https://www.shakykneesfestival.com/'},
                    map_marker_image_url: ''.concat(a.path, '/site_configs/').concat(c, '/img/favicon.png'),
                    theme: 'light',
