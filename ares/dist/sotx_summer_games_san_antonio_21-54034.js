!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(74),
            o = n(19),
            i = new (n.n(o).a)(),
            a = 'sotx_summer_games_san_antonio_21-'.concat(54034);
        function c(e) {
            return (c =
        ...
        var p = new (function () {
            return {
                ...
                header: {logo_file_location: ''.concat(i.path, '/site_configs/').concat(a, '/img/logo.png'), logo_outbound_url: 'https://www.sotx.org/'},
