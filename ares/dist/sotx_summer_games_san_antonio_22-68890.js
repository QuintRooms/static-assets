!(function (e) {
    ...
    function (e, t, n) {
        ...
        Object.defineProperty(t, '__esModule', {value: !0}),
            (t.default = function () {
                return {
                    ...
                    lodging: {event_id: '51368', event_name: '2022 Special Olympics of Texas', event_dates: '', redirect_date: '', redirect_url: '', is_lrg: !1},
                    ...
                    header: {
                        logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo2.png'),
                        email_logo_file_location: ''.concat(o.path, '/site_configs/').concat(i, '/img/logo2.png'),
        ...
        var o = new ((r = n(48)) && r.__esModule ? r : {default: r}).default(),
            i = 'sotx_summer_games_san_antonio_22-'.concat(68890);
    },
    function (e, t, n) {},
]);
