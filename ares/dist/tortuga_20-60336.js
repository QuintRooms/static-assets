    ...
    function (e, t, n) {
        ...
        var d = new (function () {
            return {
                ...
                banner_image_url: 'center/cover no-repeat url('.concat(o.path, '/site_configs/').concat(i, '/img/banner.jpg)'),
                ...
                ads: {
                    sidebar_ad: {is_active: !0, image_url: ''.concat(o.path, '/site_configs/').concat(i, '/img/ad.png'), outbound_url: 'http://rocktheocean.com/'},
...
//# sourceMappingURL=tortuga_20-60336.map
