        ...
        var d = new (function () {
            return {
                ...
                header: {
                    ...
                    background: 'url('.concat(i.path, '/site_configs/').concat(a, '/img/header-bg.png)'),
                },
                map_marker_image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/favicon.png'),
                theme: 'light',
                google_font_url: '//fonts.googleapis.com/css?family=Montserrat:100,500,700',
                ads: {
                    sidebar_ad: {is_active: !0, image_url: ''.concat(i.path, '/site_configs/').concat(a, '/img/ad.png'), outbound_url: 'http://rocktheocean.com/'},
