!(function (e) {
                                ...
                                return regeneratorRuntime.wrap(function (e) {
                                    for (;;)
                                        switch ((e.prev = e.next)) {
                                            ...
                                            case 9:
                                                !r < '08/26/21'
                                                    ? (t.setAttribute('value', r), n.setAttribute('value', g().add(3, 'day').format('MM/DD/YYYY')))
                                                    : (t.setAttribute('value', '08/26/21'), n.setAttribute('value', '08/29/21')),
                                                    (document.querySelectorAll('#theDatePrompt #datePromptContainer img')[0].src = ''.concat(
                                                        y.path,
                                                        '/site_configs/van_gogh_phoenix-71012/img/logo_b.png'
                                                    ));
                                            case 12:
                                            case 'end':
                                                return e.stop();
    ...
    function (e, t, n) {
        ...
        var o = new ((r = n(51)) && r.__esModule ? r : {default: r}).default(),
            i = 'van_gogh_phoenix-'.concat(71012);
    },
    function (e, t, n) {},
]);
