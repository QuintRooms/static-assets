        ...
        this.getSiteID().then(() => {
            this.getSiteConfigJSON().then(() => {
                ...
                if (this.page_name == 'checkout') {
                    ...
                    // this.moveElementIntoExistingWrapper('#theBookingPage #theCityAjax1 > div', '#theBillingAddressAjax1', 'afterEnd');
                    // this.moveElementIntoExistingWrapper('#theBookingPage #theStateAjax1', '#theCityZipAjax1', 'beforeBegin');
