export default class BasePortal {
    ...
    formatCheckoutForm() {
        ...
        room_reservations.forEach((reservation) => {
            ...
            this.createHTML('<legend>Credit Card Info</legend>', `#theBookingPage td.GuestForms > fieldset:nth-child(${reservation_count}) #billing-details-container${reservation_count - 1}`, 'beforeBegin');
