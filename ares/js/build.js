...
export default class BasePortal {
    ...
    insertPoweredByFooterLogo() {
        document.querySelector('.ArnSupportBottom').insertAdjacentHTML(
            ...
            <a href="https://quint.co/" target="_blank"><img src="${env_path.path}/images/quintrooms/quint_logo_white.png" alt="Quint logo"></a>
            </div>`
        );
    }
    ...
    addMessagingToConfirmationPage() {
        ...
        if (email_from === undefined || email_from === null || email_from === '') email_from = `rooms@quint.co`;
        ...
        support_info.insertAdjacentHTML(
            ...
            `<div class="confirmation-messaging">
                <p>You will receive a confirmation email from <a href="mailto:rooms@quint.co"><strong>rooms@quint.co</strong></a> at <strong>${user_email}</strong> shortly.</p>
            </div>
            `
        );
    }
