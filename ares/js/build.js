export default class BasePortal {
    ...
    formatCheckoutForm() {
        ...
        room_reservations.forEach((reservation) => {
            ...
            this.moveOrphanedElementsIntoNewWrapper([document.querySelector(`td.GuestForms > fieldset:nth-child(${reservation_count}) #theCityZipAjax1 > table > tbody > tr > td:nth-child(1) > div`), document.querySelector(`td.GuestForms > fieldset:nth-child(${reservation_count}) #theCityZipAjax1 > table > tbody > tr > td:nth-child(2) > div`), document.querySelector('td.GuestForms > fieldset:nth-child(${reservation_count}) #theStateAjax1'), document.querySelector('td.GuestForms > fieldset:nth-child(${reservation_count}) #theCountryAjax1')], `billing-details-container${reservation_count}`, `#theBillingAddressAjax${reservation_count}`, 'afterEnd');
