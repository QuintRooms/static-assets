 ...
 export default class BasePortal {
     ...
     formatCheckoutForm() {
         ...
         room_reservations.forEach((reservation) => {
             ...
             this.createWrapper(`.RoomNumber-${reservation_count} #theCreditCardBillingNameAjax${reservation_count}, .RoomNumber-${reservation_count} #theCreditCardNumberAjax, .RoomNumber-${reservation_count} #theCardExpirationFieldsAjax`, ``, `security-code-exp-container${reservation_count}`, 'afterEnd');
