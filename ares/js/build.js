...
export default class BasePortal {
    ...
    init() {
        ...
        this.getSiteID().then(async (site_id) => {
            ...
            if (document.querySelector('.RootBody')) {
                ...
                algolia.addAlgoliaSearch(this.site_config, this.page_name);
                // }
    ...
    //             // member_token = document.querySelector('meta[name="sessionId"]').content;
    //         }
    //     };
    ...
    //                 url = `${origin}/v6/?type=geo&siteid=${this.site_id}&longitude=${lng}&latitude=${lat}&checkin=${check_in_value}&nights=${nights}&pagesize=10&${this.site_config.distance_unit}&rooms=${rooms_value}&adults=${adults_value}&currency=${this.selected_currency}`;
    //             };
    ...
    //                 // built_url.searchParams.append('_s', member_token);
    //             }
    //             if (this.page_name === 'search-results') {
