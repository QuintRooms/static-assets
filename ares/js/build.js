        ...
        this.getSiteID().then(() => {
            this.getSiteConfigJSON().then(() => {
                ...
                if (this.page_name == 'checkout') {
                    ...
                    this.moveOrphanedElementsIntoNewWrapper([document.querySelector('#theBookingPage .cvvTable'), document.querySelector('#theCardExpirationFieldsAjax')], 'billing-details-container', '#theBillingAddressAjax1', 'afterEnd');
