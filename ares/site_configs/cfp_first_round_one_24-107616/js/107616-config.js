...
const site_id = 107616;
const directory_name = `cfp_first_round_one_24-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        header: {
            logo_file_location: `${env_path.path}/site_configs/${directory_name}/img/CFP_FIRST_HORZ_WHITE_SM33.png`,
