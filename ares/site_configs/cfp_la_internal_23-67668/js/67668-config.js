...
const site_id = 67668;
const directory_name = `cfp_la_internal_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: 'College Football Playoff Los Angeles',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        header: {
            logo_file_location: `${env_path.path}/site_configs/${directory_name}/img/logo-la.png`,
