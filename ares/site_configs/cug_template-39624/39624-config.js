...
export default function siteConfig() {
    return {
        ...
        banner_image_url: `linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25))`,
        ...
        primary_color: '#e2ad37',
        secondary_color: '#215853',
        primary_text_color: '#fff',
        secondary_text_color: '#215853',
        border_color: '#e2ad37',
        button_hover_background_color: '#215853 radial-gradient(circle,transparent 1%,#215853 0) 50%/15000%',
