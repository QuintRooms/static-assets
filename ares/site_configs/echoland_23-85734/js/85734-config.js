...
const site_id = 85734;
const directory_name = `echoland_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        header: {
            ...
            logo_outbound_url: 'https://www.echolandfestival.com/',
        },
        ...
        group_booking_form_url: 'https://form.jotform.com/203066540331141?bookingPortal=Echoland',
