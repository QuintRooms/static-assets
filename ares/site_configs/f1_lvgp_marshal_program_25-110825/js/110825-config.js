...
const site_id = 110825;
const directory_name = `f1_lvgp_marshal_program_25-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        map_marker_image_url: [
            `${env_path.path}/site_configs/${directory_name}/img/circle_pink_30.png`,
            `${env_path.path}/site_configs/${directory_name}/img/cc_blue_30.png`,
            `${env_path.path}/site_configs/${directory_name}/img/circle_green_30.png`,
            `${env_path.path}/clients/formula_1/images/favicon.png`,
        ],
        theme: 'light',
