...
export default function siteConfig() {
    return {
        ...
        banner_image_url: `linear-gradient(rgba(0,0,0,.25),rgba(0,0,0,.25)), url(${env_path.path}/site_configs/${directory_name}/img/f1-bg-1.jpg) no-repeat center center /cover`,
