...
const site_id = 86603;
const directory_name = `hive_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: 'Hive Music Festival',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        header: {
            ...
            logo_outbound_url: 'https://www.hivefestival.com/',
        },
        ...
        group_booking_form_url: 'https://form.jotform.com/203066540331141?bookingPortal=Hive',
