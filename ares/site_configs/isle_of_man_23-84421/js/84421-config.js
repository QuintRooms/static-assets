...
const site_id = 84421;
const directory_name = `isle_of_man_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        host_hotel_text: 'Free Ferry With 5+ Nights',
        ...
        header: {
            ...
            logo_outbound_url: 'https://www.iomttraces.com/',
        },
