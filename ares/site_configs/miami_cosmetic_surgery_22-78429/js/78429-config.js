...
const site_id = 78429;
const directory_name = `miami_cosmetic_surgery_22-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: 'Miami Cosmetic Surgery 2022',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        group_booking_form_url: 'https://form.jotform.com/203066540331141?bookingPortal=Miami%20Cosmetic%20Surgery',
