...
const site_id = 83061;
const directory_name = `miami_esap_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: 'Entrepreneurial Strategy for Aesthetic Physicians 2023',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        group_booking_form_url: 'https://form.jotform.com/203066540331141?bookingPortal=ESAP',
