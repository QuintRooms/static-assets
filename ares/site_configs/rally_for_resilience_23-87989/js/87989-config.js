...
const site_id = 87989;
const directory_name = `rally_for_resilience_23-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: '2023 Rally For Resilience',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        header: {
            ...
            logo_outbound_url: 'https://sustainableagriculture.net/farmers-for-climate-action-rally-for-resilience/',
        },
        ...
        group_booking_form_url: 'https://form.jotform.com/203066540331141?bookingPortal=Rally%20For%20Resilience',
