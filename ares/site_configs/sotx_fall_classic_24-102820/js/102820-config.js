...
const site_id = 102820;
const directory_name = `sotx_fall_classic_24-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: '2022 Special Olympics Texas',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: false,
        ...
        header: {
            ...
            email_logo_file_location: `${env_path.path}/site_configs/${directory_name}/img/logo.jpg`,
