...
const site_id = 90132;
const directory_name = `two_step_inn_festival_24-${site_id}`;
...
export default function siteConfig() {
    return {
        ...
        lodging: {
            event_id: '',
            event_name: 'Two Step Inn Festival',
            event_dates: '',
            redirect_date: '',
            redirect_url: '',
            is_lrg: true,
        ...
        header: {
            ...
            logo_outbound_url: 'https://www.twostepinn.com/',
        },
