...
noLRGPortal.updateRoomDescription('.RoomDescription', 'Shaky Knees Exclusive Rates');
    ...
    function callback(mutationsList, observer) {
        for (let mutation of mutationsList) {
            if (mutation.type === 'childList') {
                ...
                if (noLRGPortal.site_id == 60303) {
                    noLRGPortal.updateHTML('header', '<img class="branding-left" src="https://static.hotelsforhope.com/portals/child-portals/noLRG/49553/images/left.svg" alt="Shaky Knees Branding"><div><a class="logo" href="https://www.shakykneesfestival.com/" target="_blank"><img src="https://static.hotelsforhope.com/portals/child-portals/noLRG/49553/images/logo.png" alt="Logo"></a><p>Oct 16-18, 2020 • Atlanta, GA • Central Park</p></div><img class="branding-right" src="https://static.hotelsforhope.com/portals/child-portals/noLRG/49553/images/right.svg" alt="Shaky Knees Branding">');
                }
...
document.querySelector('body').insertAdjacentHTML('beforeEnd', '<link rel="stylesheet" type="text/css" href="https://static.hotelsforhope.com/portals/child-portals/noLRG/49553/49553.css">');