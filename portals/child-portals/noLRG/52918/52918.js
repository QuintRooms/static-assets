    ...
    function callback(mutationsList, observer) {
        for (let mutation of mutationsList) {
            if (mutation.type === 'childList') {
                ...
                noLRGPortal.createHTML('#language', '<a class="hidden-xs" href="https://form.jotform.com/91966384058167" target="_blank"><span class="translateMe">Group Request</span></a> <a class="hidden-xs" href="https://events.hotelsforhope.com/v6/support?siteId=' + noLRGPortal.site_id + '" target="_blank"><span class="translateMe">Contact Us</span></a>', 'beforeBegin');
